package org.wso2.wsf.wtp.ws.creation.core.messages;
...
public class WSASCreationUIMessages extends NLS {
	...
	private static final String BUNDLE_NAME = "org.wso2.wsf.wtp.ws.creation.core.messages.WSASCreationUI";//$NON-NLS-1$
