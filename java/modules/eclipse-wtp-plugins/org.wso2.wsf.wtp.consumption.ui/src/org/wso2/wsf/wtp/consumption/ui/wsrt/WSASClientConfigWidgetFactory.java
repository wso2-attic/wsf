...
import org.wso2.wsf.wtp.consumption.ui.wizard.client.WebServiceClientWSASType;
...
//		wsClientWSASType.setWebServiceDataModel(model);
	...
	private void init(){
		  ...
		  proxyWidget       = (WSASProxyWidget)proxyConfigWidget.getWidgetContributorFactory().create();
