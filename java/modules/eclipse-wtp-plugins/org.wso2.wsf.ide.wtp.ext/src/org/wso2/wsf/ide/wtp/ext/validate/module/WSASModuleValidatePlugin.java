 ...
 */
public class WSASModuleValidatePlugin extends AbstractUIPlugin {
    //The shared instance.
    private static WSASModuleValidatePlugin plugin;
    //Resource bundle.
     ...
     * The constructor.
     */
    public WSASModuleValidatePlugin() {
        super();
        plugin = this;
        try {
            resourceBundle = ResourceBundle.getBundle(
                  "org.wso2.wsf.ide.wtp.ext.validate.module.resources.ModuleValidateResources");
     ...
     */
    public static WSASModuleValidatePlugin getDefault() {
    	if (plugin == null) {
			plugin = new WSASModuleValidatePlugin();
		}
        return plugin;
    }
    ...
    public static String getResourceString(String key) {
        ResourceBundle bundle = WSASModuleValidatePlugin.getDefault().getResourceBundle();
        try {
    ...
    public static ImageDescriptor getWizardImageDescriptor() {
        if (wizardImageDescriptor == null) {
            wizardImageDescriptor =
            	WSASModuleValidatePlugin.imageDescriptorFromPlugin(
            			"org.wso2.wsf.ide.wtp.ext.validate.module.moduleValidaterWizard", 
            			"icons/modules.gif");
        }
