...
public abstract class AbstractArchiveValidateWizardPage extends WizardPage implements SettingsConstants{
    ...
    public AbstractArchiveValidateWizardPage(String pageName){
        super(pageName+".name");
        init(pageName);
    }
    ...
    protected void init(String pageName){
         ...
         */
        IDialogSettings rootSettings = WSASArchiveValidatePlugin.getDefault()
                .getDialogSettings();
    ...
    public WSASArchiveValidatePlugin getCodegenWizard(){
    	return (WSASArchiveValidatePlugin)getWizard();
    }
