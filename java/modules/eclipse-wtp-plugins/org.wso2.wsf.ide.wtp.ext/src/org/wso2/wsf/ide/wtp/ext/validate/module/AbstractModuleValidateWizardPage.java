...
public abstract class AbstractModuleValidateWizardPage extends WizardPage implements SettingsConstants{
    protected IDialogSettings settings;
    protected boolean restoredFromPreviousSettings = false;
    
    public AbstractModuleValidateWizardPage(String pageName){
        super(pageName+".name");
        init(pageName);
    }
    
    protected void init(String pageName){
        setTitle(WSASModuleValidatePlugin.getResourceString("main.title"));
        setDescription(WSASModuleValidatePlugin.getResourceString("main.discription"));
        setImageDescriptor(WSASModuleValidatePlugin.getWizardImageDescriptor());
        
        /*
         * Get the settings for this page. If there is no section in the
         * Plugin's settings for this OptionsPage, create a new section
         */
        IDialogSettings rootSettings = WSASModuleValidatePlugin.getDefault()
                .getDialogSettings();
     ...
     * @return
     */
    public WSASModuleValidatePlugin getCodegenWizard(){
    	return (WSASModuleValidatePlugin)getWizard();
    }
