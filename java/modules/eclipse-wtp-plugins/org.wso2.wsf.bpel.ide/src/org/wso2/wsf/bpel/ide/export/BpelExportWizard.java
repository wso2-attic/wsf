...
public class BpelExportWizard extends Wizard implements IExportWizard{
	...
	public void addPages() {
		super .addPages();
		mainPage = new BpelExportWizardPage("Bpel Export");
		addPage(mainPage);
	}
		...
		if (selection.getFirstElement() instanceof IProject){
			...
			try {
				...
				if (tmpZip.exists()){
					...
					String deployableZip = mainPage.getFileLocation(); //FileManagementUtil.addNodesToPath(PersistentWSASEmitterContext.getInstance().getWSASRuntimeLocation(),new String[]{"repository", "bpel",p.getName()+".zip"});
					...
					if (deployedZip.exists())
						...
						throw new Exception("Couldbpel archive file.");	
				}else
