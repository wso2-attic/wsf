...
public class CPPStubHeaderWriter extends FileWriter {

    public CPPStubHeaderWriter(String outputFileLocation) {
        this.outputFileLocation = new File(outputFileLocation);
    }

    public CPPStubHeaderWriter(File outputFileLocation, String language) {
