...
public class CPPSvcSkeletonWriter extends FileWriter {

    public CPPSvcSkeletonWriter(String outputFileLocation) {
        this.outputFileLocation = new File(outputFileLocation);
    }

    public CPPSvcSkeletonWriter(File outputFileLocation, String language) {
