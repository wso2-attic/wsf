...
/**
 * The first page of the code generator wizard. Asks for the WSDL file Name
 */
...
public class WSDLFileSelectionPage extends AbstractWizardPage {
    ...
    public void createControl(Composite parent) {
        ...
        labelFile.setText(Activator
                .getResourceString("page0.fileselection.label"));
        ...
        button.setText(Activator
                .getResourceString("page0.fileselection.browse"));
    ...
    private void dialogChanged() {
        ...
        if (fileName.length() == 0) {
            updateStatus(Activator
                    .getResourceString("page0.error.filemissingerror"));
            return;
        }
