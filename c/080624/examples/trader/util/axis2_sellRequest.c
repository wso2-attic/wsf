        ...
        */
        ...
        #include "axis2_sellRequest.h"
              ...
              /**
               * implmentation of the sellRequest|http://www.wso2.org/types element
               */
             


        struct axis2_sellRequest
        {
       ...
       /************************* Function Implmentations ********************************/
        ...
        {
            axis2_sellRequest_t *sellRequest = NULL;
            
              axutil_qname_t* qname = NULL;
            
            AXIS2_ENV_CHECK(env, NULL);

            sellRequest = (axis2_sellRequest_t *) AXIS2_MALLOC(env->
                allocator, sizeof(axis2_sellRequest_t));
                ...
                const axutil_env_t *env)
        {
            ...
            AXIS2_ENV_CHECK(env, AXIS2_FAILURE);
              ...
              if(sellRequest->qname )
              {
                  axutil_qname_free (sellRequest->qname, env);
                  sellRequest->qname = NULL;
              }
            

            if(sellRequest)
            {
                AXIS2_FREE( env->allocator, sellRequest);
                sellRequest = NULL;
            }
                ...
                axiom_node_t* parent)
        {
            ...
            ns1 = axiom_namespace_create (env,
              ...
              if ( NULL == parent )
              {
                ...
                AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, "NULL elemenet for sellRequest"
                ...
                return AXIS2_FAILURE;
                    ...
                    if ( axutil_qname_equals( qname, env, sellRequest-> qname ) )
                    {
                    ...
                    else
                    {
                      ...
                      */
                           ...
                           if ( current_node != NULL)
                           {
                              current_element = axiom_node_get_data_element( current_node, env);
                                      ...
                                      status = axis2_sellRequest_set_userid( sellRequest, env,
                                                                   text_value);
                      ...
                      */
                           ...
                           if ( current_node != NULL)
                           {
                              current_element = axiom_node_get_data_element( current_node, env);
                                      text_value = axiom_element_get_text(current_element, env, current_node );
                                      status = axis2_sellRequest_set_password( sellRequest, env,
                                                                   text_value);
                      ...
                      */
                           ...
                           if ( current_node != NULL)
                           {
                              current_element = axiom_node_get_data_element( current_node, env);
                                      text_value = axiom_element_get_text(current_element, env, current_node );
                                      status = axis2_sellRequest_set_symbol( sellRequest, env,
                                                                   text_value);
                      ...
                      */
                           ...
                           if ( current_node != NULL)
                           {
                              current_element = axiom_node_get_data_element( current_node, env);
                                      ...
                                      status = axis2_sellRequest_set_qty( sellRequest, env,
                                                                    atoi( text_value));
                ...
                const axutil_env_t *env, axiom_node_t* parent, int has_parent)
        {
                    ...
                    stream = axiom_data_source_get_stream(data_source, env);
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                           ...
                           text_value_1 = sellRequest->attrib_userid;
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                           ...
                           text_value_2 = sellRequest->attrib_password;
                           axutil_stream_write(stream, env, start_input_str, start_input_str_len);
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                           ...
                           text_value_3 = sellRequest->attrib_symbol;
                           axutil_stream_write(stream, env, start_input_str, start_input_str_len);
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                               ...
                               sprintf ( text_value_4, "%d", sellRequest->attrib_qty );
            ...
            axis2_sellRequest_get_userid(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return sellRequest-> attrib_userid;
             }
            ...
            axis2_sellRequest_set_userid(
                    ...
                    axis2_char_t*  param_userid)
             {
                ...
                sellRequest-> attrib_userid = param_userid;
                return AXIS2_SUCCESS;
             }
            ...
            axis2_sellRequest_get_password(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return sellRequest-> attrib_password;
             }
            ...
            axis2_sellRequest_set_password(
                    ...
                    axis2_char_t*  param_password)
             {
                ...
                sellRequest-> attrib_password = param_password;
                return AXIS2_SUCCESS;
             }
            ...
            axis2_sellRequest_get_symbol(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return sellRequest-> attrib_symbol;
             }
            ...
            axis2_sellRequest_set_symbol(
                    ...
                    axis2_char_t*  param_symbol)
             {
                ...
                sellRequest-> attrib_symbol = param_symbol;
                return AXIS2_SUCCESS;
             }
            ...
            axis2_sellRequest_set_qty(
                    ...
                    int  param_qty)
             {
                ...
                sellRequest-> attrib_qty = param_qty;
                return AXIS2_SUCCESS;
             }
