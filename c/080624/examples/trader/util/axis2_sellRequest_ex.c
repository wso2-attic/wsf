        ...
        */
        ...
        #include "axis2_sellRequest_ex.h"
              ...
              /**
               * implmentation of the sellRequest_ex|http://www.wso2.org/types element
               */
             


        struct axis2_sellRequest_ex
        {
       ...
       /************************* Function Implmentations ********************************/
        AXIS2_EXTERN axis2_sellRequest_ex_t* AXIS2_CALL
        axis2_sellRequest_ex_create(
            const axutil_env_t *env )
        {
            axis2_sellRequest_ex_t *sellRequest_ex = NULL;
            
              axutil_qname_t* qname = NULL;
            
            AXIS2_ENV_CHECK(env, NULL);

            sellRequest_ex = (axis2_sellRequest_ex_t *) AXIS2_MALLOC(env->
                allocator, sizeof(axis2_sellRequest_ex_t));

            if(NULL == sellRequest_ex)
            {
              ...
              sellRequest_ex->qname = qname;
            

            return sellRequest_ex;
         }

        axis2_status_t AXIS2_CALL
        axis2_sellRequest_ex_free (
                ...
                const axutil_env_t *env)
        {
            ...
            AXIS2_ENV_CHECK(env, AXIS2_FAILURE);
              ...
              if(sellRequest_ex->qname )
              {
                  axutil_qname_free (sellRequest_ex->qname, env);
                  sellRequest_ex->qname = NULL;
              }
            

            if(sellRequest_ex)
            {
                AXIS2_FREE( env->allocator, sellRequest_ex);
                sellRequest_ex = NULL;
            }
           ...
           axis2_sellRequest_ex_get_qname (
                   axis2_sellRequest_ex_t* sellRequest_ex,
                   const axutil_env_t *env)
           {
               AXIS2_ENV_CHECK(env, AXIS2_FAILURE);

               return sellRequest_ex-> qname;
           }
                ...
                const axutil_env_t *env, axiom_node_t* parent, int has_parent)
        {
            ...
            axis2_sellRequest_ex_get_userid(
                    axis2_sellRequest_ex_t* sellRequest_ex,
                    const axutil_env_t *env)
             {
                AXIS2_ENV_CHECK(env, AXIS2_FAILURE);

                return sellRequest_ex-> attrib_userid;
             }
             ...
             */
            axis2_status_t AXIS2_CALL
            axis2_sellRequest_ex_set_userid(
                    axis2_sellRequest_ex_t* sellRequest_ex,
                    const axutil_env_t *env,
                    axis2_char_t*  param_userid)
             {
                ...
                sellRequest_ex-> attrib_userid = param_userid;
                return AXIS2_SUCCESS;
             }
             ...
             */
            axis2_char_t* AXIS2_CALL
            axis2_sellRequest_ex_get_symbol(
                    axis2_sellRequest_ex_t* sellRequest_ex,
                    const axutil_env_t *env)
             {
                AXIS2_ENV_CHECK(env, AXIS2_FAILURE);

                return sellRequest_ex-> attrib_symbol;
             }
             ...
             */
            int AXIS2_CALL
            axis2_sellRequest_ex_get_qty(
                    axis2_sellRequest_ex_t* sellRequest_ex,
                    const axutil_env_t *env)
             {
                AXIS2_ENV_CHECK(env, AXIS2_FAILURE);

                return sellRequest_ex-> attrib_qty;
             }
            ...
            axis2_sellRequest_ex_set_qty(
                    ...
                    int  param_qty)
             {
                ...
                sellRequest_ex-> attrib_qty = param_qty;
                return AXIS2_SUCCESS;
             }
