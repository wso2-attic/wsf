...
*/
        ...
        #include "adb_loginResponse.h"
               ...
               /*
                * implmentation of the loginResponse|http://authentication.services.core.carbon.wso2.org element
                */
       ...
       /************************* Private Function prototypes ********************************/
                ...
                adb_loginResponse_set_return_nil(
       ...
       /************************* Function Implmentations ********************************/
            ...
            const axutil_env_t *env)
        {
            ...
            _loginResponse->is_valid_return  = AXIS2_FALSE;
            
                  qname =  axutil_qname_create (env,
                        "loginResponse",
                        "http://authentication.services.core.carbon.wso2.org",
                        NULL);
                _loginResponse->qname = qname;
                ...
                axis2_bool_t _return)
        {
            ...
            adb_obj = adb_loginResponse_create(env);
              ...
              status = adb_loginResponse_set_return(
                                     adb_obj,
                                     env,
                                     _return);
        ...
        axis2_bool_t AXIS2_CALL
                        ...
                        const axutil_env_t *env)
                {
                    ...
                    value = _loginResponse->property_return;
                ...
                const axutil_env_t *env)
        {
            ...
            adb_loginResponse_reset_return(_loginResponse, env);
            
              if(_loginResponse->qname)
              {
                  axutil_qname_free (_loginResponse->qname, env);
                  _loginResponse->qname = NULL;
              }
            ...
            AXIS2_PARAM_CHECK(env->error, _loginResponse, AXIS2_FAILURE);
              ...
              if (NULL == parent)
              {
                ...
                return AXIS2_FAILURE;
                    ...
                    if (axutil_qname_equals(qname, env, _loginResponse-> qname))
                    {
                    ...
                    else
                    {
                        AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, 
                              ...
                              axutil_qname_to_string(_loginResponse-> qname, env),
                              ...
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      if(text_value != NULL)
                                      {
                                            ...
                                            {
                                                status = adb_loginResponse_set_return(_loginResponse, env,
                                                                 AXIS2_TRUE);
                                            }
                                            else
                                            {
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
         ...
         int tag_closed = 0;
            ...
            AXIS2_PARAM_CHECK(env->error, _loginResponse, NULL);
                    ...
                    parent_element = axiom_element_create (env, NULL, "loginResponse", ns1 , &parent);
                   ...
                   if (!_loginResponse->is_valid_return)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                           ...
                           strcpy(text_value_1, (_loginResponse->property_return)?"true":"false");
            ...
            adb_loginResponse_get_property1(
                ...
                const axutil_env_t *env)
            {
                return adb_loginResponse_get_return(_loginResponse,
                                             env);
            }
            ...
            adb_loginResponse_get_return(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _loginResponse->property_return;
             }
            ...
            adb_loginResponse_set_return(
                    ...
                    axis2_bool_t  arg_return)
             {
                ...
                if(_loginResponse->is_valid_return &&
                        arg_return == _loginResponse->property_return)
                {
                ...
                _loginResponse->property_return = arg_return;
                        _loginResponse->is_valid_return = AXIS2_TRUE;
            ...
            */
           axis2_status_t AXIS2_CALL
           adb_loginResponse_reset_return(
                   adb_loginResponse_t* _loginResponse,
                   const axutil_env_t *env)
           {
               int i = 0;
            ...
            */
           axis2_bool_t AXIS2_CALL
           adb_loginResponse_is_return_nil(
                   adb_loginResponse_t* _loginResponse,
                   const axutil_env_t *env)
           {
               ...
               return !_loginResponse->is_valid_return;
           }
           ...
           adb_loginResponse_set_return_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_loginResponse_reset_return(_loginResponse, env);
           }
