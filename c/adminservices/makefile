...
distdir:
	...
	if not exist $(ADMIN_SVC_DISTDIR)\$(ENDPOINT_ADMIN_SERVICE) mkdir $(ADMIN_SVC_DISTDIR)\$(ENDPOINT_ADMIN_SERVICE)
...
intdirs:
	...
	if not exist $(ADMIN_SVC_INTDIR)\$(ENDPOINT_ADMIN_SERVICE) mkdir $(ADMIN_SVC_INTDIR)\$(ENDPOINT_ADMIN_SERVICE)
