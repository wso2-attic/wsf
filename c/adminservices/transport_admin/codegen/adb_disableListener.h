...
*/
        ...
        #ifndef ADB_DISABLELISTENER_H
        #define ADB_DISABLELISTENER_H

       /**
        * adb_disableListener.h
        *
        ...
        */
        ...
        typedef struct adb_disableListener adb_disableListener_t;
        ...
        /**
         * Constructor for creating adb_disableListener_t
         * @param env pointer to environment struct
         * @return newly created adb_disableListener_t object
         */
         ...
         * @param  _disableListener adb_disableListener_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_disableListener_t object
         * @param  _disableListener adb_disableListener_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _disableListener adb_disableListener_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_disableListener_declare_parent_namespaces(
         ...
         * @param  _disableListener adb_disableListener_t object
         * @param env pointer to environment struct
         * @param disableListener_om_node node to serialize from
         * @param disableListener_om_element parent element to serialize from
        ...
        adb_disableListener_serialize(
            adb_disableListener_t* _disableListener,
            const axutil_env_t *env,
            axiom_node_t* disableListener_om_node, axiom_element_t *disableListener_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_disableListener is a particle class (E.g. group, inner sequence)
        ...
        adb_disableListener_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_disableListener_t object and return the property value.
