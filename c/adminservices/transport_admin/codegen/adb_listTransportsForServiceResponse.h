...
*/
        ...
        #ifndef ADB_LISTTRANSPORTSFORSERVICERESPONSE_H
        #define ADB_LISTTRANSPORTSFORSERVICERESPONSE_H

       /**
        * adb_listTransportsForServiceResponse.h
        *
       ...
       /**
        *  adb_listTransportsForServiceResponse class
        */
        ...
        typedef struct adb_listTransportsForServiceResponse adb_listTransportsForServiceResponse_t;
        ...
        /**
         * Constructor for creating adb_listTransportsForServiceResponse_t
         * @param env pointer to environment struct
         * @return newly created adb_listTransportsForServiceResponse_t object
         */
         ...
         * @param  _listTransportsForServiceResponse adb_listTransportsForServiceResponse_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_listTransportsForServiceResponse_t object
         * @param  _listTransportsForServiceResponse adb_listTransportsForServiceResponse_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for return. Deprecated for array types, Use adb_listTransportsForServiceResponse_get_return_at instead
         * @param  _listTransportsForServiceResponse adb_listTransportsForServiceResponse_t object
         * @param env pointer to environment struct
        ...
        /**
         * Setter for return.Deprecated for array types, Use adb_listTransportsForServiceResponse_set_return_at
         * or adb_listTransportsForServiceResponse_add_return instead.
         * @param  _listTransportsForServiceResponse adb_listTransportsForServiceResponse_t object
         * @param env pointer to environment struct
         ...
         * @param  _listTransportsForServiceResponse _ adb_listTransportsForServiceResponse_t object
         * @param env pointer to environment struct.
       ...
       adb_listTransportsForServiceResponse_declare_parent_namespaces(
         ...
         * @param  _listTransportsForServiceResponse adb_listTransportsForServiceResponse_t object
         * @param env pointer to environment struct
         * @param listTransportsForServiceResponse_om_node node to serialize from
         * @param listTransportsForServiceResponse_om_element parent element to serialize from
        ...
        adb_listTransportsForServiceResponse_serialize(
            adb_listTransportsForServiceResponse_t* _listTransportsForServiceResponse,
            const axutil_env_t *env,
            axiom_node_t* listTransportsForServiceResponse_om_node, axiom_element_t *listTransportsForServiceResponse_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_listTransportsForServiceResponse is a particle class (E.g. group, inner sequence)
        ...
        adb_listTransportsForServiceResponse_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_listTransportsForServiceResponse_t object and return the property value.
     ...
     #endif /* ADB_LISTTRANSPORTSFORSERVICERESPONSE_H */
