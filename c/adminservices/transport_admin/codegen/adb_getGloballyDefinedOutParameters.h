...
*/
        ...
        #ifndef ADB_GETGLOBALLYDEFINEDOUTPARAMETERS_H
        #define ADB_GETGLOBALLYDEFINEDOUTPARAMETERS_H

       /**
        * adb_getGloballyDefinedOutParameters.h
        *
       ...
       /**
        *  adb_getGloballyDefinedOutParameters class
        */
        ...
        typedef struct adb_getGloballyDefinedOutParameters adb_getGloballyDefinedOutParameters_t;
        ...
        /**
         * Constructor for creating adb_getGloballyDefinedOutParameters_t
         * @param env pointer to environment struct
         * @return newly created adb_getGloballyDefinedOutParameters_t object
         */
         ...
         * @param  _getGloballyDefinedOutParameters adb_getGloballyDefinedOutParameters_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_getGloballyDefinedOutParameters_t object
         * @param  _getGloballyDefinedOutParameters adb_getGloballyDefinedOutParameters_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _getGloballyDefinedOutParameters adb_getGloballyDefinedOutParameters_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_getGloballyDefinedOutParameters_declare_parent_namespaces(
         ...
         * @param  _getGloballyDefinedOutParameters adb_getGloballyDefinedOutParameters_t object
         * @param env pointer to environment struct
         * @param getGloballyDefinedOutParameters_om_node node to serialize from
         * @param getGloballyDefinedOutParameters_om_element parent element to serialize from
        ...
        adb_getGloballyDefinedOutParameters_serialize(
            adb_getGloballyDefinedOutParameters_t* _getGloballyDefinedOutParameters,
            const axutil_env_t *env,
            axiom_node_t* getGloballyDefinedOutParameters_om_node, axiom_element_t *getGloballyDefinedOutParameters_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_getGloballyDefinedOutParameters is a particle class (E.g. group, inner sequence)
        ...
        adb_getGloballyDefinedOutParameters_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_getGloballyDefinedOutParameters_t object and return the property value.
     ...
     #endif /* ADB_GETGLOBALLYDEFINEDOUTPARAMETERS_H */
