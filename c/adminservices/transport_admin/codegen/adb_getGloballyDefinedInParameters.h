...
*/
        ...
        #ifndef ADB_GETGLOBALLYDEFINEDINPARAMETERS_H
        #define ADB_GETGLOBALLYDEFINEDINPARAMETERS_H

       /**
        * adb_getGloballyDefinedInParameters.h
        *
       ...
       /**
        *  adb_getGloballyDefinedInParameters class
        */
        ...
        typedef struct adb_getGloballyDefinedInParameters adb_getGloballyDefinedInParameters_t;
        ...
        /**
         * Constructor for creating adb_getGloballyDefinedInParameters_t
         * @param env pointer to environment struct
         * @return newly created adb_getGloballyDefinedInParameters_t object
         */
         ...
         * @param  _getGloballyDefinedInParameters adb_getGloballyDefinedInParameters_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_getGloballyDefinedInParameters_t object
         * @param  _getGloballyDefinedInParameters adb_getGloballyDefinedInParameters_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _getGloballyDefinedInParameters adb_getGloballyDefinedInParameters_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_getGloballyDefinedInParameters_declare_parent_namespaces(
         ...
         * @param  _getGloballyDefinedInParameters adb_getGloballyDefinedInParameters_t object
         * @param env pointer to environment struct
         * @param getGloballyDefinedInParameters_om_node node to serialize from
         * @param getGloballyDefinedInParameters_om_element parent element to serialize from
        ...
        adb_getGloballyDefinedInParameters_serialize(
            adb_getGloballyDefinedInParameters_t* _getGloballyDefinedInParameters,
            const axutil_env_t *env,
            axiom_node_t* getGloballyDefinedInParameters_om_node, axiom_element_t *getGloballyDefinedInParameters_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_getGloballyDefinedInParameters is a particle class (E.g. group, inner sequence)
        ...
        adb_getGloballyDefinedInParameters_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_getGloballyDefinedInParameters_t object and return the property value.
     ...
     #endif /* ADB_GETGLOBALLYDEFINEDINPARAMETERS_H */
