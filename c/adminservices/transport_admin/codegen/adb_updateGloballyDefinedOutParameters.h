...
*/
        ...
        #ifndef ADB_UPDATEGLOBALLYDEFINEDOUTPARAMETERS_H
        #define ADB_UPDATEGLOBALLYDEFINEDOUTPARAMETERS_H

       /**
        * adb_updateGloballyDefinedOutParameters.h
        *
       ...
       /**
        *  adb_updateGloballyDefinedOutParameters class
        */
        ...
        typedef struct adb_updateGloballyDefinedOutParameters adb_updateGloballyDefinedOutParameters_t;
        ...
        /**
         * Constructor for creating adb_updateGloballyDefinedOutParameters_t
         * @param env pointer to environment struct
         * @return newly created adb_updateGloballyDefinedOutParameters_t object
         */
         ...
         * @param  _updateGloballyDefinedOutParameters adb_updateGloballyDefinedOutParameters_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_updateGloballyDefinedOutParameters_t object
         * @param  _updateGloballyDefinedOutParameters adb_updateGloballyDefinedOutParameters_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _updateGloballyDefinedOutParameters adb_updateGloballyDefinedOutParameters_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
        ...
        /**
         * Getter for params. Deprecated for array types, Use adb_updateGloballyDefinedOutParameters_get_params_at instead
         * @param  _updateGloballyDefinedOutParameters adb_updateGloballyDefinedOutParameters_t object
         * @param env pointer to environment struct
        ...
        /**
         * Setter for params.Deprecated for array types, Use adb_updateGloballyDefinedOutParameters_set_params_at
         * or adb_updateGloballyDefinedOutParameters_add_params instead.
         * @param  _updateGloballyDefinedOutParameters adb_updateGloballyDefinedOutParameters_t object
         * @param env pointer to environment struct
         ...
         * @param  _updateGloballyDefinedOutParameters _ adb_updateGloballyDefinedOutParameters_t object
         * @param env pointer to environment struct.
       ...
       adb_updateGloballyDefinedOutParameters_declare_parent_namespaces(
         ...
         * @param  _updateGloballyDefinedOutParameters adb_updateGloballyDefinedOutParameters_t object
         * @param env pointer to environment struct
         * @param updateGloballyDefinedOutParameters_om_node node to serialize from
         * @param updateGloballyDefinedOutParameters_om_element parent element to serialize from
        ...
        adb_updateGloballyDefinedOutParameters_serialize(
            adb_updateGloballyDefinedOutParameters_t* _updateGloballyDefinedOutParameters,
            const axutil_env_t *env,
            axiom_node_t* updateGloballyDefinedOutParameters_om_node, axiom_element_t *updateGloballyDefinedOutParameters_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_updateGloballyDefinedOutParameters is a particle class (E.g. group, inner sequence)
        ...
        adb_updateGloballyDefinedOutParameters_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_updateGloballyDefinedOutParameters_t object and return the property value.
     ...
     #endif /* ADB_UPDATEGLOBALLYDEFINEDOUTPARAMETERS_H */
