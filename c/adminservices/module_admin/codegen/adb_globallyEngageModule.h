...
*/
        ...
        #ifndef ADB_GLOBALLYENGAGEMODULE_H
        #define ADB_GLOBALLYENGAGEMODULE_H

       /**
        * adb_globallyEngageModule.h
        *
       ...
       /**
        *  adb_globallyEngageModule class
        */
        ...
        typedef struct adb_globallyEngageModule adb_globallyEngageModule_t;
        ...
        /**
         * Constructor for creating adb_globallyEngageModule_t
         * @param env pointer to environment struct
         * @return newly created adb_globallyEngageModule_t object
         */
         ...
         * @param  _globallyEngageModule adb_globallyEngageModule_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_globallyEngageModule_t object
         * @param  _globallyEngageModule adb_globallyEngageModule_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for moduleId. 
         * @param  _globallyEngageModule adb_globallyEngageModule_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_globallyEngageModule_declare_parent_namespaces(
         ...
         * @param  _globallyEngageModule adb_globallyEngageModule_t object
         * @param env pointer to environment struct
         * @param globallyEngageModule_om_node node to serialize from
         * @param globallyEngageModule_om_element parent element to serialize from
        ...
        adb_globallyEngageModule_serialize(
            adb_globallyEngageModule_t* _globallyEngageModule,
            const axutil_env_t *env,
            axiom_node_t* globallyEngageModule_om_node, axiom_element_t *globallyEngageModule_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_globallyEngageModule is a particle class (E.g. group, inner sequence)
        ...
        adb_globallyEngageModule_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_globallyEngageModule_t object and return the property value.
     ...
     #endif /* ADB_GLOBALLYENGAGEMODULE_H */
