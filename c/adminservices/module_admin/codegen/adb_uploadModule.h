...
*/
        ...
        #ifndef ADB_UPLOADMODULE_H
        #define ADB_UPLOADMODULE_H
        ...
        */
        ...
        typedef struct adb_uploadModule adb_uploadModule_t;
        ...
        /**
         * Constructor for creating adb_uploadModule_t
         * @param env pointer to environment struct
         * @return newly created adb_uploadModule_t object
         */
         ...
         * @param  _uploadModule adb_uploadModule_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_uploadModule_t object
         * @param  _uploadModule adb_uploadModule_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for fileName. 
         * @param  _uploadModule adb_uploadModule_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
         ...
         * @param  _uploadModule adb_uploadModule_t object
         * @param env pointer to environment struct
         * @param arg_dataHandler axutil_base64_binary_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_uploadModule_declare_parent_namespaces(
         ...
         * @param  _uploadModule adb_uploadModule_t object
         * @param env pointer to environment struct
         * @param uploadModule_om_node node to serialize from
         * @param uploadModule_om_element parent element to serialize from
        ...
        adb_uploadModule_serialize(
            adb_uploadModule_t* _uploadModule,
            const axutil_env_t *env,
            axiom_node_t* uploadModule_om_node, axiom_element_t *uploadModule_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_uploadModule is a particle class (E.g. group, inner sequence)
         ...
         * @param _dataHandler axutil_base64_binary_t*
         * @return newly created adb_uploadModule_t object
         */
        adb_uploadModule_t* AXIS2_CALL
        adb_uploadModule_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_uploadModule_t object and return the property value.
