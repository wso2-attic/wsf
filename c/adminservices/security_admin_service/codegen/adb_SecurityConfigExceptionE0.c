...
*/
        ...
        #include "adb_SecurityConfigExceptionE0.h"
               ...
               /*
                * implmentation of the SecurityConfigException|http://service.config.security.carbon.wso2.org element
                */
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                      ...
                      */
                                 ...
                                 element_qname = axutil_qname_create(env, "SecurityConfigException", "http://service.config.security.carbon.wso2.org", NULL);
