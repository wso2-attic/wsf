...
*/
            ...
            axis2_char_t *default_type)
        {
            if (_object != NULL && adb_type_get_type(_object) != NULL)
            {
                ...
                if (axutil_strcmp(adb_type_get_type(_object), "adb_SecurityScenarioData") == 0)
                {
                    return adb_SecurityScenarioData_free_obj(
                    (adb_SecurityScenarioData_t*) _object, env);
                }
            
                if (axutil_strcmp(adb_type_get_type(_object), "adb_SecurityScenarioDataWrapper") == 0)
                {
                    return adb_SecurityScenarioDataWrapper_free_obj(
                    (adb_SecurityScenarioDataWrapper_t*) _object, env);
                }
            
                if (axutil_strcmp(adb_type_get_type(_object), "adb_SecurityConfigData") == 0)
                {
                    return adb_SecurityConfigData_free_obj(
                    (adb_SecurityConfigData_t*) _object, env);
                }
                ...
                if (axutil_strcmp(adb_type_get_type(_object), "adb_SecurityConfigException") == 0)
                {
                    return adb_SecurityConfigException_free_obj(
                    (adb_SecurityConfigException_t*) _object, env);
                }
            ...
            axis2_char_t *default_type)
        {
            if (_object != NULL && adb_type_get_type(_object) != NULL)
            {
                ...
                if (axutil_strcmp(adb_type_get_type(_object), "adb_SecurityScenarioData") == 0)
                {
                    return adb_SecurityScenarioData_deserialize_obj(
                    (adb_SecurityScenarioData_t*) _object, env, dp_parent, dp_is_early_node_valid, dont_care_minoccurs);
                }
            
                if (axutil_strcmp(adb_type_get_type(_object), "adb_SecurityScenarioDataWrapper") == 0)
                {
                    return adb_SecurityScenarioDataWrapper_deserialize_obj(
                    (adb_SecurityScenarioDataWrapper_t*) _object, env, dp_parent, dp_is_early_node_valid, dont_care_minoccurs);
                }
            
                if (axutil_strcmp(adb_type_get_type(_object), "adb_SecurityConfigData") == 0)
                {
                    return adb_SecurityConfigData_deserialize_obj(
                    (adb_SecurityConfigData_t*) _object, env, dp_parent, dp_is_early_node_valid, dont_care_minoccurs);
                }
                ...
                if (axutil_strcmp(adb_type_get_type(_object), "adb_SecurityConfigException") == 0)
                {
                    return adb_SecurityConfigException_deserialize_obj(
                    (adb_SecurityConfigException_t*) _object, env, dp_parent, dp_is_early_node_valid, dont_care_minoccurs);
                }
            ...
            axis2_char_t *default_type)
        {
            if (_object != NULL && adb_type_get_type(_object) != NULL)
            {
                ...
                if (axutil_strcmp(adb_type_get_type(_object), "adb_SecurityScenarioData") == 0)
                {
                    ...
                    (adb_SecurityScenarioData_t*) _object, env, om_node, om_element, tag_closed, namespaces, next_ns_index);
                }
            
                if (axutil_strcmp(adb_type_get_type(_object), "adb_SecurityScenarioDataWrapper") == 0)
                {
                    return adb_SecurityScenarioDataWrapper_serialize_obj(
                    (adb_SecurityScenarioDataWrapper_t*) _object, env, om_node, om_element, tag_closed, namespaces, next_ns_index);
                }
            
                if (axutil_strcmp(adb_type_get_type(_object), "adb_SecurityConfigData") == 0)
                {
                    return adb_SecurityConfigData_serialize_obj(
                    (adb_SecurityConfigData_t*) _object, env, om_node, om_element, tag_closed, namespaces, next_ns_index);
                }
                ...
                if (axutil_strcmp(adb_type_get_type(_object), "adb_SecurityConfigException") == 0)
                {
                    ...
                    (adb_SecurityConfigException_t*) _object, env, om_node, om_element, tag_closed, namespaces, next_ns_index);
                }
