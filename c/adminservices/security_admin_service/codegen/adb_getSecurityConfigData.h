...
*/
        ...
        #ifndef ADB_GETSECURITYCONFIGDATA_H
        #define ADB_GETSECURITYCONFIGDATA_H

       /**
        * adb_getSecurityConfigData.h
        *
       ...
       /**
        *  adb_getSecurityConfigData class
        */
        ...
        typedef struct adb_getSecurityConfigData adb_getSecurityConfigData_t;
        ...
        /**
         * Constructor for creating adb_getSecurityConfigData_t
         * @param env pointer to environment struct
         * @return newly created adb_getSecurityConfigData_t object
         */
         ...
         * @param  _getSecurityConfigData adb_getSecurityConfigData_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_getSecurityConfigData_t object
         * @param  _getSecurityConfigData adb_getSecurityConfigData_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _getSecurityConfigData adb_getSecurityConfigData_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_getSecurityConfigData_declare_parent_namespaces(
         ...
         * @param  _getSecurityConfigData adb_getSecurityConfigData_t object
         * @param env pointer to environment struct
         * @param getSecurityConfigData_om_node node to serialize from
         * @param getSecurityConfigData_om_element parent element to serialize from
        ...
        adb_getSecurityConfigData_serialize(
            adb_getSecurityConfigData_t* _getSecurityConfigData,
            const axutil_env_t *env,
            axiom_node_t* getSecurityConfigData_om_node, axiom_element_t *getSecurityConfigData_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_getSecurityConfigData is a particle class (E.g. group, inner sequence)
        ...
        adb_getSecurityConfigData_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_getSecurityConfigData_t object and return the property value.
     ...
     #endif /* ADB_GETSECURITYCONFIGDATA_H */
