...
*/
            ...
            axis2_char_t *default_type)
        {
            if (_object != NULL && adb_type_get_type(_object) != NULL)
            {
                ...
                if (axutil_strcmp(adb_type_get_type(_object), "adb_AppenderData") == 0)
                {
                    return adb_AppenderData_deserialize_obj(
                    (adb_AppenderData_t*) _object, env, dp_parent, dp_is_early_node_valid, dont_care_minoccurs);
                }
            
                if (axutil_strcmp(adb_type_get_type(_object), "adb_LoggerData") == 0)
                {
                    return adb_LoggerData_deserialize_obj(
                    (adb_LoggerData_t*) _object, env, dp_parent, dp_is_early_node_valid, dont_care_minoccurs);
                }
            
                if (axutil_strcmp(adb_type_get_type(_object), "adb_LogData") == 0)
                {
                    return adb_LogData_deserialize_obj(
                    (adb_LogData_t*) _object, env, dp_parent, dp_is_early_node_valid, dont_care_minoccurs);
                }
            ...
            axis2_char_t *default_type)
        {
            if (_object != NULL && adb_type_get_type(_object) != NULL)
            {
                ...
                if (axutil_strcmp(adb_type_get_type(_object), "adb_AppenderData") == 0)
                {
                    ...
                    (adb_AppenderData_t*) _object, env, om_node, om_element, tag_closed, namespaces, next_ns_index);
                }
            
                if (axutil_strcmp(adb_type_get_type(_object), "adb_LoggerData") == 0)
                {
                    return adb_LoggerData_serialize_obj(
                    (adb_LoggerData_t*) _object, env, om_node, om_element, tag_closed, namespaces, next_ns_index);
                }
            
                if (axutil_strcmp(adb_type_get_type(_object), "adb_LogData") == 0)
                {
                    return adb_LogData_serialize_obj(
                    (adb_LogData_t*) _object, env, om_node, om_element, tag_closed, namespaces, next_ns_index);
                }
