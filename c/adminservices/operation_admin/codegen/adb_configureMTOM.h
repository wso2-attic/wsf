...
*/
        ...
        #ifndef ADB_CONFIGUREMTOM_H
        #define ADB_CONFIGUREMTOM_H
        ...
        */
        ...
        typedef struct adb_configureMTOM adb_configureMTOM_t;
        ...
        /**
         * Constructor for creating adb_configureMTOM_t
         * @param env pointer to environment struct
         * @return newly created adb_configureMTOM_t object
         */
         ...
         * @param  _configureMTOM adb_configureMTOM_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_configureMTOM_t object
         * @param  _configureMTOM adb_configureMTOM_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for flag. 
         * @param  _configureMTOM adb_configureMTOM_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_configureMTOM_declare_parent_namespaces(
         ...
         * @param  _configureMTOM adb_configureMTOM_t object
         * @param env pointer to environment struct
         * @param configureMTOM_om_node node to serialize from
         * @param configureMTOM_om_element parent element to serialize from
        ...
        adb_configureMTOM_serialize(
            adb_configureMTOM_t* _configureMTOM,
            const axutil_env_t *env,
            axiom_node_t* configureMTOM_om_node, axiom_element_t *configureMTOM_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_configureMTOM is a particle class (E.g. group, inner sequence)
        ...
        adb_configureMTOM_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_configureMTOM_t object and return the property value.
