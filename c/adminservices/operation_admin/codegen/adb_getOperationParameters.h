...
*/
        ...
        #ifndef ADB_GETOPERATIONPARAMETERS_H
        #define ADB_GETOPERATIONPARAMETERS_H

       /**
        * adb_getOperationParameters.h
        *
       ...
       /**
        *  adb_getOperationParameters class
        */
        ...
        typedef struct adb_getOperationParameters adb_getOperationParameters_t;
        ...
        /**
         * Constructor for creating adb_getOperationParameters_t
         * @param env pointer to environment struct
         * @return newly created adb_getOperationParameters_t object
         */
         ...
         * @param  _getOperationParameters adb_getOperationParameters_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_getOperationParameters_t object
         * @param  _getOperationParameters adb_getOperationParameters_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _getOperationParameters adb_getOperationParameters_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_getOperationParameters_declare_parent_namespaces(
         ...
         * @param  _getOperationParameters adb_getOperationParameters_t object
         * @param env pointer to environment struct
         * @param getOperationParameters_om_node node to serialize from
         * @param getOperationParameters_om_element parent element to serialize from
        ...
        adb_getOperationParameters_serialize(
            adb_getOperationParameters_t* _getOperationParameters,
            const axutil_env_t *env,
            axiom_node_t* getOperationParameters_om_node, axiom_element_t *getOperationParameters_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_getOperationParameters is a particle class (E.g. group, inner sequence)
        ...
        adb_getOperationParameters_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_getOperationParameters_t object and return the property value.
     ...
     #endif /* ADB_GETOPERATIONPARAMETERS_H */
