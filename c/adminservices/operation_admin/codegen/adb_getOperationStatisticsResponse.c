...
*/
       ...
       /************************* Function Implmentations ********************************/
            ...
            const axutil_env_t *env)
        {
            ...
            _getOperationStatisticsResponse->property_Type = axutil_strdup(env, "adb_getOperationStatisticsResponse");
        ...
        adb_OperationMetaData_t* AXIS2_CALL
                        ...
                        const axutil_env_t *env)
                {
                    ...
                    _getOperationStatisticsResponse->property_return = (adb_OperationMetaData_t*)NULL;
                ...
                const axutil_env_t *env)
        {
            ...
            return adb_getOperationStatisticsResponse_free_obj(
                _getOperationStatisticsResponse,
                env);
                ...
                const axutil_env_t *env)
        {
            ...
            if (_getOperationStatisticsResponse->property_Type != NULL)
            {
              AXIS2_FREE(env->allocator, _getOperationStatisticsResponse->property_Type);
            }
                ...
                axis2_bool_t dont_care_minoccurs)
        {
            ...
            return adb_getOperationStatisticsResponse_deserialize_obj(
                _getOperationStatisticsResponse,
                env,
                dp_parent,
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
                ...
                return adb_getOperationStatisticsResponse_serialize_obj(
                    _getOperationStatisticsResponse, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index);
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                            ...
                            adb_OperationMetaData_serialize(_getOperationStatisticsResponse->property_return, 
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _getOperationStatisticsResponse, AXIS2_FAILURE);
                ...
                if(_getOperationStatisticsResponse->property_return != NULL)
                {
                   ...
                   adb_OperationMetaData_free(_getOperationStatisticsResponse->property_return, env);
                     _getOperationStatisticsResponse->property_return = NULL;
                }
