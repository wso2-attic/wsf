...
*/
        ...
        #ifndef ADB_GETOPERATIONMETADATA_H
        #define ADB_GETOPERATIONMETADATA_H

       /**
        * adb_getOperationMetaData.h
        *
       ...
       /**
        *  adb_getOperationMetaData class
        */
        ...
        typedef struct adb_getOperationMetaData adb_getOperationMetaData_t;
        ...
        /**
         * Constructor for creating adb_getOperationMetaData_t
         * @param env pointer to environment struct
         * @return newly created adb_getOperationMetaData_t object
         */
         ...
         * @param  _getOperationMetaData adb_getOperationMetaData_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_getOperationMetaData_t object
         * @param  _getOperationMetaData adb_getOperationMetaData_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _getOperationMetaData adb_getOperationMetaData_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_getOperationMetaData_declare_parent_namespaces(
         ...
         * @param  _getOperationMetaData adb_getOperationMetaData_t object
         * @param env pointer to environment struct
         * @param getOperationMetaData_om_node node to serialize from
         * @param getOperationMetaData_om_element parent element to serialize from
        ...
        adb_getOperationMetaData_serialize(
            adb_getOperationMetaData_t* _getOperationMetaData,
            const axutil_env_t *env,
            axiom_node_t* getOperationMetaData_om_node, axiom_element_t *getOperationMetaData_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_getOperationMetaData is a particle class (E.g. group, inner sequence)
        ...
        adb_getOperationMetaData_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_getOperationMetaData_t object and return the property value.
     ...
     #endif /* ADB_GETOPERATIONMETADATA_H */
