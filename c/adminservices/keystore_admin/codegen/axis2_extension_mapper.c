...
*/
            ...
            axis2_char_t *default_type)
        {
            ...
            if (type != NULL)
            {
              ...
              if (axutil_strcmp(type, "CertData") == 0)
              {
                  return (adb_type_t*) adb_CertData_create(env);
              }
              
              if (axutil_strcmp(type, "KeyStoreData") == 0)
              {
                  return (adb_type_t*) adb_KeyStoreData_create(env);
              }
            ...
            if (axutil_strcmp(default_type, "adb_CertData") == 0)
            {
                return (adb_type_t*) adb_CertData_create(env);
            }
            
            if (axutil_strcmp(default_type, "adb_KeyStoreData") == 0)
            {
                return (adb_type_t*) adb_KeyStoreData_create(env);
            }
            ...
            axis2_char_t *default_type)
        {
            if (_object != NULL && adb_type_get_type(_object) != NULL)
            {
                ...
                if (axutil_strcmp(adb_type_get_type(_object), "adb_CertData") == 0)
                {
                    return adb_CertData_free_obj(
                    (adb_CertData_t*) _object, env);
                }
            
                if (axutil_strcmp(adb_type_get_type(_object), "adb_KeyStoreData") == 0)
                {
                    return adb_KeyStoreData_free_obj(
                    (adb_KeyStoreData_t*) _object, env);
                }
            ...
            axis2_char_t *default_type)
        {
            if (_object != NULL && adb_type_get_type(_object) != NULL)
            {
                ...
                if (axutil_strcmp(adb_type_get_type(_object), "adb_CertData") == 0)
                {
                    return adb_CertData_deserialize_obj(
                    (adb_CertData_t*) _object, env, dp_parent, dp_is_early_node_valid, dont_care_minoccurs);
                }
            
                if (axutil_strcmp(adb_type_get_type(_object), "adb_KeyStoreData") == 0)
                {
                    return adb_KeyStoreData_deserialize_obj(
                    (adb_KeyStoreData_t*) _object, env, dp_parent, dp_is_early_node_valid, dont_care_minoccurs);
                }
            ...
            axis2_char_t *default_type)
        {
            if (_object != NULL && adb_type_get_type(_object) != NULL)
            {
                ...
                if (axutil_strcmp(adb_type_get_type(_object), "adb_CertData") == 0)
                {
                    ...
                    (adb_CertData_t*) _object, env, om_node, om_element, tag_closed, namespaces, next_ns_index);
                }
            
                if (axutil_strcmp(adb_type_get_type(_object), "adb_KeyStoreData") == 0)
                {
                    return adb_KeyStoreData_serialize_obj(
                    (adb_KeyStoreData_t*) _object, env, om_node, om_element, tag_closed, namespaces, next_ns_index);
                }
