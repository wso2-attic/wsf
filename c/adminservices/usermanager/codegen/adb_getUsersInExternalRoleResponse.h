...
*/
        ...
        #ifndef ADB_GETUSERSINEXTERNALROLERESPONSE_H
        #define ADB_GETUSERSINEXTERNALROLERESPONSE_H

       /**
        * adb_getUsersInExternalRoleResponse.h
        *
       ...
       /**
        *  adb_getUsersInExternalRoleResponse class
        */
        ...
        typedef struct adb_getUsersInExternalRoleResponse adb_getUsersInExternalRoleResponse_t;
        ...
        /**
         * Constructor for creating adb_getUsersInExternalRoleResponse_t
         * @param env pointer to environment struct
         * @return newly created adb_getUsersInExternalRoleResponse_t object
         */
         ...
         * @param  _getUsersInExternalRoleResponse adb_getUsersInExternalRoleResponse_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_getUsersInExternalRoleResponse_t object
         * @param  _getUsersInExternalRoleResponse adb_getUsersInExternalRoleResponse_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for return. Deprecated for array types, Use adb_getUsersInExternalRoleResponse_get_return_at instead
         * @param  _getUsersInExternalRoleResponse adb_getUsersInExternalRoleResponse_t object
         * @param env pointer to environment struct
        ...
        /**
         * Setter for return.Deprecated for array types, Use adb_getUsersInExternalRoleResponse_set_return_at
         * or adb_getUsersInExternalRoleResponse_add_return instead.
         * @param  _getUsersInExternalRoleResponse adb_getUsersInExternalRoleResponse_t object
         * @param env pointer to environment struct
         ...
         * @param  _getUsersInExternalRoleResponse _ adb_getUsersInExternalRoleResponse_t object
         * @param env pointer to environment struct.
       ...
       adb_getUsersInExternalRoleResponse_declare_parent_namespaces(
         ...
         * @param  _getUsersInExternalRoleResponse adb_getUsersInExternalRoleResponse_t object
         * @param env pointer to environment struct
         * @param getUsersInExternalRoleResponse_om_node node to serialize from
         * @param getUsersInExternalRoleResponse_om_element parent element to serialize from
        ...
        adb_getUsersInExternalRoleResponse_serialize(
            adb_getUsersInExternalRoleResponse_t* _getUsersInExternalRoleResponse,
            const axutil_env_t *env,
            axiom_node_t* getUsersInExternalRoleResponse_om_node, axiom_element_t *getUsersInExternalRoleResponse_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_getUsersInExternalRoleResponse is a particle class (E.g. group, inner sequence)
        ...
        adb_getUsersInExternalRoleResponse_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_getUsersInExternalRoleResponse_t object and return the property value.
     ...
     #endif /* ADB_GETUSERSINEXTERNALROLERESPONSE_H */
