...
*/
        ...
        #ifndef ADB_USERMGTEXCEPTIONE0_H
        #define ADB_USERMGTEXCEPTIONE0_H

       /**
        * adb_UserMgtExceptionE0.h
        *
        ...
        */
        ...
        typedef struct adb_UserMgtExceptionE0 adb_UserMgtExceptionE0_t;
        ...
        /**
         * Constructor for creating adb_UserMgtExceptionE0_t
         * @param env pointer to environment struct
         * @return newly created adb_UserMgtExceptionE0_t object
         */
         ...
         * @param  _UserMgtExceptionE0 adb_UserMgtExceptionE0_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_UserMgtExceptionE0_t object
         * @param  _UserMgtExceptionE0 adb_UserMgtExceptionE0_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _UserMgtExceptionE0 adb_UserMgtExceptionE0_t object
         * @param env pointer to environment struct
         * @return adb_UserMgtException_t*
         */
         ...
         * @param  _UserMgtExceptionE0 adb_UserMgtExceptionE0_t object
         * @param env pointer to environment struct
         * @param arg_UserMgtException adb_UserMgtException_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_UserMgtExceptionE0_declare_parent_namespaces(
         ...
         * @param  _UserMgtExceptionE0 adb_UserMgtExceptionE0_t object
         * @param env pointer to environment struct
         * @param UserMgtExceptionE0_om_node node to serialize from
         * @param UserMgtExceptionE0_om_element parent element to serialize from
        ...
        adb_UserMgtExceptionE0_serialize(
            adb_UserMgtExceptionE0_t* _UserMgtExceptionE0,
            const axutil_env_t *env,
            axiom_node_t* UserMgtExceptionE0_om_node, axiom_element_t *UserMgtExceptionE0_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_UserMgtExceptionE0 is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_UserMgtExceptionE0_t
         * @param env pointer to environment struct
         * @param _UserMgtException adb_UserMgtException_t*
         * @return newly created adb_UserMgtExceptionE0_t object
         */
        adb_UserMgtExceptionE0_t* AXIS2_CALL
        adb_UserMgtExceptionE0_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_UserMgtExceptionE0_t object and return the property value.
     ...
     #endif /* ADB_USERMGTEXCEPTIONE0_H */
