...
*/
        ...
        #ifndef ADB_GETUSERROLES_H
        #define ADB_GETUSERROLES_H
        ...
        */
        ...
        typedef struct adb_getUserRoles adb_getUserRoles_t;
        ...
        /**
         * Constructor for creating adb_getUserRoles_t
         * @param env pointer to environment struct
         * @return newly created adb_getUserRoles_t object
         */
         ...
         * @param  _getUserRoles adb_getUserRoles_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_getUserRoles_t object
         * @param  _getUserRoles adb_getUserRoles_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for userName. 
         * @param  _getUserRoles adb_getUserRoles_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_getUserRoles_declare_parent_namespaces(
         ...
         * @param  _getUserRoles adb_getUserRoles_t object
         * @param env pointer to environment struct
         * @param getUserRoles_om_node node to serialize from
         * @param getUserRoles_om_element parent element to serialize from
        ...
        adb_getUserRoles_serialize(
            adb_getUserRoles_t* _getUserRoles,
            const axutil_env_t *env,
            axiom_node_t* getUserRoles_om_node, axiom_element_t *getUserRoles_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_getUserRoles is a particle class (E.g. group, inner sequence)
        ...
        adb_getUserRoles_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_getUserRoles_t object and return the property value.
