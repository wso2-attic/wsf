...
*/
        ...
        #ifndef ADB_UPDATEROLENAME_H
        #define ADB_UPDATEROLENAME_H

       /**
        * adb_updateRoleName.h
        *
        ...
        */
        ...
        typedef struct adb_updateRoleName adb_updateRoleName_t;
        ...
        /**
         * Constructor for creating adb_updateRoleName_t
         * @param env pointer to environment struct
         * @return newly created adb_updateRoleName_t object
         */
         ...
         * @param  _updateRoleName adb_updateRoleName_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_updateRoleName_t object
         * @param  _updateRoleName adb_updateRoleName_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for roleName. 
         * @param  _updateRoleName adb_updateRoleName_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
         ...
         * @param  _updateRoleName adb_updateRoleName_t object
         * @param env pointer to environment struct
         * @param arg_newRoleName axis2_char_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_updateRoleName_declare_parent_namespaces(
         ...
         * @param  _updateRoleName adb_updateRoleName_t object
         * @param env pointer to environment struct
         * @param updateRoleName_om_node node to serialize from
         * @param updateRoleName_om_element parent element to serialize from
        ...
        adb_updateRoleName_serialize(
            adb_updateRoleName_t* _updateRoleName,
            const axutil_env_t *env,
            axiom_node_t* updateRoleName_om_node, axiom_element_t *updateRoleName_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_updateRoleName is a particle class (E.g. group, inner sequence)
         ...
         * @param _newRoleName axis2_char_t*
         * @return newly created adb_updateRoleName_t object
         */
        adb_updateRoleName_t* AXIS2_CALL
        adb_updateRoleName_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_updateRoleName_t object and return the property value.
