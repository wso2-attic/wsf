...
*/
        ...
        #ifndef ADB_STOREPROPERTY_H
        #define ADB_STOREPROPERTY_H
        ...
        */
        ...
        typedef struct adb_StoreProperty adb_StoreProperty_t;
        ...
        /**
         * Constructor for creating adb_StoreProperty_t
         * @param env pointer to environment struct
         * @return newly created adb_StoreProperty_t object
         */
         ...
         * @param  _StoreProperty adb_StoreProperty_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_StoreProperty_t object
         * @param  _StoreProperty adb_StoreProperty_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for name. 
         * @param  _StoreProperty adb_StoreProperty_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_StoreProperty_declare_parent_namespaces(
         ...
         * @param  _StoreProperty adb_StoreProperty_t object
         * @param env pointer to environment struct
         * @param StoreProperty_om_node node to serialize from
         * @param StoreProperty_om_element parent element to serialize from
        ...
        adb_StoreProperty_serialize(
            adb_StoreProperty_t* _StoreProperty,
            const axutil_env_t *env,
            axiom_node_t* StoreProperty_om_node, axiom_element_t *StoreProperty_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_StoreProperty is a particle class (E.g. group, inner sequence)
        ...
        adb_StoreProperty_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_StoreProperty_t object and return the property value.
