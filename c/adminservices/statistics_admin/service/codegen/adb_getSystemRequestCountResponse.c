...
*/
       ...
       /************************* Function Implmentations ********************************/
            ...
            const axutil_env_t *env)
        {
            ...
            _getSystemRequestCountResponse->property_Type = axutil_strdup(env, "adb_getSystemRequestCountResponse");
                ...
                const axutil_env_t *env)
        {
            ...
            return adb_getSystemRequestCountResponse_free_obj(
                _getSystemRequestCountResponse,
                env);
            
        }

        axis2_status_t AXIS2_CALL
        adb_getSystemRequestCountResponse_free_obj(
                adb_getSystemRequestCountResponse_t* _getSystemRequestCountResponse,
                const axutil_env_t *env)
        {
            ...
            if (_getSystemRequestCountResponse->property_Type != NULL)
            {
              AXIS2_FREE(env->allocator, _getSystemRequestCountResponse->property_Type);
            }
                ...
                axis2_bool_t dont_care_minoccurs)
        {
            ...
            return adb_getSystemRequestCountResponse_deserialize_obj(
                _getSystemRequestCountResponse,
                env,
                dp_parent,
        ...
        axis2_status_t AXIS2_CALL
        adb_getSystemRequestCountResponse_deserialize_obj(
                adb_getSystemRequestCountResponse_t* _getSystemRequestCountResponse,
                const axutil_env_t *env,
                axiom_node_t **dp_parent,
                axis2_bool_t *dp_is_early_node_valid,
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
                ...
                return adb_getSystemRequestCountResponse_serialize_obj(
                    _getSystemRequestCountResponse, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index);
            
        }

        axiom_node_t* AXIS2_CALL
        adb_getSystemRequestCountResponse_serialize_obj(
                adb_getSystemRequestCountResponse_t* _getSystemRequestCountResponse,
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
