...
*/
       ...
       /************************* Private Function prototypes ********************************/
                ...
                adb_ServiceStatistics_set_avgResponseTime_nil(
                        adb_ServiceStatistics_t* _ServiceStatistics,
                        const axutil_env_t *env);
            

                axis2_status_t AXIS2_CALL
                adb_ServiceStatistics_set_faultCount_nil(
                        adb_ServiceStatistics_t* _ServiceStatistics,
                        const axutil_env_t *env);
            

                axis2_status_t AXIS2_CALL
                adb_ServiceStatistics_set_maxResponseTime_nil(
                        adb_ServiceStatistics_t* _ServiceStatistics,
                        const axutil_env_t *env);
            

                axis2_status_t AXIS2_CALL
                adb_ServiceStatistics_set_minResponseTime_nil(
                        adb_ServiceStatistics_t* _ServiceStatistics,
                        const axutil_env_t *env);
            

                axis2_status_t AXIS2_CALL
                adb_ServiceStatistics_set_requestCount_nil(
                        adb_ServiceStatistics_t* _ServiceStatistics,
                        const axutil_env_t *env);
            

                axis2_status_t AXIS2_CALL
                adb_ServiceStatistics_set_responseCount_nil(
                        adb_ServiceStatistics_t* _ServiceStatistics,
                        const axutil_env_t *env);
       ...
       /************************* Function Implmentations ********************************/
        ...
        adb_ServiceStatistics_create(
            const axutil_env_t *env)
        {
            adb_ServiceStatistics_t *_ServiceStatistics = NULL;
            
            AXIS2_ENV_CHECK(env, NULL);

            _ServiceStatistics = (adb_ServiceStatistics_t *) AXIS2_MALLOC(env->
                allocator, sizeof(adb_ServiceStatistics_t));

            if(NULL == _ServiceStatistics)
            {
                AXIS2_ERROR_SET(env->error, AXIS2_ERROR_NO_MEMORY, AXIS2_FAILURE);
                return NULL;
            }

            memset(_ServiceStatistics, 0, sizeof(adb_ServiceStatistics_t));

            _ServiceStatistics->property_Type = axutil_strdup(env, "adb_ServiceStatistics");
            _ServiceStatistics->is_valid_avgResponseTime  = AXIS2_FALSE;
            _ServiceStatistics->is_valid_faultCount  = AXIS2_FALSE;
            _ServiceStatistics->is_valid_maxResponseTime  = AXIS2_FALSE;
            _ServiceStatistics->is_valid_minResponseTime  = AXIS2_FALSE;
            _ServiceStatistics->is_valid_requestCount  = AXIS2_FALSE;
            _ServiceStatistics->is_valid_responseCount  = AXIS2_FALSE;
            

            return _ServiceStatistics;
        }
        ...
        adb_ServiceStatistics_create_with_values(
            const axutil_env_t *env,
                ...
                int _responseCount)
        {
            adb_ServiceStatistics_t* adb_obj = NULL;
            axis2_status_t status = AXIS2_SUCCESS;

            adb_obj = adb_ServiceStatistics_create(env);

            
              status = adb_ServiceStatistics_set_avgResponseTime(
                                     adb_obj,
                                     env,
                                     _avgResponseTime);
              if(status == AXIS2_FAILURE) {
                  adb_ServiceStatistics_free (adb_obj, env);
                  return NULL;
              }
            
              status = adb_ServiceStatistics_set_faultCount(
                                     adb_obj,
                                     env,
                                     _faultCount);
              if(status == AXIS2_FAILURE) {
              ...
              status = adb_ServiceStatistics_set_maxResponseTime(
                                     adb_obj,
                                     env,
                                     _maxResponseTime);
              if(status == AXIS2_FAILURE) {
              ...
              status = adb_ServiceStatistics_set_minResponseTime(
                                     adb_obj,
                                     env,
                                     _minResponseTime);
              if(status == AXIS2_FAILURE) {
              ...
              status = adb_ServiceStatistics_set_requestCount(
                                     adb_obj,
                                     env,
                                     _requestCount);
              if(status == AXIS2_FAILURE) {
              ...
              status = adb_ServiceStatistics_set_responseCount(
                                     adb_obj,
                                     env,
                                     _responseCount);
              if(status == AXIS2_FAILURE) {
        ...
        double AXIS2_CALL
                        ...
                        const axutil_env_t *env)
                {
                    ...
                    value = _ServiceStatistics->property_avgResponseTime;

                    adb_ServiceStatistics_free(_ServiceStatistics, env);
                ...
                const axutil_env_t *env)
        {
            ...
            return axis2_extension_mapper_free(
                (adb_type_t*) _ServiceStatistics,
                env,
                "adb_ServiceStatistics");
                ...
                const axutil_env_t *env)
        {
            ...
            AXIS2_PARAM_CHECK(env->error, _ServiceStatistics, AXIS2_FAILURE);

            if (_ServiceStatistics->property_Type != NULL)
            {
              AXIS2_FREE(env->allocator, _ServiceStatistics->property_Type);
            }

            adb_ServiceStatistics_reset_avgResponseTime(_ServiceStatistics, env);
            adb_ServiceStatistics_reset_faultCount(_ServiceStatistics, env);
            adb_ServiceStatistics_reset_maxResponseTime(_ServiceStatistics, env);
            adb_ServiceStatistics_reset_minResponseTime(_ServiceStatistics, env);
            adb_ServiceStatistics_reset_requestCount(_ServiceStatistics, env);
            adb_ServiceStatistics_reset_responseCount(_ServiceStatistics, env);
            

            if(_ServiceStatistics)
            {
                AXIS2_FREE(env->allocator, _ServiceStatistics);
                _ServiceStatistics = NULL;
            }
            ...
            AXIS2_PARAM_CHECK(env->error, _ServiceStatistics, AXIS2_FAILURE);
              ...
              if (NULL == parent)
              {
                ...
                AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, 
                            "Failed in building adb object for ServiceStatistics : "
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      if(text_value != NULL)
                                      {
                                            status = adb_ServiceStatistics_set_avgResponseTime(_ServiceStatistics, env,
                                                                   atof(text_value));
                                      }
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      if(text_value != NULL)
                                      {
                                            status = adb_ServiceStatistics_set_faultCount(_ServiceStatistics, env,
                                                                   atoi(text_value));
                                      }
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      if(text_value != NULL)
                                      {
                                            status = adb_ServiceStatistics_set_maxResponseTime(_ServiceStatistics, env,
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      if(text_value != NULL)
                                      {
                                            status = adb_ServiceStatistics_set_minResponseTime(_ServiceStatistics, env,
                                                                   axutil_strtol(text_value, (char**)NULL, 0));
                                      }
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      if(text_value != NULL)
                                      {
                                            status = adb_ServiceStatistics_set_requestCount(_ServiceStatistics, env,
                                                                   atoi(text_value));
                                      }
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      if(text_value != NULL)
                                      {
                                            status = adb_ServiceStatistics_set_responseCount(_ServiceStatistics, env,
                                                                   atoi(text_value));
                                      }
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
            ...
            if (_ServiceStatistics == NULL)
            {
                return adb_ServiceStatistics_serialize_obj(
                    _ServiceStatistics, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index);
            }
            else
            {
                return axis2_extension_mapper_serialize(
                    (adb_type_t*) _ServiceStatistics, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index, "adb_ServiceStatistics");
            }
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
         ...
         axiom_attribute_t* xsi_type_attri = NULL;
            ...
            AXIS2_ENV_CHECK(env, NULL);
            AXIS2_PARAM_CHECK(env->error, _ServiceStatistics, NULL);
            ...
            if(!parent_tag_closed)
            {
              ...
              type_attrib = axutil_strcat(env, " ", xsi_prefix, ":type=\"ServiceStatistics\"", NULL);
            ...
            xsi_ns = axiom_namespace_create (env,
                                 ...
                                 xsi_prefix);
            xsi_type_attri = axiom_attribute_create (env, "type", "ServiceStatistics", xsi_ns);
            ...
            axiom_element_add_attribute (parent_element, env, xsi_type_attri, parent);
                   ...
                   if (!_ServiceStatistics->is_valid_avgResponseTime)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                               ...
                               sprintf (text_value_1, "%f", (double)_ServiceStatistics->property_avgResponseTime);
                   ...
                   if (!_ServiceStatistics->is_valid_faultCount)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                               ...
                               sprintf (text_value_2, AXIS2_PRINTF_INT32_FORMAT_SPECIFIER, _ServiceStatistics->property_faultCount);
                   ...
                   if (!_ServiceStatistics->is_valid_maxResponseTime)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                               ...
                               sprintf (text_value_3, AXIS2_PRINTF_INT64_FORMAT_SPECIFIER, (int64_t) _ServiceStatistics->property_maxResponseTime);
                   ...
                   if (!_ServiceStatistics->is_valid_minResponseTime)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                               ...
                               sprintf (text_value_4, AXIS2_PRINTF_INT64_FORMAT_SPECIFIER, (int64_t) _ServiceStatistics->property_minResponseTime);
                   ...
                   if (!_ServiceStatistics->is_valid_requestCount)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                               ...
                               sprintf (text_value_5, AXIS2_PRINTF_INT32_FORMAT_SPECIFIER, _ServiceStatistics->property_requestCount);
                   ...
                   if (!_ServiceStatistics->is_valid_responseCount)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                               ...
                               sprintf (text_value_6, AXIS2_PRINTF_INT32_FORMAT_SPECIFIER, _ServiceStatistics->property_responseCount);
            ...
            adb_ServiceStatistics_get_property1(
                ...
                const axutil_env_t *env)
            {
                return adb_ServiceStatistics_get_avgResponseTime(_ServiceStatistics,
                                             env);
            }
            ...
            adb_ServiceStatistics_get_avgResponseTime(
                    ...
                    const axutil_env_t *env)
             {
                    ...
                    AXIS2_PARAM_CHECK(env->error, _ServiceStatistics, (double)0);
                  

                return _ServiceStatistics->property_avgResponseTime;
             }
            ...
            adb_ServiceStatistics_set_avgResponseTime(
                    ...
                    const double  arg_avgResponseTime)
             {
                ...
                if(_ServiceStatistics->is_valid_avgResponseTime &&
                        arg_avgResponseTime == _ServiceStatistics->property_avgResponseTime)
                {
                ...
                _ServiceStatistics->property_avgResponseTime = arg_avgResponseTime;
                        _ServiceStatistics->is_valid_avgResponseTime = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _ServiceStatistics, AXIS2_TRUE);
               
               return !_ServiceStatistics->is_valid_avgResponseTime;
           }
           ...
           adb_ServiceStatistics_set_avgResponseTime_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_ServiceStatistics_reset_avgResponseTime(_ServiceStatistics, env);
           }
            ...
            adb_ServiceStatistics_get_property2(
                ...
                const axutil_env_t *env)
            {
                return adb_ServiceStatistics_get_faultCount(_ServiceStatistics,
                                             env);
            }
            ...
            adb_ServiceStatistics_get_faultCount(
                    ...
                    const axutil_env_t *env)
             {
                    ...
                    AXIS2_PARAM_CHECK(env->error, _ServiceStatistics, (int)0);
                  

                return _ServiceStatistics->property_faultCount;
             }
            ...
            adb_ServiceStatistics_set_faultCount(
                    ...
                    const int  arg_faultCount)
             {
                ...
                if(_ServiceStatistics->is_valid_faultCount &&
                        arg_faultCount == _ServiceStatistics->property_faultCount)
                {
                ...
                _ServiceStatistics->property_faultCount = arg_faultCount;
                        _ServiceStatistics->is_valid_faultCount = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               return !_ServiceStatistics->is_valid_faultCount;
           }
           ...
           adb_ServiceStatistics_set_faultCount_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_ServiceStatistics_reset_faultCount(_ServiceStatistics, env);
           }
            ...
            adb_ServiceStatistics_get_property3(
                ...
                const axutil_env_t *env)
            {
                return adb_ServiceStatistics_get_maxResponseTime(_ServiceStatistics,
                                             env);
            }
            ...
            adb_ServiceStatistics_get_maxResponseTime(
                    ...
                    const axutil_env_t *env)
             {
                    ...
                    AXIS2_PARAM_CHECK(env->error, _ServiceStatistics, (int64_t)0);
                  

                return _ServiceStatistics->property_maxResponseTime;
             }
            ...
            adb_ServiceStatistics_set_maxResponseTime(
                    ...
                    const int64_t  arg_maxResponseTime)
             {
                ...
                if(_ServiceStatistics->is_valid_maxResponseTime &&
                        arg_maxResponseTime == _ServiceStatistics->property_maxResponseTime)
                {
                ...
                _ServiceStatistics->property_maxResponseTime = arg_maxResponseTime;
                        _ServiceStatistics->is_valid_maxResponseTime = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               return !_ServiceStatistics->is_valid_maxResponseTime;
           }
           ...
           adb_ServiceStatistics_set_maxResponseTime_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_ServiceStatistics_reset_maxResponseTime(_ServiceStatistics, env);
           }
            ...
            adb_ServiceStatistics_get_property4(
                ...
                const axutil_env_t *env)
            {
                return adb_ServiceStatistics_get_minResponseTime(_ServiceStatistics,
                                             env);
            }
            ...
            adb_ServiceStatistics_get_minResponseTime(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _ServiceStatistics->property_minResponseTime;
             }
            ...
            adb_ServiceStatistics_set_minResponseTime(
                    ...
                    const int64_t  arg_minResponseTime)
             {
                ...
                if(_ServiceStatistics->is_valid_minResponseTime &&
                        arg_minResponseTime == _ServiceStatistics->property_minResponseTime)
                {
                ...
                _ServiceStatistics->property_minResponseTime = arg_minResponseTime;
                        _ServiceStatistics->is_valid_minResponseTime = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               return !_ServiceStatistics->is_valid_minResponseTime;
           }
           ...
           adb_ServiceStatistics_set_minResponseTime_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_ServiceStatistics_reset_minResponseTime(_ServiceStatistics, env);
           }
            ...
            adb_ServiceStatistics_get_property5(
                ...
                const axutil_env_t *env)
            {
                return adb_ServiceStatistics_get_requestCount(_ServiceStatistics,
                                             env);
            }
            ...
            adb_ServiceStatistics_get_requestCount(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _ServiceStatistics->property_requestCount;
             }
            ...
            adb_ServiceStatistics_set_requestCount(
                    ...
                    const int  arg_requestCount)
             {
                ...
                if(_ServiceStatistics->is_valid_requestCount &&
                        arg_requestCount == _ServiceStatistics->property_requestCount)
                {
                ...
                _ServiceStatistics->property_requestCount = arg_requestCount;
                        _ServiceStatistics->is_valid_requestCount = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               return !_ServiceStatistics->is_valid_requestCount;
           }
           ...
           adb_ServiceStatistics_set_requestCount_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_ServiceStatistics_reset_requestCount(_ServiceStatistics, env);
           }
            ...
            adb_ServiceStatistics_get_property6(
                ...
                const axutil_env_t *env)
            {
                return adb_ServiceStatistics_get_responseCount(_ServiceStatistics,
                                             env);
            }
            ...
            adb_ServiceStatistics_get_responseCount(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _ServiceStatistics->property_responseCount;
             }
            ...
            adb_ServiceStatistics_set_responseCount(
                    ...
                    const int  arg_responseCount)
             {
                ...
                if(_ServiceStatistics->is_valid_responseCount &&
                        arg_responseCount == _ServiceStatistics->property_responseCount)
                {
                ...
                _ServiceStatistics->property_responseCount = arg_responseCount;
                        _ServiceStatistics->is_valid_responseCount = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               return !_ServiceStatistics->is_valid_responseCount;
           }
           ...
           adb_ServiceStatistics_set_responseCount_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_ServiceStatistics_reset_responseCount(_ServiceStatistics, env);
           }
