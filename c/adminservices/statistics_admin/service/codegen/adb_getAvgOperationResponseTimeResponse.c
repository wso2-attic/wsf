...
*/
       ...
       /************************* Function Implmentations ********************************/
            ...
            const axutil_env_t *env)
        {
            ...
            _getAvgOperationResponseTimeResponse->property_Type = axutil_strdup(env, "adb_getAvgOperationResponseTimeResponse");
                ...
                const axutil_env_t *env)
        {
            ...
            return adb_getAvgOperationResponseTimeResponse_free_obj(
                _getAvgOperationResponseTimeResponse,
                env);
                ...
                const axutil_env_t *env)
        {
            ...
            if (_getAvgOperationResponseTimeResponse->property_Type != NULL)
            {
              AXIS2_FREE(env->allocator, _getAvgOperationResponseTimeResponse->property_Type);
            }
                ...
                axis2_bool_t dont_care_minoccurs)
        {
            ...
            return adb_getAvgOperationResponseTimeResponse_deserialize_obj(
                _getAvgOperationResponseTimeResponse,
                env,
                dp_parent,
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
                ...
                return adb_getAvgOperationResponseTimeResponse_serialize_obj(
                    _getAvgOperationResponseTimeResponse, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index);
