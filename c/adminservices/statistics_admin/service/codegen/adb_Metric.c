...
*/
       ...
       /************************* Function Implmentations ********************************/
            ...
            const axutil_env_t *env)
        {
            ...
            _Metric->property_Type = axutil_strdup(env, "adb_Metric");
                ...
                const axutil_env_t *env)
        {
            ...
            if (_Metric->property_Type != NULL)
            {
              AXIS2_FREE(env->allocator, _Metric->property_Type);
            }
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
            ...
            if (_Metric == NULL)
            {
                return adb_Metric_serialize_obj(
                    _Metric, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index);
            }
            else
            {
                return axis2_extension_mapper_serialize(
                    (adb_type_t*) _Metric, env, parent, parent_element, parent_tag_closed, namespaces, next_ns_index, "adb_Metric");
            }
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
         ...
         axiom_attribute_t* xsi_type_attri = NULL;
            ...
            if(!parent_tag_closed)
            {
              ...
              type_attrib = axutil_strcat(env, " ", xsi_prefix, ":type=\"Metric\"", NULL);
            ...
            xsi_ns = axiom_namespace_create (env,
                                 ...
                                 xsi_prefix);
            xsi_type_attri = axiom_attribute_create (env, "type", "Metric", xsi_ns);
