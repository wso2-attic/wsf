...
*/
        ...
        #ifndef ADB_STOPSERVICE_H
        #define ADB_STOPSERVICE_H
        ...
        */
        ...
        typedef struct adb_stopService adb_stopService_t;
        ...
        /**
         * Constructor for creating adb_stopService_t
         * @param env pointer to environment struct
         * @return newly created adb_stopService_t object
         */
         ...
         * @param  _stopService adb_stopService_t object to free
         * @param env pointer to environment struct
         ...
         * @param  _stopService adb_stopService_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_stopService_declare_parent_namespaces(
         ...
         * @param  _stopService adb_stopService_t object
         * @param env pointer to environment struct
         * @param stopService_om_node node to serialize from
         * @param stopService_om_element parent element to serialize from
        ...
        adb_stopService_serialize(
            adb_stopService_t* _stopService,
            const axutil_env_t *env,
            axiom_node_t* stopService_om_node, axiom_element_t *stopService_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_stopService is a particle class (E.g. group, inner sequence)
        ...
        adb_stopService_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_stopService_t object and return the property value.
