...
*/
        ...
        #ifndef ADB_LISTSERVICEGROUPS_H
        #define ADB_LISTSERVICEGROUPS_H

       /**
        * adb_listServiceGroups.h
        *
        ...
        */
        ...
        typedef struct adb_listServiceGroups adb_listServiceGroups_t;
        ...
        /**
         * Constructor for creating adb_listServiceGroups_t
         * @param env pointer to environment struct
         * @return newly created adb_listServiceGroups_t object
         */
         ...
         * @param  _listServiceGroups adb_listServiceGroups_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_listServiceGroups_t object
         * @param  _listServiceGroups adb_listServiceGroups_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _listServiceGroups adb_listServiceGroups_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
         ...
         * @param  _listServiceGroups adb_listServiceGroups_t object
         * @param env pointer to environment struct
         * @param arg_serviceTypeFilter axis2_char_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _listServiceGroups adb_listServiceGroups_t object
         * @param env pointer to environment struct
         * @param arg_serviceGroupSearchString axis2_char_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_listServiceGroups_declare_parent_namespaces(
         ...
         * @param  _listServiceGroups adb_listServiceGroups_t object
         * @param env pointer to environment struct
         * @param listServiceGroups_om_node node to serialize from
         * @param listServiceGroups_om_element parent element to serialize from
        ...
        adb_listServiceGroups_serialize(
            adb_listServiceGroups_t* _listServiceGroups,
            const axutil_env_t *env,
            axiom_node_t* listServiceGroups_om_node, axiom_element_t *listServiceGroups_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_listServiceGroups is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_listServiceGroups_t
         * @param env pointer to environment struct
         * @param _serviceTypeFilter axis2_char_t*
         * @param _serviceGroupSearchString axis2_char_t*
         * @param _pageNumber int
         * @return newly created adb_listServiceGroups_t object
         */
        adb_listServiceGroups_t* AXIS2_CALL
        adb_listServiceGroups_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_listServiceGroups_t object and return the property value.
