...
*/
        ...
        #ifndef ADB_CHANGESERVICESTATE_H
        #define ADB_CHANGESERVICESTATE_H

       /**
        * adb_changeServiceState.h
        *
        ...
        */
        ...
        typedef struct adb_changeServiceState adb_changeServiceState_t;
        ...
        /**
         * Constructor for creating adb_changeServiceState_t
         * @param env pointer to environment struct
         * @return newly created adb_changeServiceState_t object
         */
         ...
         * @param  _changeServiceState adb_changeServiceState_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_changeServiceState_t object
         * @param  _changeServiceState adb_changeServiceState_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _changeServiceState adb_changeServiceState_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
         ...
         * @param  _changeServiceState adb_changeServiceState_t object
         * @param env pointer to environment struct
         * @param arg_isActive axis2_bool_t
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_changeServiceState_declare_parent_namespaces(
         ...
         * @param  _changeServiceState adb_changeServiceState_t object
         * @param env pointer to environment struct
         * @param changeServiceState_om_node node to serialize from
         * @param changeServiceState_om_element parent element to serialize from
        ...
        adb_changeServiceState_serialize(
            adb_changeServiceState_t* _changeServiceState,
            const axutil_env_t *env,
            axiom_node_t* changeServiceState_om_node, axiom_element_t *changeServiceState_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_changeServiceState is a particle class (E.g. group, inner sequence)
        ...
        adb_changeServiceState_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_changeServiceState_t object and return the property value.
     ...
     #endif /* ADB_CHANGESERVICESTATE_H */
