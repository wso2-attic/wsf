...
*/
        ...
        #ifndef ADB_REMOVESERVICEPOLICIESBYNAMESPACE_H
        #define ADB_REMOVESERVICEPOLICIESBYNAMESPACE_H

       /**
        * adb_removeServicePoliciesByNamespace.h
        *
       ...
       /**
        *  adb_removeServicePoliciesByNamespace class
        */
        ...
        typedef struct adb_removeServicePoliciesByNamespace adb_removeServicePoliciesByNamespace_t;
        ...
        /**
         * Constructor for creating adb_removeServicePoliciesByNamespace_t
         * @param env pointer to environment struct
         * @return newly created adb_removeServicePoliciesByNamespace_t object
         */
         ...
         * @param  _removeServicePoliciesByNamespace adb_removeServicePoliciesByNamespace_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_removeServicePoliciesByNamespace_t object
         * @param  _removeServicePoliciesByNamespace adb_removeServicePoliciesByNamespace_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _removeServicePoliciesByNamespace adb_removeServicePoliciesByNamespace_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
         ...
         * @param  _removeServicePoliciesByNamespace adb_removeServicePoliciesByNamespace_t object
         * @param env pointer to environment struct
         * @param arg_namesapce axis2_char_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_removeServicePoliciesByNamespace_declare_parent_namespaces(
         ...
         * @param  _removeServicePoliciesByNamespace adb_removeServicePoliciesByNamespace_t object
         * @param env pointer to environment struct
         * @param removeServicePoliciesByNamespace_om_node node to serialize from
         * @param removeServicePoliciesByNamespace_om_element parent element to serialize from
        ...
        adb_removeServicePoliciesByNamespace_serialize(
            adb_removeServicePoliciesByNamespace_t* _removeServicePoliciesByNamespace,
            const axutil_env_t *env,
            axiom_node_t* removeServicePoliciesByNamespace_om_node, axiom_element_t *removeServicePoliciesByNamespace_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_removeServicePoliciesByNamespace is a particle class (E.g. group, inner sequence)
        ...
        adb_removeServicePoliciesByNamespace_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_removeServicePoliciesByNamespace_t object and return the property value.
     ...
     #endif /* ADB_REMOVESERVICEPOLICIESBYNAMESPACE_H */
