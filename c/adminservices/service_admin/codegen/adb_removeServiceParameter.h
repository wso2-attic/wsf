...
*/
        ...
        #ifndef ADB_REMOVESERVICEPARAMETER_H
        #define ADB_REMOVESERVICEPARAMETER_H

       /**
        * adb_removeServiceParameter.h
        *
       ...
       /**
        *  adb_removeServiceParameter class
        */
        ...
        typedef struct adb_removeServiceParameter adb_removeServiceParameter_t;
        ...
        /**
         * Constructor for creating adb_removeServiceParameter_t
         * @param env pointer to environment struct
         * @return newly created adb_removeServiceParameter_t object
         */
         ...
         * @param  _removeServiceParameter adb_removeServiceParameter_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_removeServiceParameter_t object
         * @param  _removeServiceParameter adb_removeServiceParameter_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _removeServiceParameter adb_removeServiceParameter_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_removeServiceParameter_declare_parent_namespaces(
         ...
         * @param  _removeServiceParameter adb_removeServiceParameter_t object
         * @param env pointer to environment struct
         * @param removeServiceParameter_om_node node to serialize from
         * @param removeServiceParameter_om_element parent element to serialize from
        ...
        adb_removeServiceParameter_serialize(
            adb_removeServiceParameter_t* _removeServiceParameter,
            const axutil_env_t *env,
            axiom_node_t* removeServiceParameter_om_node, axiom_element_t *removeServiceParameter_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_removeServiceParameter is a particle class (E.g. group, inner sequence)
        ...
        adb_removeServiceParameter_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_removeServiceParameter_t object and return the property value.
     ...
     #endif /* ADB_REMOVESERVICEPARAMETER_H */
