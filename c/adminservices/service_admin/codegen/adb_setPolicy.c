...
*/
       ...
       /************************* Function Implmentations ********************************/
            ...
            const axutil_env_t *env)
        {
            ...
            _setPolicy->property_serviceName  = NULL;
                  _setPolicy->is_valid_serviceName  = AXIS2_FALSE;
            _setPolicy->property_policyString  = NULL;
                  _setPolicy->is_valid_policyString  = AXIS2_FALSE;
                ...
                axis2_char_t* _policyString)
        {
            ...
            adb_obj = adb_setPolicy_create(env);
              ...
              status = adb_setPolicy_set_serviceName(
                                     adb_obj,
                                     env,
                                     _serviceName);
              ...
              status = adb_setPolicy_set_policyString(
                                     adb_obj,
                                     env,
                                     _policyString);
              if(status == AXIS2_FAILURE) {
        ...
        axis2_char_t* AXIS2_CALL
                        ...
                        const axutil_env_t *env)
                {
                    ...
                    value = _setPolicy->property_serviceName;

                    _setPolicy->property_serviceName = (axis2_char_t*)NULL;
                ...
                const axutil_env_t *env)
        {
            ...
            adb_setPolicy_reset_serviceName(_setPolicy, env);
            adb_setPolicy_reset_policyString(_setPolicy, env);
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      if(text_value != NULL)
                                      {
                                            status = adb_setPolicy_set_serviceName(_setPolicy, env,
                                                               text_value);
                                      }
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      if(text_value != NULL)
                                      {
                                            status = adb_setPolicy_set_policyString(_setPolicy, env,
                                                               text_value);
                                      }
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
         ...
         int tag_closed = 0;
            ...
            AXIS2_PARAM_CHECK(env->error, _setPolicy, NULL);
                   ...
                   if (!_setPolicy->is_valid_serviceName)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                           ...
                           text_value_1 = _setPolicy->property_serviceName;
                   ...
                   if (!_setPolicy->is_valid_policyString)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                           ...
                           text_value_2 = _setPolicy->property_policyString;
            ...
            adb_setPolicy_get_property1(
                ...
                const axutil_env_t *env)
            {
                return adb_setPolicy_get_serviceName(_setPolicy,
                                             env);
            }
            ...
            adb_setPolicy_get_serviceName(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _setPolicy->property_serviceName;
             }
            ...
            adb_setPolicy_set_serviceName(
                    ...
                    const axis2_char_t*  arg_serviceName)
             {
                ...
                if(_setPolicy->is_valid_serviceName &&
                        arg_serviceName == _setPolicy->property_serviceName)
                {
                ...
                _setPolicy->property_serviceName = (axis2_char_t *)axutil_strdup(env, arg_serviceName);
                        if(NULL == _setPolicy->property_serviceName)
                        {
                            AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, "Error allocating memeory for serviceName");
                            return AXIS2_FAILURE;
                        }
                        _setPolicy->is_valid_serviceName = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _setPolicy, AXIS2_FAILURE);
                ...
                if(_setPolicy->property_serviceName != NULL)
                {
                   
                   
                        AXIS2_FREE(env-> allocator, _setPolicy->property_serviceName);
                     _setPolicy->property_serviceName = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               return !_setPolicy->is_valid_serviceName;
           }
           ...
           adb_setPolicy_set_serviceName_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_setPolicy_reset_serviceName(_setPolicy, env);
           }
            ...
            adb_setPolicy_get_property2(
                ...
                const axutil_env_t *env)
            {
                return adb_setPolicy_get_policyString(_setPolicy,
                                             env);
            }
            ...
            adb_setPolicy_get_policyString(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _setPolicy->property_policyString;
             }
            ...
            adb_setPolicy_set_policyString(
                    ...
                    const axis2_char_t*  arg_policyString)
             {
                ...
                if(_setPolicy->is_valid_policyString &&
                        arg_policyString == _setPolicy->property_policyString)
                {
                ...
                _setPolicy->property_policyString = (axis2_char_t *)axutil_strdup(env, arg_policyString);
                        if(NULL == _setPolicy->property_policyString)
                        {
                            AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, "Error allocating memeory for policyString");
                            return AXIS2_FAILURE;
                        }
                        _setPolicy->is_valid_policyString = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _setPolicy, AXIS2_FAILURE);
                ...
                if(_setPolicy->property_policyString != NULL)
                {
                   
                   
                        AXIS2_FREE(env-> allocator, _setPolicy->property_policyString);
                     _setPolicy->property_policyString = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               return !_setPolicy->is_valid_policyString;
           }
           ...
           adb_setPolicy_set_policyString_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_setPolicy_reset_policyString(_setPolicy, env);
           }
