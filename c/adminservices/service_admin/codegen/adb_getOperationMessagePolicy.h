...
*/
        ...
        #ifndef ADB_GETOPERATIONMESSAGEPOLICY_H
        #define ADB_GETOPERATIONMESSAGEPOLICY_H

       /**
        * adb_getOperationMessagePolicy.h
        *
       ...
       /**
        *  adb_getOperationMessagePolicy class
        */
        ...
        typedef struct adb_getOperationMessagePolicy adb_getOperationMessagePolicy_t;
        ...
        /**
         * Constructor for creating adb_getOperationMessagePolicy_t
         * @param env pointer to environment struct
         * @return newly created adb_getOperationMessagePolicy_t object
         */
         ...
         * @param  _getOperationMessagePolicy adb_getOperationMessagePolicy_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_getOperationMessagePolicy_t object
         * @param  _getOperationMessagePolicy adb_getOperationMessagePolicy_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _getOperationMessagePolicy adb_getOperationMessagePolicy_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_getOperationMessagePolicy_declare_parent_namespaces(
         ...
         * @param  _getOperationMessagePolicy adb_getOperationMessagePolicy_t object
         * @param env pointer to environment struct
         * @param getOperationMessagePolicy_om_node node to serialize from
         * @param getOperationMessagePolicy_om_element parent element to serialize from
        ...
        adb_getOperationMessagePolicy_serialize(
            adb_getOperationMessagePolicy_t* _getOperationMessagePolicy,
            const axutil_env_t *env,
            axiom_node_t* getOperationMessagePolicy_om_node, axiom_element_t *getOperationMessagePolicy_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_getOperationMessagePolicy is a particle class (E.g. group, inner sequence)
        ...
        adb_getOperationMessagePolicy_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_getOperationMessagePolicy_t object and return the property value.
     ...
     #endif /* ADB_GETOPERATIONMESSAGEPOLICY_H */
