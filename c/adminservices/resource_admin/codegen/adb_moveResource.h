...
*/
        ...
        #ifndef ADB_MOVERESOURCE_H
        #define ADB_MOVERESOURCE_H
        ...
        */
        ...
        typedef struct adb_moveResource adb_moveResource_t;
        ...
        /**
         * Constructor for creating adb_moveResource_t
         * @param env pointer to environment struct
         * @return newly created adb_moveResource_t object
         */
         ...
         * @param  _moveResource adb_moveResource_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_moveResource_t object
         * @param  _moveResource adb_moveResource_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _moveResource adb_moveResource_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_moveResource_declare_parent_namespaces(
         ...
         * @param  _moveResource adb_moveResource_t object
         * @param env pointer to environment struct
         * @param moveResource_om_node node to serialize from
         * @param moveResource_om_element parent element to serialize from
        ...
        adb_moveResource_serialize(
            adb_moveResource_t* _moveResource,
            const axutil_env_t *env,
            axiom_node_t* moveResource_om_node, axiom_element_t *moveResource_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_moveResource is a particle class (E.g. group, inner sequence)
        ...
        adb_moveResource_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_moveResource_t object and return the property value.
