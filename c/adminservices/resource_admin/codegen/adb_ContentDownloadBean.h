...
*/
        ...
        #ifndef ADB_CONTENTDOWNLOADBEAN_H
        #define ADB_CONTENTDOWNLOADBEAN_H

       /**
        * adb_ContentDownloadBean.h
        *
        ...
        */
        ...
        typedef struct adb_ContentDownloadBean adb_ContentDownloadBean_t;
        ...
        /**
         * Constructor for creating adb_ContentDownloadBean_t
         * @param env pointer to environment struct
         * @return newly created adb_ContentDownloadBean_t object
         */
         ...
         * @param  _ContentDownloadBean adb_ContentDownloadBean_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_ContentDownloadBean_t object
         * @param  _ContentDownloadBean adb_ContentDownloadBean_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for content. 
         * @param  _ContentDownloadBean adb_ContentDownloadBean_t object
         * @param env pointer to environment struct
         ...
         * @param  _ContentDownloadBean adb_ContentDownloadBean_t object
         * @param env pointer to environment struct
         * @param arg_lastUpdatedTime axutil_date_time_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_ContentDownloadBean_declare_parent_namespaces(
         ...
         * @param  _ContentDownloadBean adb_ContentDownloadBean_t object
         * @param env pointer to environment struct
         * @param ContentDownloadBean_om_node node to serialize from
         * @param ContentDownloadBean_om_element parent element to serialize from
        ...
        adb_ContentDownloadBean_serialize(
            adb_ContentDownloadBean_t* _ContentDownloadBean,
            const axutil_env_t *env,
            axiom_node_t* ContentDownloadBean_om_node, axiom_element_t *ContentDownloadBean_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_ContentDownloadBean is a particle class (E.g. group, inner sequence)
         ...
         * @param _lastUpdatedTime axutil_date_time_t*
        ...
        adb_ContentDownloadBean_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_ContentDownloadBean_t object and return the property value.
     ...
     #endif /* ADB_CONTENTDOWNLOADBEAN_H */
