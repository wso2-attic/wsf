...
static void WSF_UNIT_CALL test_axutil_properties_create(wsf_unit_test_case_t *tc, void *data)
{
    ...
    WSF_UNIT_ASSERT_TRUE(tc, "Set Property Failed", 
        axutil_properties_set_property(prop, env, PROPERTIES_TEST_KEY_2, (char *)axutil_strdup(env, "this.was.changed")));
    ...
    WSF_UNIT_ASSERT_TRUE(tc, "Set Property Failed", 
        axutil_properties_set_property(prop, env, PROPERTIES_TEST_KEY_4, (char *)axutil_strdup(env, "this.is.all,new")));
