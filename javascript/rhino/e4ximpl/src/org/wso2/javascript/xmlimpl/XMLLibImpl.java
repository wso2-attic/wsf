...
public final class XMLLibImpl extends XMLLib implements Serializable {
    ...
    public String escapeAttributeValue(Object value) {
        ...
        OMElement omElement = factory.createOMElement("a", null);
        OMAttribute omAttribute = factory.createOMAttribute("a", null, text);
    ...
    public String escapeTextValue(Object value) {
        ...
        OMFactory factory = OMAbstractFactory.getOMFactory();
        OMElement omElement = factory.createOMElement("a", null);
        OMText omText = factory.createOMText(text);
    ...
    Object addXMLObjects(Context cx, XMLObject obj1, XMLObject obj2) {
        ...
        if (obj1 instanceof XMLList) {
            ...
            if (list1.length() == 1) {
                listToAdd.addToList(list1.getFromAxiomNodeList(0));
            } else {
                ...
                listToAdd = XMLList.toXMLList(this, obj1);
            }
        } else {
        ...
        if (obj2 instanceof XMLList) {
            ...
            for (int i = 0; i < list2.length(); i++) {
                listToAdd.addToList(list2.getFromAxiomNodeList(i));
            }
    ...
    QName constructQNameFromString(Context cx, String localName) {
        ...
        if ("*".equals(localName)) {
            ...
            //If the default namespace is not set then uri="" prefix =""
