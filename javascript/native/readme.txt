...
Please copy  the javascript libarary to the locations ./samples/firefox/ and ./samples/ie when you run the samples

Sample ZIP codes and a google key can be found in the api_key.txt
