...
echo_exe:
	...
	@link.exe $(LDFLAGS) int.msvc\echo\echo\*.obj $(LIBS) /OUT:$(WSFCPP_HOME_DIR)\bin\samples\cpp\echo.exe
             -@$(_VC_MANIFEST_EMBED_EXE)
...
echo_blocking_exe:
	...
	@link.exe $(LDFLAGS) int.msvc\echo\echo_blocking\*.obj $(LIBS) /OUT:$(WSFCPP_HOME_DIR)\bin\samples\cpp\echo_blocking.exe
             -@$(_VC_MANIFEST_EMBED_EXE)
...
echo_blocking_addr_exe:
	...
	@link.exe $(LDFLAGS) int.msvc\echo\echo_blocking_addr\*.obj $(LIBS) /OUT:$(WSFCPP_HOME_DIR)\bin\samples\cpp\echo_blocking_addr.exe
             -@$(_VC_MANIFEST_EMBED_EXE)
...
echo_blocking_dual_exe:
	...
	@link.exe $(LDFLAGS) int.msvc\echo\echo_blocking_dual\*.obj $(LIBS) /OUT:$(WSFCPP_HOME_DIR)\bin\samples\cpp\echo_blocking_dual.exe
             -@$(_VC_MANIFEST_EMBED_EXE)
...
echo_blocking_soap11_exe:
	...
	@link.exe $(LDFLAGS) int.msvc\echo\echo_blocking_soap11\*.obj $(LIBS) /OUT:$(WSFCPP_HOME_DIR)\bin\samples\cpp\echo_blocking_soap11.exe
             -@$(_VC_MANIFEST_EMBED_EXE)
...
echo_non_blocking_exe:
	...
	@link.exe $(LDFLAGS) int.msvc\echo\echo_non_blocking\*.obj $(LIBS) /OUT:$(WSFCPP_HOME_DIR)\bin\samples\cpp\echo_non_blocking.exe
             -@$(_VC_MANIFEST_EMBED_EXE)
...
echo_non_blocking_dual_exe:
	...
	@link.exe $(LDFLAGS) int.msvc\echo\echo_non_blocking_dual\*.obj $(LIBS) /OUT:$(WSFCPP_HOME_DIR)\bin\samples\cpp\echo_non_blocking_dual.exe
             -@$(_VC_MANIFEST_EMBED_EXE)
...
echo_rest_exe:
	...
	@link.exe $(LDFLAGS) int.msvc\echo\echo_rest\*.obj $(LIBS) /OUT:$(WSFCPP_HOME_DIR)\bin\samples\cpp\echo_rest.exe
             -@$(_VC_MANIFEST_EMBED_EXE)
...
echo_security_exe:
	...
	@link.exe $(LDFLAGS) int.msvc\echo\echo_security\*.obj $(LIBS) /OUT:$(WSFCPP_HOME_DIR)\bin\samples\cpp\echo_security.exe
             -@$(_VC_MANIFEST_EMBED_EXE)
...
flickr_exe:
	...
	@link.exe $(LDFLAGS) int.msvc\flickr\*.obj $(LIBS) /OUT:$(WSFCPP_HOME_DIR)\bin\samples\cpp\flickr.exe
             -@$(_VC_MANIFEST_EMBED_EXE)
...
google_exe:
	...
	@link.exe $(LDFLAGS) int.msvc\google\*.obj $(LIBS) /OUT:$(WSFCPP_HOME_DIR)\bin\samples\cpp\google.exe
             -@$(_VC_MANIFEST_EMBED_EXE)
...
math_exe:
	...
	@link.exe $(LDFLAGS) int.msvc\math\*.obj $(LIBS) /OUT:$(WSFCPP_HOME_DIR)\bin\samples\cpp\math.exe
             -@$(_VC_MANIFEST_EMBED_EXE)
...
yahoo_exe:
	...
	@link.exe $(LDFLAGS) int.msvc\yahoo\*.obj $(LIBS) /OUT:$(WSFCPP_HOME_DIR)\bin\samples\cpp\yahoo.exe
             -@$(_VC_MANIFEST_EMBED_EXE)
...
mtom_exe:
	...
	@link.exe $(LDFLAGS) int.msvc\mtom\*.obj $(LIBS) /OUT:$(WSFCPP_HOME_DIR)\bin\samples\cpp\mtom.exe
             -@$(_VC_MANIFEST_EMBED_EXE)
             @xcopy /E /I /Q /Y $(SAMPLES_HOME_DIR)\mtom\resources $(WSFCPP_HOME_DIR)\bin\samples\cpp\resources
             @del $(WSFCPP_HOME_DIR)\bin\samples\cpp\resources\*.am
