...
public class CPPStubSourceWriter extends FileWriter {

    public CPPStubSourceWriter(String outputFileLocation) {
        this.outputFileLocation = new File(outputFileLocation);
    }

    public CPPStubSourceWriter(File outputFileLocation, String language) {
