...
public class CPPCallbackHeaderWriter extends FileWriter {

    public CPPCallbackHeaderWriter(String outputFileLocation) {
        this.outputFileLocation = new File(outputFileLocation);
    }

    public CPPCallbackHeaderWriter(File outputFileLocation, String language) {
