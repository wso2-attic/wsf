...
public class CPPSvcSkeletonHeaderWriter extends FileWriter {

    public CPPSvcSkeletonHeaderWriter(String outputFileLocation) {
        this.outputFileLocation = new File(outputFileLocation);
    }

    public CPPSvcSkeletonHeaderWriter(File outputFileLocation, String language) {
