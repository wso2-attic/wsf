...
public class WSDLJavaAdvanceDialog extends Dialog {
	...
	protected WSDLJavaAdvanceDialog(Shell shell, HashMap advanceOptions,boolean eControls) {
		super(shell);
		...
		this.enableControls = eControls;
	}

	private Button addCheckBox(Composite container,
			final Button tmpCheckBox,String caption,final String parameterType, boolean languageDependent){
		...
		if(languageDependent){
			tmpCheckBox.setEnabled(enableControls);
		}
		if (isEditAdvanceOptions)
	...
	private Text addTextBox(Composite container,Label lblCaption, 
			final Text tmpTextBox, String caption,final String parameterType,boolean isBrowseFolder, boolean languageDependent){
		GridData gd = new GridData(GridData.FILL_HORIZONTAL);
		gd.horizontalSpan = 1;
		gd.widthHint=200;
		...
		if(languageDependent)
			tmpTextBox.setEnabled(enableControls);
		return tmpTextBox;
	}
	...
	protected Control createDialogArea(final Composite parent) {
		...
		addTextBox(container,new Label(container,SWT.NULL), new Text(container,SWT.BORDER), 
				...
				CommandLineOptionConstants.WSDL2JavaConstants.REPOSITORY_PATH_OPTION,true, false);
		addTextBox(container,new Label(container,SWT.NULL), new Text(container,SWT.BORDER), 
				"Specify a directory path for generated source", 
				CommandLineOptionConstants.WSDL2JavaConstants.SOURCE_FOLDER_NAME_OPTION,true, false);
		addTextBox(container,new Label(container,SWT.NULL), new Text(container,SWT.BORDER), 
				"Specify a directory path for generated resources", 
				CommandLineOptionConstants.WSDL2JavaConstants.RESOURCE_FOLDER_OPTION,true, false);
		addTextBox(container,new Label(container,SWT.NULL), new Text(container,SWT.BORDER), 
				"Proxy host address if you are behind a firewall", 
				CommandLineOptionConstants.WSDL2JavaConstants.HTTP_PROXY_HOST_OPTION_LONG,false, true);
		addTextBox(container,new Label(container,SWT.NULL), new Text(container,SWT.BORDER), 
				"Proxy port address if you are behind a firewall", 
				CommandLineOptionConstants.WSDL2JavaConstants.HTTP_PROXY_PORT_OPTION_LONG,false, true);
		addTextBox(container,new Label(container,SWT.NULL), new Text(container,SWT.BORDER), 
				"Skelton interface name", 
				CommandLineOptionConstants.WSDL2JavaConstants.SKELTON_INTERFACE_NAME_OPTION,false, true);
		addTextBox(container,new Label(container,SWT.NULL), new Text(container,SWT.BORDER), 
				"Skelton class name", 
				CommandLineOptionConstants.WSDL2JavaConstants.SKELTON_CLASS_NAME_OPTION,false, true);
		...
		tmpCheckBox=new Button(container, SWT.CHECK);addCheckBox(container,tmpCheckBox, 
				...
				CommandLineOptionConstants.WSDL2JavaConstants.UNPACK_CLASSES_OPTION, false);
		tmpCheckBox=new Button(container, SWT.CHECK);addCheckBox(container,tmpCheckBox, 
				"Flattens the generated files", 
				CommandLineOptionConstants.WSDL2JavaConstants.FLATTEN_FILES_OPTION, true);
		tmpCheckBox=new Button(container, SWT.CHECK);addCheckBox(container,tmpCheckBox, 
				"Switch on un-wrapping", 
				CommandLineOptionConstants.WSDL2JavaConstants.UNWRAP_PARAMETERS, false);
		tmpCheckBox=new Button(container, SWT.CHECK);addCheckBox(container,tmpCheckBox, 
				"Generate code for all ports", 
				CommandLineOptionConstants.WSDL2JavaConstants.All_PORTS_OPTION, false);
		tmpCheckBox=new Button(container, SWT.CHECK);addCheckBox(container,tmpCheckBox, 
				"Overwrite the existing classes", 
				CommandLineOptionConstants.WSDL2JavaConstants.OVERRIDE_OPTION, false);
		tmpCheckBox=new Button(container, SWT.CHECK);addCheckBox(container,tmpCheckBox, 
				"Generate Axis 1.x backword compatible code", 
				CommandLineOptionConstants.WSDL2JavaConstants.BACKWORD_COMPATIBILITY_OPTION, true);
		tmpCheckBox=new Button(container, SWT.CHECK);addCheckBox(container,tmpCheckBox, 
				"Suppress namespace prefixes (Optimzation that reduces size of soap request/response)", 
				CommandLineOptionConstants.WSDL2JavaConstants.SUPPRESS_PREFIXES_OPTION, true);
		tmpCheckBox=new Button(container, SWT.CHECK);addCheckBox(container,tmpCheckBox, 
				"Dont generate the build.xml in the output directory", 
				CommandLineOptionConstants.WSDL2JavaConstants.NO_BUILD_XML_OPTION_LONG, true);
		tmpCheckBox=new Button(container, SWT.CHECK);addCheckBox(container,tmpCheckBox, 
				"Dont generate WSDLs in the resources directory", 
				CommandLineOptionConstants.WSDL2JavaConstants.NO_WSDLS_OPTION_LONG, true);
		tmpCheckBox=new Button(container, SWT.CHECK);addCheckBox(container,tmpCheckBox, 
				"Dont generate a MessageReceiver in the generated sources", 
				CommandLineOptionConstants.WSDL2JavaConstants.NO_MESSAGE_RECEIVER_OPTION_LONG, true);
		...
		addNewExcludePackageName.setEnabled(enableControls);
