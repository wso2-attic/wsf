...
namespace org_wso2_www_types
{
        ...
        /**
         * Constructor for class BuyRequest
         */

        BuyRequest();

        /**
         * Destructor BuyRequest
         */
        ~BuyRequest();
       ...
       /**
         ...
         * @param BuyRequest_om_node node to serialize from
         * @param BuyRequest_om_element parent element to serialize from
        ...
        serialize(axiom_node_t* BuyRequest_om_node, axiom_element_t *BuyRequest_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);

        /**
         * Check whether the BuyRequest is a particle class (E.g. group, inner sequence)
