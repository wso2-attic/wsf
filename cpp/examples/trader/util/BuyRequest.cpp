        ...
        using namespace org_wso2_www_types;
               ...
               /*
                * Implementation of the buyRequest|http://www.wso2.org/types Element
                */
           org_wso2_www_types::BuyRequest::BuyRequest()
        {
       ...
       org_wso2_www_types::BuyRequest::BuyRequest(std::string arg_Userid,std::string arg_Password,std::string arg_Symbol,int arg_Qty)
        {
        ...
        bool WSF_CALL
        org_wso2_www_types::BuyRequest::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                        WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI,
                              "Failed in building adb object for buyRequest : "
          ...
          bool WSF_CALL
          org_wso2_www_types::BuyRequest::isParticle()
          {
          ...
          void WSF_CALL
          org_wso2_www_types::BuyRequest::declareParentNamespaces(
	...
	org_wso2_www_types::BuyRequest::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
         ...
         int tag_closed = 0;
               ...
               axutil_stream_t *stream = NULL;
                ...
                int next_ns_index_value = 0;
                    ...
                    parent_element = axiom_element_create (Environment::getEnv(), NULL, "buyRequest", ns1 , &parent);
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::BuyRequest::getProperty1()
            {
                return getUserid();
            }
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::BuyRequest::getUserid()
             {
             ...
             */
            bool WSF_CALL
            org_wso2_www_types::BuyRequest::setUserid(
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::BuyRequest::resetUserid()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::BuyRequest::isUseridNil()
           {
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::BuyRequest::setUseridNil()
           {
               return resetUserid();
           }
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::BuyRequest::getProperty2()
            {
                return getPassword();
            }
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::BuyRequest::getPassword()
             {
             ...
             */
            bool WSF_CALL
            org_wso2_www_types::BuyRequest::setPassword(
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::BuyRequest::resetPassword()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::BuyRequest::isPasswordNil()
           {
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::BuyRequest::setPasswordNil()
           {
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::BuyRequest::getProperty3()
            {
                return getSymbol();
            }
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::BuyRequest::getSymbol()
             {
             ...
             */
            bool WSF_CALL
            org_wso2_www_types::BuyRequest::setSymbol(
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::BuyRequest::resetSymbol()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::BuyRequest::isSymbolNil()
           {
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::BuyRequest::setSymbolNil()
           {
               return resetSymbol();
           }
             ...
             */
            int WSF_CALL
            org_wso2_www_types::BuyRequest::getProperty4()
            {
                return getQty();
            }
             ...
             */
            int WSF_CALL
            org_wso2_www_types::BuyRequest::getQty()
             {
                return property_Qty;
             }
             ...
             */
            bool WSF_CALL
            org_wso2_www_types::BuyRequest::setQty(
                    const int  arg_Qty)
             {
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::BuyRequest::resetQty()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::BuyRequest::isQtyNil()
           {
               return !isValidQty;
           }
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::BuyRequest::setQtyNil()
           {
               return resetQty();
           }
