        ...
        using namespace org_wso2_www_types;
               ...
               /*
                * Implementation of the loginRequest|http://www.wso2.org/types Element
                */
           org_wso2_www_types::LoginRequest::LoginRequest()
        {
       ...
       org_wso2_www_types::LoginRequest::LoginRequest(std::string arg_Username,std::string arg_Password)
        {
            ...
            isValidPassword  = true;
                 ...
                 qname =  axutil_qname_create (Environment::getEnv(),
                    ...
                    property_Username = arg_Username;
        ...
        bool WSF_CALL
        org_wso2_www_types::LoginRequest::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                        WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI,
                              "Failed in building adb object for loginRequest : "
                      ...
                      */
                                 ...
                                 element_qname = axutil_qname_create(Environment::getEnv(), "username", NULL, NULL);
                                 

                           if ( 
                                (current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("username", axiom_element_get_localname(current_element, Environment::getEnv())))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("username", axiom_element_get_localname(current_element, Environment::getEnv()))))
                              {
                                is_early_node_valid = true;
                                      ...
                                      else
                                      {
                                            ...
                                            {
                                                WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI, "NULL value is set to a non nillable element username");
                                 ...
                                 {
                                     WSF_LOG_ERROR_MSG( Environment::getEnv()->log,WSF_LOG_SI,"failed in setting the value for username ");
                                     if(element_qname)
                                     {
				  ...
				  WSF_LOG_ERROR_MSG(Environment::getEnv()->log,WSF_LOG_SI, "non nillable or minOuccrs != 0 element username missing");
                                  return AXIS2_FAILURE;
                              }
          ...
          bool WSF_CALL
          org_wso2_www_types::LoginRequest::isParticle()
          {
          ...
          void WSF_CALL
          org_wso2_www_types::LoginRequest::declareParentNamespaces(
	...
	org_wso2_www_types::LoginRequest::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
         ...
         int tag_closed = 0;
               ...
               axutil_stream_t *stream = NULL;
                ...
                int next_ns_index_value = 0;
                    ...
                    parent_element = axiom_element_create (Environment::getEnv(), NULL, "loginRequest", ns1 , &parent);
                   ...
                   if (!isValidUsername)
                   {
                            ...
                            WSF_LOG_ERROR_MSG( Environment::getEnv()->log,WSF_LOG_SI,"Nil value found in non-nillable property username");
                            return NULL;
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                           ...
                           text_value_1 = (axis2_char_t*)property_Username.c_str();
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::LoginRequest::getProperty1()
            {
                return getUsername();
            }
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::LoginRequest::getUsername()
             {
             ...
             */
            bool WSF_CALL
            org_wso2_www_types::LoginRequest::setUsername(
                    const std::string  arg_Username)
             {
                

                if(isValidUsername &&
                        arg_Username == property_Username)
                {
                  ...
                  if(arg_Username.empty())
                       
                  {
                      WSF_LOG_ERROR_MSG( Environment::getEnv()->log,WSF_LOG_SI,"username is being set to NULL, but it is not a nullable element");
                      return AXIS2_FAILURE;
                  }
                ...
                resetUsername();
                        ...
                        property_Username = std::string(arg_Username.c_str());
                        isValidUsername = true;
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::LoginRequest::resetUsername()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::LoginRequest::isUsernameNil()
           {
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::LoginRequest::setUsernameNil()
           {
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::LoginRequest::getProperty2()
            {
                return getPassword();
            }
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::LoginRequest::getPassword()
             {
             ...
             */
            bool WSF_CALL
            org_wso2_www_types::LoginRequest::setPassword(
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::LoginRequest::resetPassword()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::LoginRequest::isPasswordNil()
           {
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::LoginRequest::setPasswordNil()
           {
