        ...
        using namespace org_wso2_www_types;
                 ...
                 */
           org_wso2_www_types::StockQuote::StockQuote()
        {
       ...
       org_wso2_www_types::StockQuote::StockQuote(std::string arg_Name,std::string arg_Symbol,float arg_Price,float arg_High,float arg_Low)
        {
            ...
            isValidLow  = true;
                    ...
                    property_Price = arg_Price;
            
                    property_High = arg_High;
            
                    property_Low = arg_Low;
        ...
        bool WSF_CALL
        org_wso2_www_types::StockQuote::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                  ...
                  if(element_qname)
                  {
                      ...
                      */
                                 ...
                                 element_qname = axutil_qname_create(Environment::getEnv(), "price", NULL, NULL);
                                 

                           if ( 
                                (current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("price", axiom_element_get_localname(current_element, Environment::getEnv())))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("price", axiom_element_get_localname(current_element, Environment::getEnv()))))
                              {
                                is_early_node_valid = true;
                              }
                                      ...
                                      if(text_value != NULL)
                                      {
                                            status = setPrice(atof(text_value));
                                      }
                                      
                                      else
                                      {
                                          WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI, "NULL value is set to a non nillable element price");
                                          status = AXIS2_FAILURE;
                                      }
                                      
                                 if(AXIS2_FAILURE ==  status)
                                 {
                                     WSF_LOG_ERROR_MSG( Environment::getEnv()->log,WSF_LOG_SI,"failed in setting the value for price ");
                                     if(element_qname)
                                     {
                                         axutil_qname_free(element_qname, Environment::getEnv());
                                     }
                              ...
                              else if(!dont_care_minoccurs)
                              {
                                  ...
                                  /* this is not a nillable element*/
				  WSF_LOG_ERROR_MSG(Environment::getEnv()->log,WSF_LOG_SI, "non nillable or minOuccrs != 0 element price missing");
                                  return AXIS2_FAILURE;
                              }
                  ...
                  if(element_qname)
                  {
                      ...
                      */
                                 ...
                                 element_qname = axutil_qname_create(Environment::getEnv(), "high", NULL, NULL);
                                 

                           if ( 
                                (current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("high", axiom_element_get_localname(current_element, Environment::getEnv())))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("high", axiom_element_get_localname(current_element, Environment::getEnv()))))
                              {
                                is_early_node_valid = true;
                              }
                                      ...
                                      if(text_value != NULL)
                                      {
                                            status = setHigh(atof(text_value));
                                      }
                                      
                                      else
                                      {
                                          WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI, "NULL value is set to a non nillable element high");
                                          status = AXIS2_FAILURE;
                                      }
                                      
                                 if(AXIS2_FAILURE ==  status)
                                 {
                                     WSF_LOG_ERROR_MSG( Environment::getEnv()->log,WSF_LOG_SI,"failed in setting the value for high ");
                                     if(element_qname)
                                     {
                                         axutil_qname_free(element_qname, Environment::getEnv());
                                     }
                              ...
                              else if(!dont_care_minoccurs)
                              {
                                  ...
                                  /* this is not a nillable element*/
				  WSF_LOG_ERROR_MSG(Environment::getEnv()->log,WSF_LOG_SI, "non nillable or minOuccrs != 0 element high missing");
                                  return AXIS2_FAILURE;
                              }
                  ...
                  if(element_qname)
                  {
                      ...
                      */
                                 ...
                                 element_qname = axutil_qname_create(Environment::getEnv(), "low", NULL, NULL);
                                 

                           if ( 
                                (current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("low", axiom_element_get_localname(current_element, Environment::getEnv())))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("low", axiom_element_get_localname(current_element, Environment::getEnv()))))
                              {
                                is_early_node_valid = true;
                              }
                                      ...
                                      if(text_value != NULL)
                                      {
                                            status = setLow(atof(text_value));
                                      }
                                      
                                      else
                                      {
                                          WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI, "NULL value is set to a non nillable element low");
                                          status = AXIS2_FAILURE;
                                      }
                                      
                                 if(AXIS2_FAILURE ==  status)
                                 {
                                     WSF_LOG_ERROR_MSG( Environment::getEnv()->log,WSF_LOG_SI,"failed in setting the value for low ");
                                     if(element_qname)
                                     {
                                         axutil_qname_free(element_qname, Environment::getEnv());
                                     }
                              ...
                              else if(!dont_care_minoccurs)
                              {
                                  ...
                                  /* this is not a nillable element*/
				  WSF_LOG_ERROR_MSG(Environment::getEnv()->log,WSF_LOG_SI, "non nillable or minOuccrs != 0 element low missing");
                                  return AXIS2_FAILURE;
                              }
          ...
          bool WSF_CALL
          org_wso2_www_types::StockQuote::isParticle()
          {
          ...
          void WSF_CALL
          org_wso2_www_types::StockQuote::declareParentNamespaces(
	...
	org_wso2_www_types::StockQuote::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
			...
			int *next_ns_index)
        {
         ...
         int tag_closed = 0;
            ...
            if(!parent_tag_closed)
            {
              ...
              tag_closed = 1;
                   ...
                   if (!isValidPrice)
                   {
                            ...
                            WSF_LOG_ERROR_MSG( Environment::getEnv()->log,WSF_LOG_SI,"Nil value found in non-nillable property price");
                            return NULL;
                   ...
                   else
                   {
                     start_input_str = (axis2_char_t*)AXIS2_MALLOC(Environment::getEnv()->allocator, sizeof(axis2_char_t) *
                                 ...
                                 /* axutil_strlen("<:>") + 1 = 4 */
                     end_input_str = (axis2_char_t*)AXIS2_MALLOC(Environment::getEnv()->allocator, sizeof(axis2_char_t) *
                                 (5 + axutil_strlen(p_prefix) + axutil_strlen("price")));
                                  /* axutil_strlen("</:>") + 1 = 5 */
                      ...
                      */
                            ...
                            sprintf(start_input_str, "<%s%sprice>",
                                 p_prefix?p_prefix:"",
                                 (p_prefix && axutil_strcmp(p_prefix, ""))?":":"");
                            
                        start_input_str_len = axutil_strlen(start_input_str);
                        sprintf(end_input_str, "</%s%sprice>",
                                 p_prefix?p_prefix:"",
                                 (p_prefix && axutil_strcmp(p_prefix, ""))?":":"");
                        end_input_str_len = axutil_strlen(end_input_str);
                    
                               sprintf (text_value_3, "%f", (float)property_Price);
                   ...
                   if (!isValidHigh)
                   {
                            ...
                            WSF_LOG_ERROR_MSG( Environment::getEnv()->log,WSF_LOG_SI,"Nil value found in non-nillable property high");
                            return NULL;
                   ...
                   else
                   {
                     start_input_str = (axis2_char_t*)AXIS2_MALLOC(Environment::getEnv()->allocator, sizeof(axis2_char_t) *
                                 ...
                                 /* axutil_strlen("<:>") + 1 = 4 */
                     end_input_str = (axis2_char_t*)AXIS2_MALLOC(Environment::getEnv()->allocator, sizeof(axis2_char_t) *
                                 (5 + axutil_strlen(p_prefix) + axutil_strlen("high")));
                                  /* axutil_strlen("</:>") + 1 = 5 */
                      ...
                      */
                            ...
                            sprintf(start_input_str, "<%s%shigh>",
                                 p_prefix?p_prefix:"",
                                 (p_prefix && axutil_strcmp(p_prefix, ""))?":":"");
                            
                        start_input_str_len = axutil_strlen(start_input_str);
                        sprintf(end_input_str, "</%s%shigh>",
                                 p_prefix?p_prefix:"",
                                 (p_prefix && axutil_strcmp(p_prefix, ""))?":":"");
                        end_input_str_len = axutil_strlen(end_input_str);
                    
                               sprintf (text_value_4, "%f", (float)property_High);
                   ...
                   if (!isValidLow)
                   {
                            ...
                            WSF_LOG_ERROR_MSG( Environment::getEnv()->log,WSF_LOG_SI,"Nil value found in non-nillable property low");
                            return NULL;
                   ...
                   else
                   {
                     start_input_str = (axis2_char_t*)AXIS2_MALLOC(Environment::getEnv()->allocator, sizeof(axis2_char_t) *
                                 ...
                                 /* axutil_strlen("<:>") + 1 = 4 */
                     end_input_str = (axis2_char_t*)AXIS2_MALLOC(Environment::getEnv()->allocator, sizeof(axis2_char_t) *
                                 (5 + axutil_strlen(p_prefix) + axutil_strlen("low")));
                                  /* axutil_strlen("</:>") + 1 = 5 */
                      ...
                      */
                            ...
                            sprintf(start_input_str, "<%s%slow>",
                                 p_prefix?p_prefix:"",
                                 (p_prefix && axutil_strcmp(p_prefix, ""))?":":"");
                            
                        start_input_str_len = axutil_strlen(start_input_str);
                        sprintf(end_input_str, "</%s%slow>",
                                 p_prefix?p_prefix:"",
                                 (p_prefix && axutil_strcmp(p_prefix, ""))?":":"");
                        end_input_str_len = axutil_strlen(end_input_str);
                    
                               sprintf (text_value_5, "%f", (float)property_Low);
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::StockQuote::getProperty1()
            {
                return getName();
            }
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::StockQuote::getName()
             {
             ...
             */
            bool WSF_CALL
            org_wso2_www_types::StockQuote::setName(
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::StockQuote::resetName()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::StockQuote::isNameNil()
           {
               return !isValidName;
           }
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::StockQuote::setNameNil()
           {
               return resetName();
           }
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::StockQuote::getProperty2()
            {
                return getSymbol();
            }
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::StockQuote::getSymbol()
             {
             ...
             */
            bool WSF_CALL
            org_wso2_www_types::StockQuote::setSymbol(
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::StockQuote::resetSymbol()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::StockQuote::isSymbolNil()
           {
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::StockQuote::setSymbolNil()
           {
               return resetSymbol();
           }
             ...
             */
            float WSF_CALL
            org_wso2_www_types::StockQuote::getProperty3()
            {
                return getPrice();
            }
             ...
             */
            float WSF_CALL
            org_wso2_www_types::StockQuote::getPrice()
             {
             ...
             */
            bool WSF_CALL
            org_wso2_www_types::StockQuote::setPrice(
                    const float  arg_Price)
             {
                

                if(isValidPrice &&
                        arg_Price == property_Price)
                {
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::StockQuote::resetPrice()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::StockQuote::isPriceNil()
           {
               return !isValidPrice;
           }

           /**
            * Set price to nill (currently the same as reset)
            */
           bool WSF_CALL
           org_wso2_www_types::StockQuote::setPriceNil()
           {
               return resetPrice();
           }
             ...
             */
            float WSF_CALL
            org_wso2_www_types::StockQuote::getProperty4()
            {
                return getHigh();
            }
             ...
             */
            float WSF_CALL
            org_wso2_www_types::StockQuote::getHigh()
             {
                return property_High;
             }
             ...
             */
            bool WSF_CALL
            org_wso2_www_types::StockQuote::setHigh(
                    const float  arg_High)
             {
                

                if(isValidHigh &&
                        arg_High == property_High)
                {
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::StockQuote::resetHigh()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::StockQuote::isHighNil()
           {
               return !isValidHigh;
           }

           /**
            * Set high to nill (currently the same as reset)
            */
           bool WSF_CALL
           org_wso2_www_types::StockQuote::setHighNil()
           {
               return resetHigh();
           }
             ...
             */
            float WSF_CALL
            org_wso2_www_types::StockQuote::getProperty5()
            {
                return getLow();
            }
             ...
             */
            float WSF_CALL
            org_wso2_www_types::StockQuote::getLow()
             {
                return property_Low;
             }
             ...
             */
            bool WSF_CALL
            org_wso2_www_types::StockQuote::setLow(
                    const float  arg_Low)
             {
                

                if(isValidLow &&
                        arg_Low == property_Low)
                {
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::StockQuote::resetLow()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::StockQuote::isLowNil()
           {
               return !isValidLow;
           }

           /**
            * Set low to nill (currently the same as reset)
            */
           bool WSF_CALL
           org_wso2_www_types::StockQuote::setLowNil()
           {
               return resetLow();
           }
