        ...
        using namespace org_wso2_www_types;
               ...
               /*
                * Implementation of the registerClientResponse|http://www.wso2.org/types Element
                */
           org_wso2_www_types::RegisterClientResponse::RegisterClientResponse()
        {
       ...
       org_wso2_www_types::RegisterClientResponse::RegisterClientResponse(std::string arg_Userid)
        {
        ...
        bool WSF_CALL
        org_wso2_www_types::RegisterClientResponse::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                        WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI,
                              "Failed in building adb object for registerClientResponse : "
          ...
          bool WSF_CALL
          org_wso2_www_types::RegisterClientResponse::isParticle()
          {
          ...
          void WSF_CALL
          org_wso2_www_types::RegisterClientResponse::declareParentNamespaces(
	...
	org_wso2_www_types::RegisterClientResponse::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
         ...
         int tag_closed = 0;
               ...
               axutil_stream_t *stream = NULL;
                ...
                int next_ns_index_value = 0;
                    ...
                    parent_element = axiom_element_create (Environment::getEnv(), NULL, "registerClientResponse", ns1 , &parent);
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::RegisterClientResponse::getProperty1()
            {
                return getUserid();
            }
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::RegisterClientResponse::getUserid()
             {
             ...
             */
            bool WSF_CALL
            org_wso2_www_types::RegisterClientResponse::setUserid(
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::RegisterClientResponse::resetUserid()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::RegisterClientResponse::isUseridNil()
           {
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::RegisterClientResponse::setUseridNil()
           {
               return resetUserid();
           }
