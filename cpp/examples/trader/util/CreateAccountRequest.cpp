        ...
        using namespace org_wso2_www_types;
               ...
               /*
                * Implementation of the createAccountRequest|http://www.wso2.org/types Element
                */
           org_wso2_www_types::CreateAccountRequest::CreateAccountRequest()
        {
       ...
       org_wso2_www_types::CreateAccountRequest::CreateAccountRequest(org_wso2_www_types::ClientInfo* arg_Clientinfo,std::string arg_Password)
        {
        ...
        bool WSF_CALL
        org_wso2_www_types::CreateAccountRequest::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                        WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI,
                              "Failed in building adb object for createAccountRequest : "
          ...
          bool WSF_CALL
          org_wso2_www_types::CreateAccountRequest::isParticle()
          {
          ...
          void WSF_CALL
          org_wso2_www_types::CreateAccountRequest::declareParentNamespaces(
	...
	org_wso2_www_types::CreateAccountRequest::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
         ...
         int tag_closed = 0;
               ...
               axutil_stream_t *stream = NULL;
                ...
                int next_ns_index_value = 0;
                    ...
                    parent_element = axiom_element_create (Environment::getEnv(), NULL, "createAccountRequest", ns1 , &parent);
            ...
            org_wso2_www_types::CreateAccountRequest::getProperty1()
            {
             ...
             */
            org_wso2_www_types::ClientInfo* WSF_CALL
            org_wso2_www_types::CreateAccountRequest::getClientinfo()
             {
             ...
             */
            bool WSF_CALL
            org_wso2_www_types::CreateAccountRequest::setClientinfo(
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::CreateAccountRequest::resetClientinfo()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::CreateAccountRequest::isClientinfoNil()
           {
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::CreateAccountRequest::setClientinfoNil()
           {
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::CreateAccountRequest::getProperty2()
            {
                return getPassword();
            }
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::CreateAccountRequest::getPassword()
             {
             ...
             */
            bool WSF_CALL
            org_wso2_www_types::CreateAccountRequest::setPassword(
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::CreateAccountRequest::resetPassword()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::CreateAccountRequest::isPasswordNil()
           {
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::CreateAccountRequest::setPasswordNil()
           {
