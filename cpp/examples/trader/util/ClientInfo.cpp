        ...
        using namespace org_wso2_www_types;
                 ...
                 */
           org_wso2_www_types::ClientInfo::ClientInfo()
        {
       ...
       org_wso2_www_types::ClientInfo::ClientInfo(std::string arg_Name,std::string arg_Ssn)
        {
        ...
        bool WSF_CALL
        org_wso2_www_types::ClientInfo::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                  ...
                  if(element_qname)
                  {
                      ...
                      */
                                 ...
                                 element_qname = axutil_qname_create(Environment::getEnv(), "ssn", NULL, NULL);
                                 

                           if ( 
                                (current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("ssn", axiom_element_get_localname(current_element, Environment::getEnv())))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("ssn", axiom_element_get_localname(current_element, Environment::getEnv()))))
                              {
                                is_early_node_valid = true;
                              }
                                      ...
                                      else
                                      {
                                            ...
                                            if(attrib_text && 0 == axutil_strcmp(attrib_text, "1"))
                                            {
                                                WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI, "NULL value is set to a non nillable element ssn");
                                                status = AXIS2_FAILURE;
                                            }
                                            else
                                            {
                                 ...
                                 if(AXIS2_FAILURE ==  status)
                                 {
                                     WSF_LOG_ERROR_MSG( Environment::getEnv()->log,WSF_LOG_SI,"failed in setting the value for ssn ");
                                     if(element_qname)
                                     {
                                         axutil_qname_free(element_qname, Environment::getEnv());
                                     }
                              ...
                              else if(!dont_care_minoccurs)
                              {
                                  ...
                                  /* this is not a nillable element*/
				  WSF_LOG_ERROR_MSG(Environment::getEnv()->log,WSF_LOG_SI, "non nillable or minOuccrs != 0 element ssn missing");
                                  return AXIS2_FAILURE;
                              }
          ...
          bool WSF_CALL
          org_wso2_www_types::ClientInfo::isParticle()
          {
          ...
          void WSF_CALL
          org_wso2_www_types::ClientInfo::declareParentNamespaces(
	...
	org_wso2_www_types::ClientInfo::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
			...
			int *next_ns_index)
        {
         ...
         int tag_closed = 0;
            ...
            if(!parent_tag_closed)
            {
              ...
              tag_closed = 1;
                   ...
                   if (!isValidSsn)
                   {
                            ...
                            WSF_LOG_ERROR_MSG( Environment::getEnv()->log,WSF_LOG_SI,"Nil value found in non-nillable property ssn");
                            return NULL;
                   ...
                   else
                   {
                     start_input_str = (axis2_char_t*)AXIS2_MALLOC(Environment::getEnv()->allocator, sizeof(axis2_char_t) *
                                 ...
                                 /* axutil_strlen("<:>") + 1 = 4 */
                     end_input_str = (axis2_char_t*)AXIS2_MALLOC(Environment::getEnv()->allocator, sizeof(axis2_char_t) *
                                 (5 + axutil_strlen(p_prefix) + axutil_strlen("ssn")));
                                  /* axutil_strlen("</:>") + 1 = 5 */
                      ...
                      */
                            ...
                            sprintf(start_input_str, "<%s%sssn>",
                                 p_prefix?p_prefix:"",
                                 (p_prefix && axutil_strcmp(p_prefix, ""))?":":"");
                            
                        start_input_str_len = axutil_strlen(start_input_str);
                        sprintf(end_input_str, "</%s%sssn>",
                                 p_prefix?p_prefix:"",
                                 (p_prefix && axutil_strcmp(p_prefix, ""))?":":"");
                        end_input_str_len = axutil_strlen(end_input_str);
                    
                           text_value_2 = (axis2_char_t*)property_Ssn.c_str();
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::ClientInfo::getProperty1()
            {
                return getName();
            }
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::ClientInfo::getName()
             {
             ...
             */
            bool WSF_CALL
            org_wso2_www_types::ClientInfo::setName(
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::ClientInfo::resetName()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::ClientInfo::isNameNil()
           {
               return !isValidName;
           }
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::ClientInfo::setNameNil()
           {
               return resetName();
           }
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::ClientInfo::getProperty2()
            {
                return getSsn();
            }
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::ClientInfo::getSsn()
             {
                return property_Ssn;
             }
             ...
             */
            bool WSF_CALL
            org_wso2_www_types::ClientInfo::setSsn(
                    const std::string  arg_Ssn)
             {
                

                if(isValidSsn &&
                        arg_Ssn == property_Ssn)
                {
                  ...
                  {
                      WSF_LOG_ERROR_MSG( Environment::getEnv()->log,WSF_LOG_SI,"ssn is being set to NULL, but it is not a nullable element");
                      return AXIS2_FAILURE;
                  }
                ...
                resetSsn();
                        ...
                        property_Ssn = std::string(arg_Ssn.c_str());
                        isValidSsn = true;
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::ClientInfo::resetSsn()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::ClientInfo::isSsnNil()
           {
               return !isValidSsn;
           }

           /**
            * Set ssn to nill (currently the same as reset)
            */
           bool WSF_CALL
           org_wso2_www_types::ClientInfo::setSsnNil()
           {
               return resetSsn();
           }
