        ...
        using namespace org_wso2_www_types;
               ...
               /*
                * Implementation of the buyResponse|http://www.wso2.org/types Element
                */
           org_wso2_www_types::BuyResponse::BuyResponse()
        {
       ...
       org_wso2_www_types::BuyResponse::BuyResponse(org_wso2_www_types::TradeStatus* arg_Trade_status)
        {
        ...
        bool WSF_CALL
        org_wso2_www_types::BuyResponse::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                        WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI,
                              "Failed in building adb object for buyResponse : "
          ...
          bool WSF_CALL
          org_wso2_www_types::BuyResponse::isParticle()
          {
          ...
          void WSF_CALL
          org_wso2_www_types::BuyResponse::declareParentNamespaces(
	...
	org_wso2_www_types::BuyResponse::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
         ...
         int tag_closed = 0;
               ...
               axutil_stream_t *stream = NULL;
                ...
                int next_ns_index_value = 0;
                    ...
                    parent_element = axiom_element_create (Environment::getEnv(), NULL, "buyResponse", ns1 , &parent);
            ...
            org_wso2_www_types::BuyResponse::getProperty1()
            {
             ...
             */
            org_wso2_www_types::TradeStatus* WSF_CALL
            org_wso2_www_types::BuyResponse::getTrade_status()
             {
             ...
             */
            bool WSF_CALL
            org_wso2_www_types::BuyResponse::setTrade_status(
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::BuyResponse::resetTrade_status()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::BuyResponse::isTrade_statusNil()
           {
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::BuyResponse::setTrade_statusNil()
           {
