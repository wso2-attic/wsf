        ...
        using namespace org_wso2_www_types;
               ...
               /*
                * Implementation of the getQuoteRequest|http://www.wso2.org/types Element
                */
           org_wso2_www_types::GetQuoteRequest::GetQuoteRequest()
        {
       ...
       org_wso2_www_types::GetQuoteRequest::GetQuoteRequest(std::string arg_Symbol)
        {
        ...
        bool WSF_CALL
        org_wso2_www_types::GetQuoteRequest::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                        WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI,
                              "Failed in building adb object for getQuoteRequest : "
          ...
          bool WSF_CALL
          org_wso2_www_types::GetQuoteRequest::isParticle()
          {
          ...
          void WSF_CALL
          org_wso2_www_types::GetQuoteRequest::declareParentNamespaces(
	...
	org_wso2_www_types::GetQuoteRequest::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
         ...
         int tag_closed = 0;
               ...
               axutil_stream_t *stream = NULL;
                ...
                int next_ns_index_value = 0;
                    ...
                    parent_element = axiom_element_create (Environment::getEnv(), NULL, "getQuoteRequest", ns1 , &parent);
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                           ...
                           text_value_1 = (axis2_char_t*)property_Symbol.c_str();
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::GetQuoteRequest::getProperty1()
            {
                return getSymbol();
            }
             ...
             */
            std::string WSF_CALL
            org_wso2_www_types::GetQuoteRequest::getSymbol()
             {
             ...
             */
            bool WSF_CALL
            org_wso2_www_types::GetQuoteRequest::setSymbol(
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::GetQuoteRequest::resetSymbol()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::GetQuoteRequest::isSymbolNil()
           {
            ...
            */
           bool WSF_CALL
           org_wso2_www_types::GetQuoteRequest::setSymbolNil()
           {
               return resetSymbol();
           }
