...
<head>
	...
	<script language="javascript">
        ...
        function comment_make_visible(anchor)
        {
        	...
        	{
				comment_area_div.innerHTML = '<form action="dbs2phptool.php" method="<?php echo FORM_METHOD; ?>">'+
			                                            ...
			                                            <div id="content_description">
			                                            	<table>
			                                            		...
			                                            		<tr>
                                                                    ...
                                                                    ?>
                                                                    <form id="dbs2phpform" method="GET" action="dbs2phptool.php">
                                                                        <div>
                                                                            <div style="float:left;width:150px">
                                                                                <label>Try Some Examples</label>
                                                                            </div>
                                                                            <div style="float:left;">
                                                                                <select onchange="javascript:document.getElementById('dbs2phpform').submit()" name="example">
                                                                        ...
                                                                        <div>
                                                                            <div style="float:left;width:150px">
                                                                                <label>Edit your DBS XML here</label>
                                                                            </div>
                                                                            <div style="float:left;">&nbsp;
                                                                            </div>
                                                                            <div style="float:left">&nbsp;
                                                                    ...
                                                                    ?>
                                                                    <form id="dbs2phpform" method="post" action="dbs2phptool.php">
			                                            		...
			                                            		<tr>
			                                            			...
			                                            			<td>
                                                                        ...
                                                                        <?php 
                                                                            // doing the dbs2php generation
                                                                            $service_code = $_POST["service_code"];
                                                                            $service_code = str_replace("\\\"", "\"", $service_code);

                                                                            // the conversion logic..

                                                                            $dbs_doc = new DOMDocument();
                                                                            if(!$dbs_doc->loadXML($service_code)) {
                                                                                echo "Error parsing the code as an XML!";
                                                                            }
                                                                            else {
                                                                                $xslt_doc = new DOMDocument();
                                                                                if(!$xslt_doc->load("dbs2php.xslt")) {
                                                                                    ...
                                                                                    $result = $xslt->transformToXML($dbs_doc);
