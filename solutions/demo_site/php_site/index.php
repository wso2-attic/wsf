			...
			<?php
			 ...
			 ?>
													...
													<?php
														$i = 0;
                                                        if($username == NULL) {
                                                            $star_title = "title=\"Please login and go inside the demo to rate it\"";
                                                        }
                                                        else {
                                                            $star_title = "title=\"Please go inside the demo to rate it\"";
                                                        }
														...
														if(is_array($resources))
														{
															foreach($resources as $resource)
															{
				                                            	...
				                                            	//<td class="table_data"><a href="resource_view.php?url={$path}">{$title}</a></td>
															      echo <<<END
				                                            		<tr>
				                                            			<td class="table_data"><a href="resource_view.php?url={$title}">{$title}</a></td>
				                                            			<?php echo ""?>
				                                            			...
				                                            			<td class="table_data_right">
																	       <div {$star_title}>
																	            <img {$star_title} id="rated_{$i}_1" src="images/stars/r00.gif"/>
																	            <img {$star_title} id="rated_{$i}_2" src="images/stars/r00.gif"/>
																	            <img {$star_title} id="rated_{$i}_3" src="images/stars/r00.gif"/>
																	            <img {$star_title} id="rated_{$i}_4" src="images/stars/r00.gif"/>
																	            <img {$star_title} id="rated_{$i}_5" src="images/stars/r00.gif"/>
																	       </div>
				                                            			</td>
				                                            		</tr>
END;
