...
<body>
	<div id="page">
		...
		<div id="content">
			<div id="welcome">
				<h2> <?php echo "<a href='demo.php?name={$extracted_title}&demo={$demo}&src={$src}'>{$extracted_title}</a>"; ?></h2>
			</div>
			                                            ...
			                                            <div id="content_description">
			                                            	<table>
			                                            		...
			                                            		if(isset($demo) && !empty($demo))
			                                            		{
			                                            		 ...
			                                            		 ?>
				                                            		<tr>
				                                            			...
				                                            			<td class="left_align"><?php echo "<a href='demo.php?name={$extracted_title}&demo={$demo}&src={$src}'>{$demo_home}{$demo}</a>"?></td>
				                                            			<td>&nbsp;</td>
				                                            			<td>&nbsp;</td>
				                                            		</tr>
			                                            		<?php
																...
																?>
			                                            		<tr>
			                                            			<td class="right_align"><?php if(isset($src)) { echo "<b>Source</b>"; } ?></td>
                                                                    <td class="left_align"><?php if(isset($src)) {echo "<a href='source_page_frame.php?src={$src}'>View source online</a>"; } ?></td>
			                                            			<!--<td class="left_align"><?php echo "<a href='demo.php?name={$extracted_title}&demo={$demo}&src={$src}'>{$demo}</a>"?></td> -->
			                                            			<td>&nbsp;</td>
			                                            			<td>&nbsp;</td>
			                                            		</tr>
			                                            		<?php
                                                                ...
                                                                <?php
                                                                    if($username == NULL) {
                                                                        $star_title = "title=\"Please login to rate the demo\"";
                                                                    }
                                                                    else {
                                                                        $star_title = "";
                                                                    }
