...
if($demo == NULL || empty($demo))
{
	...
	$demo = "resource_view.php?url={$labs_php_home}/{$name}&aschild=1";
}
else
{
	$pos = strpos($demo, "?");
			...
			<div id="demobar_content">
				<div id="demobar_content_topic" style="width:250px;">
					<div style="float:left">
						<h2><a href="javascript:form_resources_view('{$labs_php_home}/{$name}')">{$name}</a></h2>
					</div>
...
DEMOBAR;
			...
			<h3 class="downloads">Popular <a href="http://wso2.org/downloads/wsf/c">Downloads</a></h3>
			<div class="wsfphp_downloads">
			<ul>
			<li>
			<a class="binary" href="http://dist.wso2.org/products/wsf/c/wso2-wsf-c-1.2.0.msi">Windows Binary</a>
			</li>
			<li>
			<a class="zip" href="http://dist.wso2.org/products/wsf/c/wso2-wsf-c-src-1.2.0.zip">Source Zip</a>
			</li>
			<li>
			<a class="srctarball" href="http://dist.wso2.org/products/wsf/c/wso2-wsf-c-src-1.2.0.tar.gz">Source TarBall</a>
			</li>
			</ul>
			</div>
