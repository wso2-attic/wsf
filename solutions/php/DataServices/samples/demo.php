...
define("DEMO1_ENDPOINT", "http://localhost/solutions/DataServices/samples/EmployeesByNumberService.php");
define("DEMO2_ENDPOINT", "http://localhost/solutions/DataServices/samples/CustomersInBostonService.php");
define("DEMO3_ENDPOINT", "http://localhost/solutions/DataServices/samples/CustomerOrdersService.php");
define("DEMO4_ENDPOINT", "http://localhost/solutions/DataServices/samples/NestedQueryService.php");
...
XML;
    ...
    try {
        $client = new WSClient(array( "to" => DEMO3_ENDPOINT, "useWSA"=>TRUE,"action"=>"urn:ds"));
        $responseMessage = $client->request( $request );
        $response = $responseMessage->str;
