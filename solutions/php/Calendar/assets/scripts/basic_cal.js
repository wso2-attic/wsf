...
function function1(day,time,year,week_no)
{
document.location.href = 'add_event_client.php?day='+day+'&time='+time+'&year='+year+'&week-no='+week_no;

}

function highlightRow()
{
document.getElementById('').bgcolor = '#E2E6A8';
}
