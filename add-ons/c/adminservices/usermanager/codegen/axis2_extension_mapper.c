...
*/
            ...
            axis2_char_t *default_type)
        {
            ...
            if (type != NULL)
            {
              ...
              if (axutil_strcmp(type, "UserMgtException") == 0)
              {
                  return (adb_type_t*) adb_UserMgtException_create(env);
              }
              
              if (axutil_strcmp(type, "StoreProperty") == 0)
              {
                  return (adb_type_t*) adb_StoreProperty_create(env);
              }
            ...
            if (axutil_strcmp(default_type, "adb_UserMgtException") == 0)
            {
                return (adb_type_t*) adb_UserMgtException_create(env);
            }
            
            if (axutil_strcmp(default_type, "adb_StoreProperty") == 0)
            {
                return (adb_type_t*) adb_StoreProperty_create(env);
            }
            ...
            axis2_char_t *default_type)
        {
            if (_object != NULL && adb_type_get_type(_object) != NULL)
            {
                ...
                if (axutil_strcmp(adb_type_get_type(_object), "adb_UserMgtException") == 0)
                {
                    return adb_UserMgtException_free_obj(
                    (adb_UserMgtException_t*) _object, env);
                }
            
                if (axutil_strcmp(adb_type_get_type(_object), "adb_StoreProperty") == 0)
                {
                    return adb_StoreProperty_free_obj(
                    (adb_StoreProperty_t*) _object, env);
                }
            ...
            axis2_char_t *default_type)
        {
            if (_object != NULL && adb_type_get_type(_object) != NULL)
            {
                ...
                if (axutil_strcmp(adb_type_get_type(_object), "adb_UserMgtException") == 0)
                {
                    return adb_UserMgtException_deserialize_obj(
                    (adb_UserMgtException_t*) _object, env, dp_parent, dp_is_early_node_valid, dont_care_minoccurs);
                }
            
                if (axutil_strcmp(adb_type_get_type(_object), "adb_StoreProperty") == 0)
                {
                    return adb_StoreProperty_deserialize_obj(
                    (adb_StoreProperty_t*) _object, env, dp_parent, dp_is_early_node_valid, dont_care_minoccurs);
                }
            ...
            axis2_char_t *default_type)
        {
            if (_object != NULL && adb_type_get_type(_object) != NULL)
            {
                ...
                if (axutil_strcmp(adb_type_get_type(_object), "adb_UserMgtException") == 0)
                {
                    ...
                    (adb_UserMgtException_t*) _object, env, om_node, om_element, tag_closed, namespaces, next_ns_index);
                }
            
                if (axutil_strcmp(adb_type_get_type(_object), "adb_StoreProperty") == 0)
                {
                    return adb_StoreProperty_serialize_obj(
                    (adb_StoreProperty_t*) _object, env, om_node, om_element, tag_closed, namespaces, next_ns_index);
                }
