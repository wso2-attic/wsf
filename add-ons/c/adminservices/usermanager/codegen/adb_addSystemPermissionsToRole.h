...
*/
        ...
        #ifndef ADB_ADDSYSTEMPERMISSIONSTOROLE_H
        #define ADB_ADDSYSTEMPERMISSIONSTOROLE_H

       /**
        * adb_addSystemPermissionsToRole.h
        *
       ...
       /**
        *  adb_addSystemPermissionsToRole class
        */
        ...
        typedef struct adb_addSystemPermissionsToRole adb_addSystemPermissionsToRole_t;
        ...
        /**
         * Constructor for creating adb_addSystemPermissionsToRole_t
         * @param env pointer to environment struct
         * @return newly created adb_addSystemPermissionsToRole_t object
         */
         ...
         * @param  _addSystemPermissionsToRole adb_addSystemPermissionsToRole_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_addSystemPermissionsToRole_t object
         * @param  _addSystemPermissionsToRole adb_addSystemPermissionsToRole_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for roleName. 
         * @param  _addSystemPermissionsToRole adb_addSystemPermissionsToRole_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
        ...
        /**
         * Getter for actions. Deprecated for array types, Use adb_addSystemPermissionsToRole_get_actions_at instead
         * @param  _addSystemPermissionsToRole adb_addSystemPermissionsToRole_t object
         * @param env pointer to environment struct
        ...
        /**
         * Setter for actions.Deprecated for array types, Use adb_addSystemPermissionsToRole_set_actions_at
         * or adb_addSystemPermissionsToRole_add_actions instead.
         * @param  _addSystemPermissionsToRole adb_addSystemPermissionsToRole_t object
         * @param env pointer to environment struct
         ...
         * @param  _addSystemPermissionsToRole _ adb_addSystemPermissionsToRole_t object
         * @param env pointer to environment struct.
       ...
       adb_addSystemPermissionsToRole_declare_parent_namespaces(
         ...
         * @param  _addSystemPermissionsToRole adb_addSystemPermissionsToRole_t object
         * @param env pointer to environment struct
         * @param addSystemPermissionsToRole_om_node node to serialize from
         * @param addSystemPermissionsToRole_om_element parent element to serialize from
        ...
        adb_addSystemPermissionsToRole_serialize(
            adb_addSystemPermissionsToRole_t* _addSystemPermissionsToRole,
            const axutil_env_t *env,
            axiom_node_t* addSystemPermissionsToRole_om_node, axiom_element_t *addSystemPermissionsToRole_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_addSystemPermissionsToRole is a particle class (E.g. group, inner sequence)
        ...
        adb_addSystemPermissionsToRole_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_addSystemPermissionsToRole_t object and return the property value.
     ...
     #endif /* ADB_ADDSYSTEMPERMISSIONSTOROLE_H */
