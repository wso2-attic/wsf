...
*/
        ...
        #ifndef ADB_USERMGTEXCEPTION_H
        #define ADB_USERMGTEXCEPTION_H

       /**
        * adb_UserMgtException.h
        *
        ...
        */
        ...
        typedef struct adb_UserMgtException adb_UserMgtException_t;
        ...
        /**
         * Constructor for creating adb_UserMgtException_t
         * @param env pointer to environment struct
         * @return newly created adb_UserMgtException_t object
         */
         ...
         * @param  _UserMgtException adb_UserMgtException_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_UserMgtException_t object
         * @param  _UserMgtException adb_UserMgtException_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _UserMgtException adb_UserMgtException_t object
         * @param env pointer to environment struct
         * @return axiom_node_t*
         */
       ...
       adb_UserMgtException_declare_parent_namespaces(
         ...
         * @param  _UserMgtException adb_UserMgtException_t object
         * @param env pointer to environment struct
         * @param UserMgtException_om_node node to serialize from
         * @param UserMgtException_om_element parent element to serialize from
        ...
        adb_UserMgtException_serialize(
            adb_UserMgtException_t* _UserMgtException,
            const axutil_env_t *env,
            axiom_node_t* UserMgtException_om_node, axiom_element_t *UserMgtException_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_UserMgtException is a particle class (E.g. group, inner sequence)
        ...
        adb_UserMgtException_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_UserMgtException_t object and return the property value.
