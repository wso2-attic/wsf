...
*/
        ...
        #ifndef ADB_ADDREMOTELINK_H
        #define ADB_ADDREMOTELINK_H
        ...
        */
        ...
        typedef struct adb_addRemoteLink adb_addRemoteLink_t;
        ...
        /**
         * Constructor for creating adb_addRemoteLink_t
         * @param env pointer to environment struct
         * @return newly created adb_addRemoteLink_t object
         */
         ...
         * @param  _addRemoteLink adb_addRemoteLink_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_addRemoteLink_t object
         * @param  _addRemoteLink adb_addRemoteLink_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _addRemoteLink adb_addRemoteLink_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
         ...
         * @param  _addRemoteLink adb_addRemoteLink_t object
         * @param env pointer to environment struct
         * @param arg_instance axis2_char_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_addRemoteLink_declare_parent_namespaces(
         ...
         * @param  _addRemoteLink adb_addRemoteLink_t object
         * @param env pointer to environment struct
         * @param addRemoteLink_om_node node to serialize from
         * @param addRemoteLink_om_element parent element to serialize from
        ...
        adb_addRemoteLink_serialize(
            adb_addRemoteLink_t* _addRemoteLink,
            const axutil_env_t *env,
            axiom_node_t* addRemoteLink_om_node, axiom_element_t *addRemoteLink_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_addRemoteLink is a particle class (E.g. group, inner sequence)
        ...
        adb_addRemoteLink_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_addRemoteLink_t object and return the property value.
