...
*/
        ...
        #ifndef ADB_ADDROLEPERMISSION_H
        #define ADB_ADDROLEPERMISSION_H

       /**
        * adb_addRolePermission.h
        *
        ...
        */
        ...
        typedef struct adb_addRolePermission adb_addRolePermission_t;
        ...
        /**
         * Constructor for creating adb_addRolePermission_t
         * @param env pointer to environment struct
         * @return newly created adb_addRolePermission_t object
         */
         ...
         * @param  _addRolePermission adb_addRolePermission_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_addRolePermission_t object
         * @param  _addRolePermission adb_addRolePermission_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _addRolePermission adb_addRolePermission_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
         ...
         * @param  _addRolePermission adb_addRolePermission_t object
         * @param env pointer to environment struct
         * @param arg_roleToAuthorize axis2_char_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_addRolePermission_declare_parent_namespaces(
         ...
         * @param  _addRolePermission adb_addRolePermission_t object
         * @param env pointer to environment struct
         * @param addRolePermission_om_node node to serialize from
         * @param addRolePermission_om_element parent element to serialize from
        ...
        adb_addRolePermission_serialize(
            adb_addRolePermission_t* _addRolePermission,
            const axutil_env_t *env,
            axiom_node_t* addRolePermission_om_node, axiom_element_t *addRolePermission_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_addRolePermission is a particle class (E.g. group, inner sequence)
         ...
         * @param _roleToAuthorize axis2_char_t*
        ...
        adb_addRolePermission_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_addRolePermission_t object and return the property value.
