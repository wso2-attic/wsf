...
*/
        ...
        #ifndef ADB__DELETE_H
        #define ADB__DELETE_H
        ...
        */
        ...
        typedef struct adb__delete adb__delete_t;
        ...
        /**
         * Constructor for creating adb__delete_t
         * @param env pointer to environment struct
         * @return newly created adb__delete_t object
         */
         ...
         * @param  __delete adb__delete_t object to free
         * @param env pointer to environment struct
         ...
         * @param  __delete adb__delete_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
         ...
         * @param  __delete adb__delete_t object
         * @param env pointer to environment struct
         * @param arg_pathToDelete axis2_char_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb__delete_declare_parent_namespaces(
         ...
         * @param  __delete adb__delete_t object
         * @param env pointer to environment struct
         * @param _delete_om_node node to serialize from
         * @param _delete_om_element parent element to serialize from
        ...
        adb__delete_serialize(
            adb__delete_t* __delete,
            const axutil_env_t *env,
            axiom_node_t* _delete_om_node, axiom_element_t *_delete_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb__delete is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb__delete_t
         * @param env pointer to environment struct
         * @param _pathToDelete axis2_char_t*
         * @return newly created adb__delete_t object
         */
        adb__delete_t* AXIS2_CALL
        adb__delete_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb__delete_t object and return the property value.
