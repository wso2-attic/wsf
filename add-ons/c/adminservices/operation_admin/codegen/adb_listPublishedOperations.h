...
*/
        ...
        #ifndef ADB_LISTPUBLISHEDOPERATIONS_H
        #define ADB_LISTPUBLISHEDOPERATIONS_H

       /**
        * adb_listPublishedOperations.h
        *
       ...
       /**
        *  adb_listPublishedOperations class
        */
        ...
        typedef struct adb_listPublishedOperations adb_listPublishedOperations_t;
        ...
        /**
         * Constructor for creating adb_listPublishedOperations_t
         * @param env pointer to environment struct
         * @return newly created adb_listPublishedOperations_t object
         */
         ...
         * @param  _listPublishedOperations adb_listPublishedOperations_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_listPublishedOperations_t object
         * @param  _listPublishedOperations adb_listPublishedOperations_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _listPublishedOperations adb_listPublishedOperations_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_listPublishedOperations_declare_parent_namespaces(
         ...
         * @param  _listPublishedOperations adb_listPublishedOperations_t object
         * @param env pointer to environment struct
         * @param listPublishedOperations_om_node node to serialize from
         * @param listPublishedOperations_om_element parent element to serialize from
        ...
        adb_listPublishedOperations_serialize(
            adb_listPublishedOperations_t* _listPublishedOperations,
            const axutil_env_t *env,
            axiom_node_t* listPublishedOperations_om_node, axiom_element_t *listPublishedOperations_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_listPublishedOperations is a particle class (E.g. group, inner sequence)
        ...
        adb_listPublishedOperations_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_listPublishedOperations_t object and return the property value.
     ...
     #endif /* ADB_LISTPUBLISHEDOPERATIONS_H */
