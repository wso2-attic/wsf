...
*/
        ...
        #ifndef ADB_LISTPUBLISHEDOPERATIONSRESPONSE_H
        #define ADB_LISTPUBLISHEDOPERATIONSRESPONSE_H

       /**
        * adb_listPublishedOperationsResponse.h
        *
       ...
       /**
        *  adb_listPublishedOperationsResponse class
        */
        ...
        typedef struct adb_listPublishedOperationsResponse adb_listPublishedOperationsResponse_t;
        ...
        /**
         * Constructor for creating adb_listPublishedOperationsResponse_t
         * @param env pointer to environment struct
         * @return newly created adb_listPublishedOperationsResponse_t object
         */
         ...
         * @param  _listPublishedOperationsResponse adb_listPublishedOperationsResponse_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_listPublishedOperationsResponse_t object
         * @param  _listPublishedOperationsResponse adb_listPublishedOperationsResponse_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for return. Deprecated for array types, Use adb_listPublishedOperationsResponse_get_return_at instead
         * @param  _listPublishedOperationsResponse adb_listPublishedOperationsResponse_t object
         * @param env pointer to environment struct
        ...
        /**
         * Setter for return.Deprecated for array types, Use adb_listPublishedOperationsResponse_set_return_at
         * or adb_listPublishedOperationsResponse_add_return instead.
         * @param  _listPublishedOperationsResponse adb_listPublishedOperationsResponse_t object
         * @param env pointer to environment struct
         ...
         * @param  _listPublishedOperationsResponse _ adb_listPublishedOperationsResponse_t object
         * @param env pointer to environment struct.
       ...
       adb_listPublishedOperationsResponse_declare_parent_namespaces(
         ...
         * @param  _listPublishedOperationsResponse adb_listPublishedOperationsResponse_t object
         * @param env pointer to environment struct
         * @param listPublishedOperationsResponse_om_node node to serialize from
         * @param listPublishedOperationsResponse_om_element parent element to serialize from
        ...
        adb_listPublishedOperationsResponse_serialize(
            adb_listPublishedOperationsResponse_t* _listPublishedOperationsResponse,
            const axutil_env_t *env,
            axiom_node_t* listPublishedOperationsResponse_om_node, axiom_element_t *listPublishedOperationsResponse_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_listPublishedOperationsResponse is a particle class (E.g. group, inner sequence)
        ...
        adb_listPublishedOperationsResponse_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_listPublishedOperationsResponse_t object and return the property value.
     ...
     #endif /* ADB_LISTPUBLISHEDOPERATIONSRESPONSE_H */
