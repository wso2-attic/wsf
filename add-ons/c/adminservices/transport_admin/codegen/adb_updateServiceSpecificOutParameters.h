...
*/
        ...
        #ifndef ADB_UPDATESERVICESPECIFICOUTPARAMETERS_H
        #define ADB_UPDATESERVICESPECIFICOUTPARAMETERS_H

       /**
        * adb_updateServiceSpecificOutParameters.h
        *
       ...
       /**
        *  adb_updateServiceSpecificOutParameters class
        */
        ...
        typedef struct adb_updateServiceSpecificOutParameters adb_updateServiceSpecificOutParameters_t;
        ...
        /**
         * Constructor for creating adb_updateServiceSpecificOutParameters_t
         * @param env pointer to environment struct
         * @return newly created adb_updateServiceSpecificOutParameters_t object
         */
         ...
         * @param  _updateServiceSpecificOutParameters adb_updateServiceSpecificOutParameters_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_updateServiceSpecificOutParameters_t object
         * @param  _updateServiceSpecificOutParameters adb_updateServiceSpecificOutParameters_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _updateServiceSpecificOutParameters adb_updateServiceSpecificOutParameters_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
        ...
        /**
         * Getter for params. Deprecated for array types, Use adb_updateServiceSpecificOutParameters_get_params_at instead
         * @param  _updateServiceSpecificOutParameters adb_updateServiceSpecificOutParameters_t object
         * @param env pointer to environment struct
        ...
        /**
         * Setter for params.Deprecated for array types, Use adb_updateServiceSpecificOutParameters_set_params_at
         * or adb_updateServiceSpecificOutParameters_add_params instead.
         * @param  _updateServiceSpecificOutParameters adb_updateServiceSpecificOutParameters_t object
         * @param env pointer to environment struct
         ...
         * @param  _updateServiceSpecificOutParameters _ adb_updateServiceSpecificOutParameters_t object
         * @param env pointer to environment struct.
       ...
       adb_updateServiceSpecificOutParameters_declare_parent_namespaces(
         ...
         * @param  _updateServiceSpecificOutParameters adb_updateServiceSpecificOutParameters_t object
         * @param env pointer to environment struct
         * @param updateServiceSpecificOutParameters_om_node node to serialize from
         * @param updateServiceSpecificOutParameters_om_element parent element to serialize from
        ...
        adb_updateServiceSpecificOutParameters_serialize(
            adb_updateServiceSpecificOutParameters_t* _updateServiceSpecificOutParameters,
            const axutil_env_t *env,
            axiom_node_t* updateServiceSpecificOutParameters_om_node, axiom_element_t *updateServiceSpecificOutParameters_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_updateServiceSpecificOutParameters is a particle class (E.g. group, inner sequence)
        ...
        adb_updateServiceSpecificOutParameters_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_updateServiceSpecificOutParameters_t object and return the property value.
     ...
     #endif /* ADB_UPDATESERVICESPECIFICOUTPARAMETERS_H */
