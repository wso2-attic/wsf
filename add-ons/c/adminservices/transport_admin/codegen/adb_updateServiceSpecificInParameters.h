...
*/
        ...
        #ifndef ADB_UPDATESERVICESPECIFICINPARAMETERS_H
        #define ADB_UPDATESERVICESPECIFICINPARAMETERS_H

       /**
        * adb_updateServiceSpecificInParameters.h
        *
       ...
       /**
        *  adb_updateServiceSpecificInParameters class
        */
        ...
        typedef struct adb_updateServiceSpecificInParameters adb_updateServiceSpecificInParameters_t;
        ...
        /**
         * Constructor for creating adb_updateServiceSpecificInParameters_t
         * @param env pointer to environment struct
         * @return newly created adb_updateServiceSpecificInParameters_t object
         */
         ...
         * @param  _updateServiceSpecificInParameters adb_updateServiceSpecificInParameters_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_updateServiceSpecificInParameters_t object
         * @param  _updateServiceSpecificInParameters adb_updateServiceSpecificInParameters_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _updateServiceSpecificInParameters adb_updateServiceSpecificInParameters_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
        ...
        /**
         * Getter for params. Deprecated for array types, Use adb_updateServiceSpecificInParameters_get_params_at instead
         * @param  _updateServiceSpecificInParameters adb_updateServiceSpecificInParameters_t object
         * @param env pointer to environment struct
        ...
        /**
         * Setter for params.Deprecated for array types, Use adb_updateServiceSpecificInParameters_set_params_at
         * or adb_updateServiceSpecificInParameters_add_params instead.
         * @param  _updateServiceSpecificInParameters adb_updateServiceSpecificInParameters_t object
         * @param env pointer to environment struct
         ...
         * @param  _updateServiceSpecificInParameters _ adb_updateServiceSpecificInParameters_t object
         * @param env pointer to environment struct.
       ...
       adb_updateServiceSpecificInParameters_declare_parent_namespaces(
         ...
         * @param  _updateServiceSpecificInParameters adb_updateServiceSpecificInParameters_t object
         * @param env pointer to environment struct
         * @param updateServiceSpecificInParameters_om_node node to serialize from
         * @param updateServiceSpecificInParameters_om_element parent element to serialize from
        ...
        adb_updateServiceSpecificInParameters_serialize(
            adb_updateServiceSpecificInParameters_t* _updateServiceSpecificInParameters,
            const axutil_env_t *env,
            axiom_node_t* updateServiceSpecificInParameters_om_node, axiom_element_t *updateServiceSpecificInParameters_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_updateServiceSpecificInParameters is a particle class (E.g. group, inner sequence)
        ...
        adb_updateServiceSpecificInParameters_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_updateServiceSpecificInParameters_t object and return the property value.
     ...
     #endif /* ADB_UPDATESERVICESPECIFICINPARAMETERS_H */
