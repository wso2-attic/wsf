...
*/
        ...
        #ifndef ADB_LISTEXPOSEDTRANSPORTSRESPONSE_H
        #define ADB_LISTEXPOSEDTRANSPORTSRESPONSE_H

       /**
        * adb_listExposedTransportsResponse.h
        *
       ...
       /**
        *  adb_listExposedTransportsResponse class
        */
        ...
        typedef struct adb_listExposedTransportsResponse adb_listExposedTransportsResponse_t;
        ...
        /**
         * Constructor for creating adb_listExposedTransportsResponse_t
         * @param env pointer to environment struct
         * @return newly created adb_listExposedTransportsResponse_t object
         */
         ...
         * @param  _listExposedTransportsResponse adb_listExposedTransportsResponse_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_listExposedTransportsResponse_t object
         * @param  _listExposedTransportsResponse adb_listExposedTransportsResponse_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for return. Deprecated for array types, Use adb_listExposedTransportsResponse_get_return_at instead
         * @param  _listExposedTransportsResponse adb_listExposedTransportsResponse_t object
         * @param env pointer to environment struct
        ...
        /**
         * Setter for return.Deprecated for array types, Use adb_listExposedTransportsResponse_set_return_at
         * or adb_listExposedTransportsResponse_add_return instead.
         * @param  _listExposedTransportsResponse adb_listExposedTransportsResponse_t object
         * @param env pointer to environment struct
         ...
         * @param  _listExposedTransportsResponse _ adb_listExposedTransportsResponse_t object
         * @param env pointer to environment struct.
       ...
       adb_listExposedTransportsResponse_declare_parent_namespaces(
         ...
         * @param  _listExposedTransportsResponse adb_listExposedTransportsResponse_t object
         * @param env pointer to environment struct
         * @param listExposedTransportsResponse_om_node node to serialize from
         * @param listExposedTransportsResponse_om_element parent element to serialize from
        ...
        adb_listExposedTransportsResponse_serialize(
            adb_listExposedTransportsResponse_t* _listExposedTransportsResponse,
            const axutil_env_t *env,
            axiom_node_t* listExposedTransportsResponse_om_node, axiom_element_t *listExposedTransportsResponse_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_listExposedTransportsResponse is a particle class (E.g. group, inner sequence)
        ...
        adb_listExposedTransportsResponse_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_listExposedTransportsResponse_t object and return the property value.
     ...
     #endif /* ADB_LISTEXPOSEDTRANSPORTSRESPONSE_H */
