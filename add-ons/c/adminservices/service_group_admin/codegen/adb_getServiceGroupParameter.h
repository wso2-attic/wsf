...
*/
        ...
        #ifndef ADB_GETSERVICEGROUPPARAMETER_H
        #define ADB_GETSERVICEGROUPPARAMETER_H

       /**
        * adb_getServiceGroupParameter.h
        *
       ...
       /**
        *  adb_getServiceGroupParameter class
        */
        ...
        typedef struct adb_getServiceGroupParameter adb_getServiceGroupParameter_t;
        ...
        /**
         * Constructor for creating adb_getServiceGroupParameter_t
         * @param env pointer to environment struct
         * @return newly created adb_getServiceGroupParameter_t object
         */
         ...
         * @param  _getServiceGroupParameter adb_getServiceGroupParameter_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_getServiceGroupParameter_t object
         * @param  _getServiceGroupParameter adb_getServiceGroupParameter_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _getServiceGroupParameter adb_getServiceGroupParameter_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
         ...
         * @param  _getServiceGroupParameter adb_getServiceGroupParameter_t object
         * @param env pointer to environment struct
         * @param arg_paramName axis2_char_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_getServiceGroupParameter_declare_parent_namespaces(
         ...
         * @param  _getServiceGroupParameter adb_getServiceGroupParameter_t object
         * @param env pointer to environment struct
         * @param getServiceGroupParameter_om_node node to serialize from
         * @param getServiceGroupParameter_om_element parent element to serialize from
        ...
        adb_getServiceGroupParameter_serialize(
            adb_getServiceGroupParameter_t* _getServiceGroupParameter,
            const axutil_env_t *env,
            axiom_node_t* getServiceGroupParameter_om_node, axiom_element_t *getServiceGroupParameter_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_getServiceGroupParameter is a particle class (E.g. group, inner sequence)
        ...
        adb_getServiceGroupParameter_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_getServiceGroupParameter_t object and return the property value.
     ...
     #endif /* ADB_GETSERVICEGROUPPARAMETER_H */
