...
*/
        ...
        #ifndef ADB_REMOVESERVICEGROUPPARAMETER_H
        #define ADB_REMOVESERVICEGROUPPARAMETER_H

       /**
        * adb_removeServiceGroupParameter.h
        *
       ...
       /**
        *  adb_removeServiceGroupParameter class
        */
        ...
        typedef struct adb_removeServiceGroupParameter adb_removeServiceGroupParameter_t;
        ...
        /**
         * Constructor for creating adb_removeServiceGroupParameter_t
         * @param env pointer to environment struct
         * @return newly created adb_removeServiceGroupParameter_t object
         */
         ...
         * @param  _removeServiceGroupParameter adb_removeServiceGroupParameter_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_removeServiceGroupParameter_t object
         * @param  _removeServiceGroupParameter adb_removeServiceGroupParameter_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _removeServiceGroupParameter adb_removeServiceGroupParameter_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_removeServiceGroupParameter_declare_parent_namespaces(
         ...
         * @param  _removeServiceGroupParameter adb_removeServiceGroupParameter_t object
         * @param env pointer to environment struct
         * @param removeServiceGroupParameter_om_node node to serialize from
         * @param removeServiceGroupParameter_om_element parent element to serialize from
        ...
        adb_removeServiceGroupParameter_serialize(
            adb_removeServiceGroupParameter_t* _removeServiceGroupParameter,
            const axutil_env_t *env,
            axiom_node_t* removeServiceGroupParameter_om_node, axiom_element_t *removeServiceGroupParameter_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_removeServiceGroupParameter is a particle class (E.g. group, inner sequence)
        ...
        adb_removeServiceGroupParameter_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_removeServiceGroupParameter_t object and return the property value.
     ...
     #endif /* ADB_REMOVESERVICEGROUPPARAMETER_H */
