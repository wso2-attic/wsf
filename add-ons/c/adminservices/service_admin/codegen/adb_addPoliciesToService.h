...
*/
        ...
        #ifndef ADB_ADDPOLICIESTOSERVICE_H
        #define ADB_ADDPOLICIESTOSERVICE_H

       /**
        * adb_addPoliciesToService.h
        *
       ...
       /**
        *  adb_addPoliciesToService class
        */
        ...
        typedef struct adb_addPoliciesToService adb_addPoliciesToService_t;
        ...
        /**
         * Constructor for creating adb_addPoliciesToService_t
         * @param env pointer to environment struct
         * @return newly created adb_addPoliciesToService_t object
         */
         ...
         * @param  _addPoliciesToService adb_addPoliciesToService_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_addPoliciesToService_t object
         * @param  _addPoliciesToService adb_addPoliciesToService_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _addPoliciesToService adb_addPoliciesToService_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
        ...
        /**
         * Getter for modulePaths. Deprecated for array types, Use adb_addPoliciesToService_get_modulePaths_at instead
         * @param  _addPoliciesToService adb_addPoliciesToService_t object
         * @param env pointer to environment struct
        ...
        /**
         * Setter for modulePaths.Deprecated for array types, Use adb_addPoliciesToService_set_modulePaths_at
         * or adb_addPoliciesToService_add_modulePaths instead.
         * @param  _addPoliciesToService adb_addPoliciesToService_t object
         * @param env pointer to environment struct
         * @param arg_modulePaths Array of axis2_char_t*s.
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
        ...
        /**
         * Get the ith element of modulePaths.
         * @param  _addPoliciesToService adb_addPoliciesToService_t object
         * @param env pointer to environment struct
        ...
        /**
         * Set the ith element of modulePaths. (If the ith already exist, it will be replaced)
         * @param  _addPoliciesToService adb_addPoliciesToService_t object
         * @param env pointer to environment struct
         * @param i index of the item to return
         * @param arg_modulePaths element to set axis2_char_t* to the array
         * @return ith axis2_char_t* of the array
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _addPoliciesToService adb_addPoliciesToService_t object
         * @param env pointer to environment struct
         * @param arg_modulePaths element to add axis2_char_t* to the array
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _addPoliciesToService adb_addPoliciesToService_t object
         * @param env pointer to environment struct.
         * @return the size of the modulePaths array.
         */
        int AXIS2_CALL
        ...
        /**
         * Remove the ith element of modulePaths.
         * @param  _addPoliciesToService adb_addPoliciesToService_t object
         * @param env pointer to environment struct
         ...
         * @param  _addPoliciesToService _ adb_addPoliciesToService_t object
         * @param env pointer to environment struct.
       ...
       adb_addPoliciesToService_declare_parent_namespaces(
         ...
         * @param  _addPoliciesToService adb_addPoliciesToService_t object
         * @param env pointer to environment struct
         * @param addPoliciesToService_om_node node to serialize from
         * @param addPoliciesToService_om_element parent element to serialize from
        ...
        adb_addPoliciesToService_serialize(
            adb_addPoliciesToService_t* _addPoliciesToService,
            const axutil_env_t *env,
            axiom_node_t* addPoliciesToService_om_node, axiom_element_t *addPoliciesToService_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_addPoliciesToService is a particle class (E.g. group, inner sequence)
         ...
         * @param _policy adb_Policy_t*
         * @param _policyType int
         * @param _modulePaths axutil_array_list_t*
         * @return newly created adb_addPoliciesToService_t object
         */
        adb_addPoliciesToService_t* AXIS2_CALL
        adb_addPoliciesToService_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_addPoliciesToService_t object and return the property value.
     ...
     #endif /* ADB_ADDPOLICIESTOSERVICE_H */
