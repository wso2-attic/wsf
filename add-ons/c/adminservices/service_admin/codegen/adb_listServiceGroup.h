...
*/
        ...
        #ifndef ADB_LISTSERVICEGROUP_H
        #define ADB_LISTSERVICEGROUP_H

       /**
        * adb_listServiceGroup.h
        *
        ...
        */
        ...
        typedef struct adb_listServiceGroup adb_listServiceGroup_t;
        ...
        /**
         * Constructor for creating adb_listServiceGroup_t
         * @param env pointer to environment struct
         * @return newly created adb_listServiceGroup_t object
         */
         ...
         * @param  _listServiceGroup adb_listServiceGroup_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_listServiceGroup_t object
         * @param  _listServiceGroup adb_listServiceGroup_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _listServiceGroup adb_listServiceGroup_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_listServiceGroup_declare_parent_namespaces(
         ...
         * @param  _listServiceGroup adb_listServiceGroup_t object
         * @param env pointer to environment struct
         * @param listServiceGroup_om_node node to serialize from
         * @param listServiceGroup_om_element parent element to serialize from
        ...
        adb_listServiceGroup_serialize(
            adb_listServiceGroup_t* _listServiceGroup,
            const axutil_env_t *env,
            axiom_node_t* listServiceGroup_om_node, axiom_element_t *listServiceGroup_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_listServiceGroup is a particle class (E.g. group, inner sequence)
        ...
        adb_listServiceGroup_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_listServiceGroup_t object and return the property value.
