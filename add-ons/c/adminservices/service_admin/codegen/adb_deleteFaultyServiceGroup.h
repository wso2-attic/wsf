...
*/
        ...
        #ifndef ADB_DELETEFAULTYSERVICEGROUP_H
        #define ADB_DELETEFAULTYSERVICEGROUP_H

       /**
        * adb_deleteFaultyServiceGroup.h
        *
       ...
       /**
        *  adb_deleteFaultyServiceGroup class
        */
        ...
        typedef struct adb_deleteFaultyServiceGroup adb_deleteFaultyServiceGroup_t;
        ...
        /**
         * Constructor for creating adb_deleteFaultyServiceGroup_t
         * @param env pointer to environment struct
         * @return newly created adb_deleteFaultyServiceGroup_t object
         */
         ...
         * @param  _deleteFaultyServiceGroup adb_deleteFaultyServiceGroup_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_deleteFaultyServiceGroup_t object
         * @param  _deleteFaultyServiceGroup adb_deleteFaultyServiceGroup_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _deleteFaultyServiceGroup adb_deleteFaultyServiceGroup_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
         ...
         * @param  _deleteFaultyServiceGroup adb_deleteFaultyServiceGroup_t object
         * @param env pointer to environment struct
         * @param arg_archiveName axis2_char_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_deleteFaultyServiceGroup_declare_parent_namespaces(
         ...
         * @param  _deleteFaultyServiceGroup adb_deleteFaultyServiceGroup_t object
         * @param env pointer to environment struct
         * @param deleteFaultyServiceGroup_om_node node to serialize from
         * @param deleteFaultyServiceGroup_om_element parent element to serialize from
        ...
        adb_deleteFaultyServiceGroup_serialize(
            adb_deleteFaultyServiceGroup_t* _deleteFaultyServiceGroup,
            const axutil_env_t *env,
            axiom_node_t* deleteFaultyServiceGroup_om_node, axiom_element_t *deleteFaultyServiceGroup_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_deleteFaultyServiceGroup is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_deleteFaultyServiceGroup_t
         * @param env pointer to environment struct
         * @param _archiveName axis2_char_t*
         * @return newly created adb_deleteFaultyServiceGroup_t object
         */
        adb_deleteFaultyServiceGroup_t* AXIS2_CALL
        adb_deleteFaultyServiceGroup_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_deleteFaultyServiceGroup_t object and return the property value.
     ...
     #endif /* ADB_DELETEFAULTYSERVICEGROUP_H */
