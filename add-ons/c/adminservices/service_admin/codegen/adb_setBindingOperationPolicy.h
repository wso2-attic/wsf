...
*/
        ...
        #ifndef ADB_SETBINDINGOPERATIONPOLICY_H
        #define ADB_SETBINDINGOPERATIONPOLICY_H

       /**
        * adb_setBindingOperationPolicy.h
        *
       ...
       /**
        *  adb_setBindingOperationPolicy class
        */
        ...
        typedef struct adb_setBindingOperationPolicy adb_setBindingOperationPolicy_t;
        ...
        /**
         * Constructor for creating adb_setBindingOperationPolicy_t
         * @param env pointer to environment struct
         * @return newly created adb_setBindingOperationPolicy_t object
         */
         ...
         * @param  _setBindingOperationPolicy adb_setBindingOperationPolicy_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_setBindingOperationPolicy_t object
         * @param  _setBindingOperationPolicy adb_setBindingOperationPolicy_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _setBindingOperationPolicy adb_setBindingOperationPolicy_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_setBindingOperationPolicy_declare_parent_namespaces(
         ...
         * @param  _setBindingOperationPolicy adb_setBindingOperationPolicy_t object
         * @param env pointer to environment struct
         * @param setBindingOperationPolicy_om_node node to serialize from
         * @param setBindingOperationPolicy_om_element parent element to serialize from
        ...
        adb_setBindingOperationPolicy_serialize(
            adb_setBindingOperationPolicy_t* _setBindingOperationPolicy,
            const axutil_env_t *env,
            axiom_node_t* setBindingOperationPolicy_om_node, axiom_element_t *setBindingOperationPolicy_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_setBindingOperationPolicy is a particle class (E.g. group, inner sequence)
        ...
        adb_setBindingOperationPolicy_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_setBindingOperationPolicy_t object and return the property value.
     ...
     #endif /* ADB_SETBINDINGOPERATIONPOLICY_H */
