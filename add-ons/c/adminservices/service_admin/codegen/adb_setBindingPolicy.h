...
*/
        ...
        #ifndef ADB_SETBINDINGPOLICY_H
        #define ADB_SETBINDINGPOLICY_H

       /**
        * adb_setBindingPolicy.h
        *
        ...
        */
        ...
        typedef struct adb_setBindingPolicy adb_setBindingPolicy_t;
        ...
        /**
         * Constructor for creating adb_setBindingPolicy_t
         * @param env pointer to environment struct
         * @return newly created adb_setBindingPolicy_t object
         */
         ...
         * @param  _setBindingPolicy adb_setBindingPolicy_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_setBindingPolicy_t object
         * @param  _setBindingPolicy adb_setBindingPolicy_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _setBindingPolicy adb_setBindingPolicy_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_setBindingPolicy_declare_parent_namespaces(
         ...
         * @param  _setBindingPolicy adb_setBindingPolicy_t object
         * @param env pointer to environment struct
         * @param setBindingPolicy_om_node node to serialize from
         * @param setBindingPolicy_om_element parent element to serialize from
        ...
        adb_setBindingPolicy_serialize(
            adb_setBindingPolicy_t* _setBindingPolicy,
            const axutil_env_t *env,
            axiom_node_t* setBindingPolicy_om_node, axiom_element_t *setBindingPolicy_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_setBindingPolicy is a particle class (E.g. group, inner sequence)
        ...
        adb_setBindingPolicy_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_setBindingPolicy_t object and return the property value.
