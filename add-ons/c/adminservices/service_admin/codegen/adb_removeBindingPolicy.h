...
*/
        ...
        #ifndef ADB_REMOVEBINDINGPOLICY_H
        #define ADB_REMOVEBINDINGPOLICY_H

       /**
        * adb_removeBindingPolicy.h
        *
        ...
        */
        ...
        typedef struct adb_removeBindingPolicy adb_removeBindingPolicy_t;
        ...
        /**
         * Constructor for creating adb_removeBindingPolicy_t
         * @param env pointer to environment struct
         * @return newly created adb_removeBindingPolicy_t object
         */
         ...
         * @param  _removeBindingPolicy adb_removeBindingPolicy_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_removeBindingPolicy_t object
         * @param  _removeBindingPolicy adb_removeBindingPolicy_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _removeBindingPolicy adb_removeBindingPolicy_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
         ...
         * @param  _removeBindingPolicy adb_removeBindingPolicy_t object
         * @param env pointer to environment struct
         * @param arg_policyKey axis2_char_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
        ...
        /**
         * Getter for moduleNames. Deprecated for array types, Use adb_removeBindingPolicy_get_moduleNames_at instead
         * @param  _removeBindingPolicy adb_removeBindingPolicy_t object
         * @param env pointer to environment struct
        ...
        /**
         * Setter for moduleNames.Deprecated for array types, Use adb_removeBindingPolicy_set_moduleNames_at
         * or adb_removeBindingPolicy_add_moduleNames instead.
         * @param  _removeBindingPolicy adb_removeBindingPolicy_t object
         * @param env pointer to environment struct
         * @param arg_moduleNames Array of axis2_char_t*s.
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
        ...
        /**
         * Get the ith element of moduleNames.
         * @param  _removeBindingPolicy adb_removeBindingPolicy_t object
         * @param env pointer to environment struct
        ...
        /**
         * Set the ith element of moduleNames. (If the ith already exist, it will be replaced)
         * @param  _removeBindingPolicy adb_removeBindingPolicy_t object
         * @param env pointer to environment struct
         * @param i index of the item to return
         * @param arg_moduleNames element to set axis2_char_t* to the array
         * @return ith axis2_char_t* of the array
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _removeBindingPolicy adb_removeBindingPolicy_t object
         * @param env pointer to environment struct
         * @param arg_moduleNames element to add axis2_char_t* to the array
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _removeBindingPolicy adb_removeBindingPolicy_t object
         * @param env pointer to environment struct.
         * @return the size of the moduleNames array.
         */
        int AXIS2_CALL
        ...
        /**
         * Remove the ith element of moduleNames.
         * @param  _removeBindingPolicy adb_removeBindingPolicy_t object
         * @param env pointer to environment struct
         ...
         * @param  _removeBindingPolicy _ adb_removeBindingPolicy_t object
         * @param env pointer to environment struct.
       ...
       adb_removeBindingPolicy_declare_parent_namespaces(
         ...
         * @param  _removeBindingPolicy adb_removeBindingPolicy_t object
         * @param env pointer to environment struct
         * @param removeBindingPolicy_om_node node to serialize from
         * @param removeBindingPolicy_om_element parent element to serialize from
        ...
        adb_removeBindingPolicy_serialize(
            adb_removeBindingPolicy_t* _removeBindingPolicy,
            const axutil_env_t *env,
            axiom_node_t* removeBindingPolicy_om_node, axiom_element_t *removeBindingPolicy_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_removeBindingPolicy is a particle class (E.g. group, inner sequence)
         ...
         * @param _policyKey axis2_char_t*
         * @param _moduleNames axutil_array_list_t*
         * @return newly created adb_removeBindingPolicy_t object
         */
        adb_removeBindingPolicy_t* AXIS2_CALL
        adb_removeBindingPolicy_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_removeBindingPolicy_t object and return the property value.
     ...
     #endif /* ADB_REMOVEBINDINGPOLICY_H */
