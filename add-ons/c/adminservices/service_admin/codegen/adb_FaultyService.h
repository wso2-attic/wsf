...
*/
        ...
        #ifndef ADB_FAULTYSERVICE_H
        #define ADB_FAULTYSERVICE_H
        ...
        */
        ...
        typedef struct adb_FaultyService adb_FaultyService_t;
        ...
        /**
         * Constructor for creating adb_FaultyService_t
         * @param env pointer to environment struct
         * @return newly created adb_FaultyService_t object
         */
         ...
         * @param  _FaultyService adb_FaultyService_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_FaultyService_t object
         * @param  _FaultyService adb_FaultyService_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for artifact. 
         * @param  _FaultyService adb_FaultyService_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
         ...
         * @param  _FaultyService adb_FaultyService_t object
         * @param env pointer to environment struct
         * @param arg_artifact axis2_char_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_FaultyService_declare_parent_namespaces(
         ...
         * @param  _FaultyService adb_FaultyService_t object
         * @param env pointer to environment struct
         * @param FaultyService_om_node node to serialize from
         * @param FaultyService_om_element parent element to serialize from
        ...
        adb_FaultyService_serialize(
            adb_FaultyService_t* _FaultyService,
            const axutil_env_t *env,
            axiom_node_t* FaultyService_om_node, axiom_element_t *FaultyService_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_FaultyService is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_FaultyService_t
         * @param env pointer to environment struct
         * @param _artifact axis2_char_t*
         * @param _fault axis2_char_t*
        ...
        adb_FaultyService_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_FaultyService_t object and return the property value.
