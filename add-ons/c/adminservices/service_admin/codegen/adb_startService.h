...
*/
        ...
        #ifndef ADB_STARTSERVICE_H
        #define ADB_STARTSERVICE_H
        ...
        */
        ...
        typedef struct adb_startService adb_startService_t;
        ...
        /**
         * Constructor for creating adb_startService_t
         * @param env pointer to environment struct
         * @return newly created adb_startService_t object
         */
         ...
         * @param  _startService adb_startService_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_startService_t object
         * @param  _startService adb_startService_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _startService adb_startService_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_startService_declare_parent_namespaces(
         ...
         * @param  _startService adb_startService_t object
         * @param env pointer to environment struct
         * @param startService_om_node node to serialize from
         * @param startService_om_element parent element to serialize from
        ...
        adb_startService_serialize(
            adb_startService_t* _startService,
            const axutil_env_t *env,
            axiom_node_t* startService_om_node, axiom_element_t *startService_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_startService is a particle class (E.g. group, inner sequence)
        ...
        adb_startService_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_startService_t object and return the property value.
