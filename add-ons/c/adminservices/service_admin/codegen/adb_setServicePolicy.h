...
*/
        ...
        #ifndef ADB_SETSERVICEPOLICY_H
        #define ADB_SETSERVICEPOLICY_H

       /**
        * adb_setServicePolicy.h
        *
        ...
        */
        ...
        typedef struct adb_setServicePolicy adb_setServicePolicy_t;
        ...
        /**
         * Constructor for creating adb_setServicePolicy_t
         * @param env pointer to environment struct
         * @return newly created adb_setServicePolicy_t object
         */
         ...
         * @param  _setServicePolicy adb_setServicePolicy_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_setServicePolicy_t object
         * @param  _setServicePolicy adb_setServicePolicy_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _setServicePolicy adb_setServicePolicy_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_setServicePolicy_declare_parent_namespaces(
         ...
         * @param  _setServicePolicy adb_setServicePolicy_t object
         * @param env pointer to environment struct
         * @param setServicePolicy_om_node node to serialize from
         * @param setServicePolicy_om_element parent element to serialize from
        ...
        adb_setServicePolicy_serialize(
            adb_setServicePolicy_t* _setServicePolicy,
            const axutil_env_t *env,
            axiom_node_t* setServicePolicy_om_node, axiom_element_t *setServicePolicy_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_setServicePolicy is a particle class (E.g. group, inner sequence)
        ...
        adb_setServicePolicy_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_setServicePolicy_t object and return the property value.
