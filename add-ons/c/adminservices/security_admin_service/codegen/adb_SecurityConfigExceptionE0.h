...
*/
        ...
        #ifndef ADB_SECURITYCONFIGEXCEPTIONE0_H
        #define ADB_SECURITYCONFIGEXCEPTIONE0_H

       /**
        * adb_SecurityConfigExceptionE0.h
        *
       ...
       /**
        *  adb_SecurityConfigExceptionE0 class
        */
        ...
        typedef struct adb_SecurityConfigExceptionE0 adb_SecurityConfigExceptionE0_t;
        ...
        /**
         * Constructor for creating adb_SecurityConfigExceptionE0_t
         * @param env pointer to environment struct
         * @return newly created adb_SecurityConfigExceptionE0_t object
         */
         ...
         * @param  _SecurityConfigExceptionE0 adb_SecurityConfigExceptionE0_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_SecurityConfigExceptionE0_t object
         * @param  _SecurityConfigExceptionE0 adb_SecurityConfigExceptionE0_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _SecurityConfigExceptionE0 adb_SecurityConfigExceptionE0_t object
         * @param env pointer to environment struct
         * @return adb_SecurityConfigException_t*
         */
         ...
         * @param  _SecurityConfigExceptionE0 adb_SecurityConfigExceptionE0_t object
         * @param env pointer to environment struct
         * @param arg_SecurityConfigException adb_SecurityConfigException_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_SecurityConfigExceptionE0_declare_parent_namespaces(
         ...
         * @param  _SecurityConfigExceptionE0 adb_SecurityConfigExceptionE0_t object
         * @param env pointer to environment struct
         * @param SecurityConfigExceptionE0_om_node node to serialize from
         * @param SecurityConfigExceptionE0_om_element parent element to serialize from
        ...
        adb_SecurityConfigExceptionE0_serialize(
            adb_SecurityConfigExceptionE0_t* _SecurityConfigExceptionE0,
            const axutil_env_t *env,
            axiom_node_t* SecurityConfigExceptionE0_om_node, axiom_element_t *SecurityConfigExceptionE0_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_SecurityConfigExceptionE0 is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_SecurityConfigExceptionE0_t
         * @param env pointer to environment struct
         * @param _SecurityConfigException adb_SecurityConfigException_t*
         * @return newly created adb_SecurityConfigExceptionE0_t object
         */
        adb_SecurityConfigExceptionE0_t* AXIS2_CALL
        adb_SecurityConfigExceptionE0_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_SecurityConfigExceptionE0_t object and return the property value.
     ...
     #endif /* ADB_SECURITYCONFIGEXCEPTIONE0_H */
