...
*/
        ...
        #ifndef ADB_GETSCENARIOS_H
        #define ADB_GETSCENARIOS_H
        ...
        */
        ...
        typedef struct adb_getScenarios adb_getScenarios_t;
        ...
        /**
         * Constructor for creating adb_getScenarios_t
         * @param env pointer to environment struct
         * @return newly created adb_getScenarios_t object
         */
         ...
         * @param  _getScenarios adb_getScenarios_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_getScenarios_t object
         * @param  _getScenarios adb_getScenarios_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _getScenarios adb_getScenarios_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_getScenarios_declare_parent_namespaces(
         ...
         * @param  _getScenarios adb_getScenarios_t object
         * @param env pointer to environment struct
         * @param getScenarios_om_node node to serialize from
         * @param getScenarios_om_element parent element to serialize from
        ...
        adb_getScenarios_serialize(
            adb_getScenarios_t* _getScenarios,
            const axutil_env_t *env,
            axiom_node_t* getScenarios_om_node, axiom_element_t *getScenarios_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_getScenarios is a particle class (E.g. group, inner sequence)
        ...
        adb_getScenarios_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_getScenarios_t object and return the property value.
