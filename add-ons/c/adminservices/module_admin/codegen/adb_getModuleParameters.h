...
*/
        ...
        #ifndef ADB_GETMODULEPARAMETERS_H
        #define ADB_GETMODULEPARAMETERS_H

       /**
        * adb_getModuleParameters.h
        *
        ...
        */
        ...
        typedef struct adb_getModuleParameters adb_getModuleParameters_t;
        ...
        /**
         * Constructor for creating adb_getModuleParameters_t
         * @param env pointer to environment struct
         * @return newly created adb_getModuleParameters_t object
         */
         ...
         * @param  _getModuleParameters adb_getModuleParameters_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_getModuleParameters_t object
         * @param  _getModuleParameters adb_getModuleParameters_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _getModuleParameters adb_getModuleParameters_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_getModuleParameters_declare_parent_namespaces(
         ...
         * @param  _getModuleParameters adb_getModuleParameters_t object
         * @param env pointer to environment struct
         * @param getModuleParameters_om_node node to serialize from
         * @param getModuleParameters_om_element parent element to serialize from
        ...
        adb_getModuleParameters_serialize(
            adb_getModuleParameters_t* _getModuleParameters,
            const axutil_env_t *env,
            axiom_node_t* getModuleParameters_om_node, axiom_element_t *getModuleParameters_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_getModuleParameters is a particle class (E.g. group, inner sequence)
        ...
        adb_getModuleParameters_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_getModuleParameters_t object and return the property value.
     ...
     #endif /* ADB_GETMODULEPARAMETERS_H */
