...
*/
        ...
        #ifndef ADB_DISENGAGEMODULEFORSERVICE_H
        #define ADB_DISENGAGEMODULEFORSERVICE_H

       /**
        * adb_disengageModuleForService.h
        *
       ...
       /**
        *  adb_disengageModuleForService class
        */
        ...
        typedef struct adb_disengageModuleForService adb_disengageModuleForService_t;
        ...
        /**
         * Constructor for creating adb_disengageModuleForService_t
         * @param env pointer to environment struct
         * @return newly created adb_disengageModuleForService_t object
         */
         ...
         * @param  _disengageModuleForService adb_disengageModuleForService_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_disengageModuleForService_t object
         * @param  _disengageModuleForService adb_disengageModuleForService_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for moduleId. 
         * @param  _disengageModuleForService adb_disengageModuleForService_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_disengageModuleForService_declare_parent_namespaces(
         ...
         * @param  _disengageModuleForService adb_disengageModuleForService_t object
         * @param env pointer to environment struct
         * @param disengageModuleForService_om_node node to serialize from
         * @param disengageModuleForService_om_element parent element to serialize from
        ...
        adb_disengageModuleForService_serialize(
            adb_disengageModuleForService_t* _disengageModuleForService,
            const axutil_env_t *env,
            axiom_node_t* disengageModuleForService_om_node, axiom_element_t *disengageModuleForService_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_disengageModuleForService is a particle class (E.g. group, inner sequence)
        ...
        adb_disengageModuleForService_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_disengageModuleForService_t object and return the property value.
     ...
     #endif /* ADB_DISENGAGEMODULEFORSERVICE_H */
