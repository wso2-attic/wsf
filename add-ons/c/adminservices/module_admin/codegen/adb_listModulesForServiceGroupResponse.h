...
*/
        ...
        #ifndef ADB_LISTMODULESFORSERVICEGROUPRESPONSE_H
        #define ADB_LISTMODULESFORSERVICEGROUPRESPONSE_H

       /**
        * adb_listModulesForServiceGroupResponse.h
        *
       ...
       /**
        *  adb_listModulesForServiceGroupResponse class
        */
        ...
        typedef struct adb_listModulesForServiceGroupResponse adb_listModulesForServiceGroupResponse_t;
        ...
        /**
         * Constructor for creating adb_listModulesForServiceGroupResponse_t
         * @param env pointer to environment struct
         * @return newly created adb_listModulesForServiceGroupResponse_t object
         */
         ...
         * @param  _listModulesForServiceGroupResponse adb_listModulesForServiceGroupResponse_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_listModulesForServiceGroupResponse_t object
         * @param  _listModulesForServiceGroupResponse adb_listModulesForServiceGroupResponse_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for return. Deprecated for array types, Use adb_listModulesForServiceGroupResponse_get_return_at instead
         * @param  _listModulesForServiceGroupResponse adb_listModulesForServiceGroupResponse_t object
         * @param env pointer to environment struct
        ...
        /**
         * Setter for return.Deprecated for array types, Use adb_listModulesForServiceGroupResponse_set_return_at
         * or adb_listModulesForServiceGroupResponse_add_return instead.
         * @param  _listModulesForServiceGroupResponse adb_listModulesForServiceGroupResponse_t object
         * @param env pointer to environment struct
         ...
         * @param  _listModulesForServiceGroupResponse _ adb_listModulesForServiceGroupResponse_t object
         * @param env pointer to environment struct.
       ...
       adb_listModulesForServiceGroupResponse_declare_parent_namespaces(
         ...
         * @param  _listModulesForServiceGroupResponse adb_listModulesForServiceGroupResponse_t object
         * @param env pointer to environment struct
         * @param listModulesForServiceGroupResponse_om_node node to serialize from
         * @param listModulesForServiceGroupResponse_om_element parent element to serialize from
        ...
        adb_listModulesForServiceGroupResponse_serialize(
            adb_listModulesForServiceGroupResponse_t* _listModulesForServiceGroupResponse,
            const axutil_env_t *env,
            axiom_node_t* listModulesForServiceGroupResponse_om_node, axiom_element_t *listModulesForServiceGroupResponse_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_listModulesForServiceGroupResponse is a particle class (E.g. group, inner sequence)
        ...
        adb_listModulesForServiceGroupResponse_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_listModulesForServiceGroupResponse_t object and return the property value.
     ...
     #endif /* ADB_LISTMODULESFORSERVICEGROUPRESPONSE_H */
