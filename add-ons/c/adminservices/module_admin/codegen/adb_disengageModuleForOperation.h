...
*/
        ...
        #ifndef ADB_DISENGAGEMODULEFOROPERATION_H
        #define ADB_DISENGAGEMODULEFOROPERATION_H

       /**
        * adb_disengageModuleForOperation.h
        *
       ...
       /**
        *  adb_disengageModuleForOperation class
        */
        ...
        typedef struct adb_disengageModuleForOperation adb_disengageModuleForOperation_t;
        ...
        /**
         * Constructor for creating adb_disengageModuleForOperation_t
         * @param env pointer to environment struct
         * @return newly created adb_disengageModuleForOperation_t object
         */
         ...
         * @param  _disengageModuleForOperation adb_disengageModuleForOperation_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_disengageModuleForOperation_t object
         * @param  _disengageModuleForOperation adb_disengageModuleForOperation_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for moduleId. 
         * @param  _disengageModuleForOperation adb_disengageModuleForOperation_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_disengageModuleForOperation_declare_parent_namespaces(
         ...
         * @param  _disengageModuleForOperation adb_disengageModuleForOperation_t object
         * @param env pointer to environment struct
         * @param disengageModuleForOperation_om_node node to serialize from
         * @param disengageModuleForOperation_om_element parent element to serialize from
        ...
        adb_disengageModuleForOperation_serialize(
            adb_disengageModuleForOperation_t* _disengageModuleForOperation,
            const axutil_env_t *env,
            axiom_node_t* disengageModuleForOperation_om_node, axiom_element_t *disengageModuleForOperation_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_disengageModuleForOperation is a particle class (E.g. group, inner sequence)
        ...
        adb_disengageModuleForOperation_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_disengageModuleForOperation_t object and return the property value.
     ...
     #endif /* ADB_DISENGAGEMODULEFOROPERATION_H */
