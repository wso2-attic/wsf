...
*/
        ...
        #ifndef ADB_DISENGAGEMODULEFORSERVICEGROUP_H
        #define ADB_DISENGAGEMODULEFORSERVICEGROUP_H

       /**
        * adb_disengageModuleForServiceGroup.h
        *
       ...
       /**
        *  adb_disengageModuleForServiceGroup class
        */
        ...
        typedef struct adb_disengageModuleForServiceGroup adb_disengageModuleForServiceGroup_t;
        ...
        /**
         * Constructor for creating adb_disengageModuleForServiceGroup_t
         * @param env pointer to environment struct
         * @return newly created adb_disengageModuleForServiceGroup_t object
         */
         ...
         * @param  _disengageModuleForServiceGroup adb_disengageModuleForServiceGroup_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_disengageModuleForServiceGroup_t object
         * @param  _disengageModuleForServiceGroup adb_disengageModuleForServiceGroup_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for moduleId. 
         * @param  _disengageModuleForServiceGroup adb_disengageModuleForServiceGroup_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_disengageModuleForServiceGroup_declare_parent_namespaces(
         ...
         * @param  _disengageModuleForServiceGroup adb_disengageModuleForServiceGroup_t object
         * @param env pointer to environment struct
         * @param disengageModuleForServiceGroup_om_node node to serialize from
         * @param disengageModuleForServiceGroup_om_element parent element to serialize from
        ...
        adb_disengageModuleForServiceGroup_serialize(
            adb_disengageModuleForServiceGroup_t* _disengageModuleForServiceGroup,
            const axutil_env_t *env,
            axiom_node_t* disengageModuleForServiceGroup_om_node, axiom_element_t *disengageModuleForServiceGroup_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_disengageModuleForServiceGroup is a particle class (E.g. group, inner sequence)
        ...
        adb_disengageModuleForServiceGroup_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_disengageModuleForServiceGroup_t object and return the property value.
     ...
     #endif /* ADB_DISENGAGEMODULEFORSERVICEGROUP_H */
