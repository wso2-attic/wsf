...
*/
        ...
        #ifndef ADB_LISTMODULESFORSERVICE_H
        #define ADB_LISTMODULESFORSERVICE_H

       /**
        * adb_listModulesForService.h
        *
       ...
       /**
        *  adb_listModulesForService class
        */
        ...
        typedef struct adb_listModulesForService adb_listModulesForService_t;
        ...
        /**
         * Constructor for creating adb_listModulesForService_t
         * @param env pointer to environment struct
         * @return newly created adb_listModulesForService_t object
         */
         ...
         * @param  _listModulesForService adb_listModulesForService_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_listModulesForService_t object
         * @param  _listModulesForService adb_listModulesForService_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _listModulesForService adb_listModulesForService_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
       ...
       adb_listModulesForService_declare_parent_namespaces(
         ...
         * @param  _listModulesForService adb_listModulesForService_t object
         * @param env pointer to environment struct
         * @param listModulesForService_om_node node to serialize from
         * @param listModulesForService_om_element parent element to serialize from
        ...
        adb_listModulesForService_serialize(
            adb_listModulesForService_t* _listModulesForService,
            const axutil_env_t *env,
            axiom_node_t* listModulesForService_om_node, axiom_element_t *listModulesForService_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_listModulesForService is a particle class (E.g. group, inner sequence)
        ...
        adb_listModulesForService_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_listModulesForService_t object and return the property value.
     ...
     #endif /* ADB_LISTMODULESFORSERVICE_H */
