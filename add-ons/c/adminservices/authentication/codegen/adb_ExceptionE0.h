...
*/
        ...
        #ifndef ADB_EXCEPTIONE0_H
        #define ADB_EXCEPTIONE0_H
        ...
        */
        ...
        typedef struct adb_ExceptionE0 adb_ExceptionE0_t;
        ...
        /**
         * Constructor for creating adb_ExceptionE0_t
         * @param env pointer to environment struct
         * @return newly created adb_ExceptionE0_t object
         */
         ...
         * @param  _ExceptionE0 adb_ExceptionE0_t object to free
         * @param env pointer to environment struct
         ...
         * @param  _ExceptionE0 adb_ExceptionE0_t object
         * @param env pointer to environment struct
         * @return adb_Exception_t*
         */
         ...
         * @param  _ExceptionE0 adb_ExceptionE0_t object
         * @param env pointer to environment struct
         * @param arg_Exception adb_Exception_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_ExceptionE0_declare_parent_namespaces(
         ...
         * @param  _ExceptionE0 adb_ExceptionE0_t object
         * @param env pointer to environment struct
         * @param ExceptionE0_om_node node to serialize from
         * @param ExceptionE0_om_element parent element to serialize from
        ...
        adb_ExceptionE0_serialize(
            adb_ExceptionE0_t* _ExceptionE0,
            const axutil_env_t *env,
            axiom_node_t* ExceptionE0_om_node, axiom_element_t *ExceptionE0_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_ExceptionE0 is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_ExceptionE0_t
         * @param env pointer to environment struct
         * @param _Exception adb_Exception_t*
         * @return newly created adb_ExceptionE0_t object
         */
        adb_ExceptionE0_t* AXIS2_CALL
        adb_ExceptionE0_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_ExceptionE0_t object and return the property value.
