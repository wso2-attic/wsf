...
*/
        ...
        #ifndef ADB_GETUSERPERMISSIONS_H
        #define ADB_GETUSERPERMISSIONS_H

       /**
        * adb_getUserPermissions.h
        *
        ...
        */
        ...
        typedef struct adb_getUserPermissions adb_getUserPermissions_t;
        ...
        /**
         * Constructor for creating adb_getUserPermissions_t
         * @param env pointer to environment struct
         * @return newly created adb_getUserPermissions_t object
         */
         ...
         * @param  _getUserPermissions adb_getUserPermissions_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_getUserPermissions_t object
         * @param  _getUserPermissions adb_getUserPermissions_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        ...
        /**
         * Getter for username. 
         * @param  _getUserPermissions adb_getUserPermissions_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
         ...
         * @param  _getUserPermissions adb_getUserPermissions_t object
         * @param env pointer to environment struct
         * @param arg_realm adb_UserRealm_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_getUserPermissions_declare_parent_namespaces(
         ...
         * @param  _getUserPermissions adb_getUserPermissions_t object
         * @param env pointer to environment struct
         * @param getUserPermissions_om_node node to serialize from
         * @param getUserPermissions_om_element parent element to serialize from
        ...
        adb_getUserPermissions_serialize(
            adb_getUserPermissions_t* _getUserPermissions,
            const axutil_env_t *env,
            axiom_node_t* getUserPermissions_om_node, axiom_element_t *getUserPermissions_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_getUserPermissions is a particle class (E.g. group, inner sequence)
        ...
        adb_getUserPermissions_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_getUserPermissions_t object and return the property value.
     ...
     #endif /* ADB_GETUSERPERMISSIONS_H */
