...
*/
        ...
        #ifndef ADB_GETALLLOGGERDATA_H
        #define ADB_GETALLLOGGERDATA_H

       /**
        * adb_getAllLoggerData.h
        *
        ...
        */
        ...
        typedef struct adb_getAllLoggerData adb_getAllLoggerData_t;
        ...
        /**
         * Constructor for creating adb_getAllLoggerData_t
         * @param env pointer to environment struct
         * @return newly created adb_getAllLoggerData_t object
         */
         ...
         * @param  _getAllLoggerData adb_getAllLoggerData_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free adb_getAllLoggerData_t object
         * @param  _getAllLoggerData adb_getAllLoggerData_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _getAllLoggerData adb_getAllLoggerData_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
         ...
         * @param  _getAllLoggerData adb_getAllLoggerData_t object
         * @param env pointer to environment struct
         * @param arg_logNameFilter axis2_char_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _getAllLoggerData adb_getAllLoggerData_t object
         * @param env pointer to environment struct
         * @param arg_beginsWith axis2_bool_t
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       adb_getAllLoggerData_declare_parent_namespaces(
         ...
         * @param  _getAllLoggerData adb_getAllLoggerData_t object
         * @param env pointer to environment struct
         * @param getAllLoggerData_om_node node to serialize from
         * @param getAllLoggerData_om_element parent element to serialize from
        ...
        adb_getAllLoggerData_serialize(
            adb_getAllLoggerData_t* _getAllLoggerData,
            const axutil_env_t *env,
            axiom_node_t* getAllLoggerData_om_node, axiom_element_t *getAllLoggerData_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_getAllLoggerData is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating adb_getAllLoggerData_t
         * @param env pointer to environment struct
         * @param _logNameFilter axis2_char_t*
         * @param _beginsWith axis2_bool_t
         * @return newly created adb_getAllLoggerData_t object
         */
        adb_getAllLoggerData_t* AXIS2_CALL
        adb_getAllLoggerData_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_getAllLoggerData_t object and return the property value.
