...
function wsf_serivce_invoke_function($operation_node, $function_name, $envelope_node)
{
    if($operation_node){
...
//    file_put_contents("/tmp/my.txt", print_r($arg_array, TRUE));
...
function wsf_wsdl_create_response_payload($return_val, $signature_node)
{
    ...
    file_put_contents("/tmp/my.txt", print_r($tmp_param_struct, TRUE));
