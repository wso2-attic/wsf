...
try {
    $client = new WSSoapClient(null, 
        array('location' => 'http://localhost:9090/soap/soap_ext/tests/ws_hello_service_nonwsdl.php',
              'uri' => 'http://localhost/axis/helloService',
              'soap_version' => SOAP_1_2,
              'style' => SOAP_RPC));
    /* $result =  $client->__soapCall('greet', array(new
     * WSSoapParam('Sam', 'name')), NULL, NULL); */
