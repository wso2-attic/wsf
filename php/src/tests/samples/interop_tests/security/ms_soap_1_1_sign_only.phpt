...
try {
    ...
    $reqMessage = new WSMessage($reqPayloadString,
                                array("to" => "http://131.107.72.15/Security_WsSecurity_Service_Indigo/WsSecurity10Sign.svc/MutualCertificate10Sign",
                                      "action" => "http://InteropBaseAddress/interop/echo"));
    
    $policy_xml = file_get_contents("sign-only-policy.xml");
