--TEST--
SOAP 1.1 Security - Sign and encript TripleDes
--FILE--
<?php
/*
...
try {
    ...
    $reqMessage = new WSMessage($reqPayloadString,
                                array("to" => "http://131.107.72.15/Security_WsSecurity_Service_Indigo/WsSecurity10.svc/MutualCertificate10SignEncryptRsa15TripleDes",
                                      "action" => "http://InteropBaseAddress/interop/echo"));
    
    $policy_xml = file_get_contents("sign-encrypt-tripledes-policy.xml");
