...
$wsclient = new WSClient( array(
                "wsdl" => "http://localhost/services/wsdl_generation/class_based_classmap_service.php?wsdl",
                "to" => "http://localhost/services/wsdl_generation/class_based_classmap_service.php"));
