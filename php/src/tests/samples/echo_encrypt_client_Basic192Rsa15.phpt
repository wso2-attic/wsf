--TEST--
Test for echo_encrypt_client_Basic192Rsa15 sample
--FILE--
<?php
...
try {
    ...
    $reqMessage = new WSMessage($reqPayloadString,
                                array("to"=>"http://localhost/samples/security/encryption/encrypt_service_Basic192Rsa15.php",
                                      "action" => "http://php.axis2.org/samples/echoString"));
    
    $sec_array = array("encrypt"=>TRUE,
                       "algorithmSuite" => "Basic192Rsa15",
