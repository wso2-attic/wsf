--TEST--
Test for math_add_service sample
--FILE--
<?php
...
--EXPECT--
<soapenv:Envelope xmlns:soapenv="http://www.w3.org/2003/05/soap-envelope"><soapenv:Header/><soapenv:Body><ns1:result xmlns:ns1="http://ws.axis2.org/axis2/php/math">48</ns1:result></soapenv:Body></soapenv:Envelope>