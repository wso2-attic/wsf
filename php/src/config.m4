...
if test "$PHP_WSF" = "yes"; then
	...
	PHP_NEW_EXTENSION(wsf, wsf.c xml_msg_recv.c util.c stream.c worker.c out_transport_info.c client.c policy.c wsfsoap.c php_schema.c php_sdl.c php_encoding.c php_xml.c php_http.c , $ext_shared)
