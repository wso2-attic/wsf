...
LDFLAGS = /nologo /LIBPATH:.\..\wso2-wsf-php-bin-1.0\wsf_c\lib /LIBPATH:$(PHP_BIN_DIR)\dev \
...
INCLUDE_PATH = /I$(PHP_SRC_DIR) /I$(PHP_SRC_DIR)\main /I$(PHP_SRC_DIR)\regex \
	       ...
	       /I$(PHP_SRC_DIR)\TSRM /I.\..\wso2-wsf-php-bin-1.0\wsf_c\include \
...
wsf.dll :
	...
	link.exe $(LDFLAGS) intdir\*.obj $(LIBS) /DLL  /OUT:.\..\wso2-wsf-php-bin-1.0\wsf.dll
