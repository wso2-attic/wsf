...
void wsf_set_soap_fault_properties(axutil_env_t *env, axiom_soap_fault_t *soap_fault, zval *zval_ws_fault TSRMLS_DC)
{
    if(soap_fault){
        ...
        if(sf_detail){
            sf_detail_node = axiom_soap_fault_detail_get_base_node(sf_detail, env);
            if(sf_detail_node){
