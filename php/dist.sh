...
make dist
tar xzf wso2-wsf-php-src-1.3.1.tar.gz
rm wso2-wsf-php-src-1.3.1.tar.gz
cp -r src samples scripts docs wso2-wsf-php-src-1.3.1
rm -f wso2-wsf-php-src-1.3.1/src/libtool

cd wso2-wsf-php-src-1.3.1
...
cd ..
tar czf wso2-wsf-php-src-1.3.1.tar.gz wso2-wsf-php-src-1.3.1
zip -rq wso2-wsf-php-src-1 wso2-wsf-php-src-1.3.1
mv wso2-wsf-php-src-1.zip wso2-wsf-php-src-1.3.1.zip
rm -rf wso2-wsf-php-src-1.3.1
