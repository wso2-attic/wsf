...
make dist
tar xzf wso2-wsf-php-src-1.3.2.tar.gz
rm wso2-wsf-php-src-1.3.2.tar.gz
cp -r src samples scripts docs wso2-wsf-php-src-1.3.2
rm -f wso2-wsf-php-src-1.3.2/src/libtool

cd wso2-wsf-php-src-1.3.2
...
cd ..
tar czf wso2-wsf-php-src-1.3.2.tar.gz wso2-wsf-php-src-1.3.2
zip -rq wso2-wsf-php-src-1 wso2-wsf-php-src-1.3.2
mv wso2-wsf-php-src-1.zip wso2-wsf-php-src-1.3.2.zip
rm -rf wso2-wsf-php-src-1.3.2
