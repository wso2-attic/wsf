...
make dist
tar xzf wso2-wsf-php-src-1.3.0.tar.gz
rm wso2-wsf-php-src-1.3.0.tar.gz
cp -r src samples scripts docs wso2-wsf-php-src-1.3.0
rm -f wso2-wsf-php-src-1.3.0/src/libtool

cd wso2-wsf-php-src-1.3.0
...
cd ..
tar czf wso2-wsf-php-src-1.3.0.tar.gz wso2-wsf-php-src-1.3.0
zip -rq wso2-wsf-php-src-1 wso2-wsf-php-src-1.3.0
mv wso2-wsf-php-src-1.zip wso2-wsf-php-src-1.3.0.zip
rm -rf wso2-wsf-php-src-1.3.0
