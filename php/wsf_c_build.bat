...
@nmake /nologo dist_no_samples AUTOCONF=..\..\..\configure.in AXIS2_BIN_DIR=.\..\..\..\axis2c\build\axis2c-bin-1.2.0-win32
...
@nmake /nologo dist_no_samples AXIS2_BIN_DIR=.\..\..\..\axis2c\build\axis2c-bin-1.2.0-win32 AUTOCONF=..\..\..\configure.in
...
@xcopy /E /Q /I /Y sandesha2\lib\sandesha2_client.lib  .\..\..\axis2c\build\axis2c-bin-1.2.0-win32\lib\
@xcopy /E /Q /I /Y sandesha2\lib\sandesha2_client.dll  .\..\..\axis2c\build\axis2c-bin-1.2.0-win32\lib\
...
@cd ..\..\
@cd axis2c\neethi\src\util
@nmake /nologo -f neethi_util.mk AXIS2_BIN_DIR=..\..\..\build\axis2c-bin-1.2.0-win32 AUTOCONF=..\..\..\..\configure.in
@copy neethi_options.h ..\..\..\build\axis2c-bin-1.2.0-win32\include
@cd ..\..\..\..\
