@if exist wsf_c\wso2-wsf-c-bin-1.1.0 rmdir /S /Q wsf_c\wso2-wsf-c-bin-1.1.0

@if exist wso2-wsf-php-bin-1.1.0-win32 rmdir /S /Q wso2-wsf-php-bin-1.1.0-win32

@if exist wsf_c\axis2c\build\axis2c-bin-1.1.0-win32 rmdir /s /q wsf_c\axis2c\build\axis2c-bin-1.1.0-win32
