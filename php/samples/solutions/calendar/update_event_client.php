...
<fieldset>
	...
	<fieldset>
		<legend>Event Information</legend>
                          <div><label for="year">Year<em>*</em></label> <input id="year" name="year" size="45" type="text" value="<?php echo $year; ?>"/></div>
                          <div><label for="week">Week<em>*</em></label> <input id="week" name="week" size="45" type="text" value="<?php echo $week; ?>"/></div>

                	<div><label for="time">Even Time<em>*</em></label> <input id="time" name="time" size="45" type="text" value="<?php echo $time; ?>"/></div>
			<div><label for="name">New Event Name<em>*</em></label> <input id="name" name="event" size="60" value="<?php echo $event; ?>" size="12" type="text" /></div>
